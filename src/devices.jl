...
# Aliases (@enum requires unique values)
const SHARED_MEMORY_PER_BLOCK = MAX_SHARED_MEMORY_PER_BLOCK
const REGISTERS_PER_BLOCK = MAX_REGISTERS_PER_BLOCK
const MAXIMUM_TEXTURE2D_ARRAY_WIDTH = MAXIMUM_TEXTURE2D_LAYERED_WIDTH
const MAXIMUM_TEXTURE2D_ARRAY_HEIGHT = MAXIMUM_TEXTURE2D_LAYERED_HEIGHT
const MAXIMUM_TEXTURE2D_ARRAY_NUMSLICES = MAXIMUM_TEXTURE2D_LAYERED_LAYERS
