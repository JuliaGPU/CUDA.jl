...
@checked function cudnnGetProperty(type, value)
    ccall((:cudnnGetProperty, libcudnn), cudnnStatus_t, (libraryPropertyType, Ptr{Cint}),
          type, value)
end
...
@checked function cudnnSetStream(handle, streamId)
    initialize_context()
    ccall((:cudnnSetStream, libcudnn), cudnnStatus_t, (cudnnHandle_t, cudaStream_t), handle,
          streamId)
end

@checked function cudnnGetStream(handle, streamId)
    initialize_context()
    ccall((:cudnnGetStream, libcudnn), cudnnStatus_t, (cudnnHandle_t, Ptr{cudaStream_t}),
          handle, streamId)
end
...
@checked function cudnnCreateTensorDescriptor(tensorDesc)
    ...
    ccall((:cudnnCreateTensorDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnTensorDescriptor_t},), tensorDesc)
end
...
@checked function cudnnSetTensor4dDescriptor(tensorDesc, format, dataType, n, c, h, w)
    ...
    ccall((:cudnnSetTensor4dDescriptor, libcudnn), cudnnStatus_t,
          (cudnnTensorDescriptor_t, cudnnTensorFormat_t, cudnnDataType_t, Cint, Cint, Cint,
           Cint), tensorDesc, format, dataType, n, c, h, w)
end
...
@checked function cudnnSetTensor4dDescriptorEx(tensorDesc, dataType, n, c, h, w, nStride,
    ...
    ccall((:cudnnSetTensor4dDescriptorEx, libcudnn), cudnnStatus_t,
          (cudnnTensorDescriptor_t, cudnnDataType_t, Cint, Cint, Cint, Cint, Cint, Cint,
           Cint, Cint), tensorDesc, dataType, n, c, h, w, nStride, cStride, hStride,
          wStride)
end
...
@checked function cudnnGetTensor4dDescriptor(tensorDesc, dataType, n, c, h, w, nStride,
    ...
    ccall((:cudnnGetTensor4dDescriptor, libcudnn), cudnnStatus_t,
          (cudnnTensorDescriptor_t, Ptr{cudnnDataType_t}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint},
           Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), tensorDesc, dataType, n,
          c, h, w, nStride, cStride, hStride, wStride)
end
...
@checked function cudnnGetTensorNdDescriptor(tensorDesc, nbDimsRequested, dataType, nbDims,
    ...
    ccall((:cudnnGetTensorNdDescriptor, libcudnn), cudnnStatus_t,
          (cudnnTensorDescriptor_t, Cint, Ptr{cudnnDataType_t}, Ptr{Cint}, Ptr{Cint},
           Ptr{Cint}), tensorDesc, nbDimsRequested, dataType, nbDims, dimA, strideA)
end

@checked function cudnnGetTensorSizeInBytes(tensorDesc, size)
    initialize_context()
    ccall((:cudnnGetTensorSizeInBytes, libcudnn), cudnnStatus_t,
          (cudnnTensorDescriptor_t, Ptr{Csize_t}), tensorDesc, size)
end
...
@checked function cudnnInitTransformDest(transformDesc, srcDesc, destDesc, destSizeInBytes)
    ...
    ccall((:cudnnInitTransformDest, libcudnn), cudnnStatus_t,
          (cudnnTensorTransformDescriptor_t, cudnnTensorDescriptor_t,
           cudnnTensorDescriptor_t, Ptr{Csize_t}), transformDesc, srcDesc, destDesc,
          destSizeInBytes)
end
...
@checked function cudnnCreateTensorTransformDescriptor(transformDesc)
    ...
    ccall((:cudnnCreateTensorTransformDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnTensorTransformDescriptor_t},), transformDesc)
end
...
@checked function cudnnSetTensorTransformDescriptor(transformDesc, nbDims, destFormat,
    ...
    ccall((:cudnnSetTensorTransformDescriptor, libcudnn), cudnnStatus_t,
          (cudnnTensorTransformDescriptor_t, UInt32, cudnnTensorFormat_t, Ptr{Int32},
           Ptr{Int32}, Ptr{UInt32}, cudnnFoldingDirection_t), transformDesc, nbDims,
...
@checked function cudnnGetTensorTransformDescriptor(transformDesc, nbDimsRequested,
    ...
    ccall((:cudnnGetTensorTransformDescriptor, libcudnn), cudnnStatus_t,
          (cudnnTensorTransformDescriptor_t, UInt32, Ptr{cudnnTensorFormat_t}, Ptr{Int32},
           Ptr{Int32}, Ptr{UInt32}, Ptr{cudnnFoldingDirection_t}), transformDesc,
          nbDimsRequested, destFormat, padBeforeA, padAfterA, foldA, direction)
end
...
@checked function cudnnTransformTensor(handle, alpha, xDesc, x, beta, yDesc, y)
    ...
    ccall((:cudnnTransformTensor, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, Ptr{Cvoid}, cudnnTensorDescriptor_t, Ptr{Cvoid}, Ptr{Cvoid},
           cudnnTensorDescriptor_t, Ptr{Cvoid}), handle, alpha, xDesc, x, beta, yDesc, y)
end
...
@checked function cudnnTransformTensorEx(handle, transDesc, alpha, srcDesc, srcData, beta,
    ...
    ccall((:cudnnTransformTensorEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorTransformDescriptor_t, Ptr{Cvoid},
           ...
           Ptr{Cvoid}), handle, transDesc, alpha, srcDesc, srcData, beta, destDesc,
          destData)
end
...
@checked function cudnnAddTensor(handle, alpha, aDesc, A, beta, cDesc, C)
    ...
    ccall((:cudnnAddTensor, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}, Ptr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle, alpha, aDesc, A, beta, cDesc, C)
end
...
@checked function cudnnCreateOpTensorDescriptor(opTensorDesc)
    ...
    ccall((:cudnnCreateOpTensorDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnOpTensorDescriptor_t},), opTensorDesc)
end
...
@checked function cudnnSetOpTensorDescriptor(opTensorDesc, opTensorOp, opTensorCompType,
    ...
    ccall((:cudnnSetOpTensorDescriptor, libcudnn), cudnnStatus_t,
          (cudnnOpTensorDescriptor_t, cudnnOpTensorOp_t, cudnnDataType_t,
           cudnnNanPropagation_t), opTensorDesc, opTensorOp, opTensorCompType,
          opTensorNanOpt)
end
...
@checked function cudnnGetOpTensorDescriptor(opTensorDesc, opTensorOp, opTensorCompType,
    ...
    ccall((:cudnnGetOpTensorDescriptor, libcudnn), cudnnStatus_t,
          (cudnnOpTensorDescriptor_t, Ptr{cudnnOpTensorOp_t}, Ptr{cudnnDataType_t},
           Ptr{cudnnNanPropagation_t}), opTensorDesc, opTensorOp, opTensorCompType,
          opTensorNanOpt)
end
...
@checked function cudnnOpTensor(handle, opTensorDesc, alpha1, aDesc, A, alpha2, bDesc, B,
    ...
    ccall((:cudnnOpTensor, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnOpTensorDescriptor_t, Ptr{Cvoid}, cudnnTensorDescriptor_t,
           ...
           cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle, opTensorDesc, alpha1, aDesc, A,
...
@checked function cudnnCreateReduceTensorDescriptor(reduceTensorDesc)
    ...
    ccall((:cudnnCreateReduceTensorDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnReduceTensorDescriptor_t},), reduceTensorDesc)
end
...
@checked function cudnnGetReduceTensorDescriptor(reduceTensorDesc, reduceTensorOp,
    ...
    ccall((:cudnnGetReduceTensorDescriptor, libcudnn), cudnnStatus_t,
          (cudnnReduceTensorDescriptor_t, Ptr{cudnnReduceTensorOp_t}, Ptr{cudnnDataType_t},
           ...
           Ptr{cudnnIndicesType_t}), reduceTensorDesc, reduceTensorOp, reduceTensorCompType,
...
@checked function cudnnGetReductionIndicesSize(handle, reduceTensorDesc, aDesc, cDesc,
    ...
    ccall((:cudnnGetReductionIndicesSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnReduceTensorDescriptor_t, cudnnTensorDescriptor_t,
           cudnnTensorDescriptor_t, Ptr{Csize_t}), handle, reduceTensorDesc, aDesc, cDesc,
          sizeInBytes)
end
...
@checked function cudnnGetReductionWorkspaceSize(handle, reduceTensorDesc, aDesc, cDesc,
    ...
    ccall((:cudnnGetReductionWorkspaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnReduceTensorDescriptor_t, cudnnTensorDescriptor_t,
           cudnnTensorDescriptor_t, Ref{Csize_t}), handle, reduceTensorDesc, aDesc, cDesc,
          sizeInBytes)
end
...
@checked function cudnnReduceTensor(handle, reduceTensorDesc, indices, indicesSizeInBytes,
    ...
    ccall((:cudnnReduceTensor, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnReduceTensorDescriptor_t, Ptr{Cvoid}, Csize_t, CuPtr{Cvoid},
           ...
           cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle, reduceTensorDesc, indices,
          indicesSizeInBytes, workspace, workspaceSizeInBytes, alpha, aDesc, A, beta, cDesc,
          C)
end
...
@checked function cudnnSetTensor(handle, yDesc, y, valuePtr)
    ...
    ccall((:cudnnSetTensor, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorDescriptor_t, CuPtr{Cvoid}, Ptr{Cvoid}), handle, yDesc,
          y, valuePtr)
end
...
@checked function cudnnCreateFilterDescriptor(filterDesc)
    ...
    ccall((:cudnnCreateFilterDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnFilterDescriptor_t},), filterDesc)
end
...
@checked function cudnnSetFilter4dDescriptor(filterDesc, dataType, format, k, c, h, w)
    ...
    ccall((:cudnnSetFilter4dDescriptor, libcudnn), cudnnStatus_t,
          (cudnnFilterDescriptor_t, cudnnDataType_t, cudnnTensorFormat_t, Cint, Cint, Cint,
           Cint), filterDesc, dataType, format, k, c, h, w)
end
...
@checked function cudnnGetFilter4dDescriptor(filterDesc, dataType, format, k, c, h, w)
    ...
    ccall((:cudnnGetFilter4dDescriptor, libcudnn), cudnnStatus_t,
          (cudnnFilterDescriptor_t, Ptr{cudnnDataType_t}, Ptr{cudnnTensorFormat_t},
           Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), filterDesc, dataType, format, k, c,
          h, w)
end
...
@checked function cudnnGetFilterNdDescriptor(filterDesc, nbDimsRequested, dataType, format,
    ...
    ccall((:cudnnGetFilterNdDescriptor, libcudnn), cudnnStatus_t,
          (cudnnFilterDescriptor_t, Cint, Ptr{cudnnDataType_t}, Ptr{cudnnTensorFormat_t},
           Ptr{Cint}, Ptr{Cint}), filterDesc, nbDimsRequested, dataType, format, nbDims,
          filterDimA)
end
...
@checked function cudnnGetFilterSizeInBytes(filterDesc, size)
    ...
    ccall((:cudnnGetFilterSizeInBytes, libcudnn), cudnnStatus_t,
          (cudnnFilterDescriptor_t, Ptr{Csize_t}), filterDesc, size)
end
...
@checked function cudnnTransformFilter(handle, transDesc, alpha, srcDesc, srcData, beta,
    ...
    ccall((:cudnnTransformFilter, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorTransformDescriptor_t, Ptr{Cvoid},
           ...
           CuPtr{Cvoid}), handle, transDesc, alpha, srcDesc, srcData, beta, destDesc,
          destData)
end
...
@checked function cudnnSoftmaxForward(handle, algo, mode, alpha, xDesc, x, beta, yDesc, y)
    ...
    ccall((:cudnnSoftmaxForward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnSoftmaxAlgorithm_t, cudnnSoftmaxMode_t, Ptr{Cvoid},
           ...
           CuPtr{Cvoid}), handle, algo, mode, alpha, xDesc, x, beta, yDesc, y)
end
...
@checked function cudnnCreatePoolingDescriptor(poolingDesc)
    ...
    ccall((:cudnnCreatePoolingDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnPoolingDescriptor_t},), poolingDesc)
end
...
@checked function cudnnSetPooling2dDescriptor(poolingDesc, mode, maxpoolingNanOpt,
    ...
    ccall((:cudnnSetPooling2dDescriptor, libcudnn), cudnnStatus_t,
          (cudnnPoolingDescriptor_t, cudnnPoolingMode_t, cudnnNanPropagation_t, Cint, Cint,
           Cint, Cint, Cint, Cint), poolingDesc, mode, maxpoolingNanOpt, windowHeight,
...
@checked function cudnnGetPooling2dDescriptor(poolingDesc, mode, maxpoolingNanOpt,
    ...
    ccall((:cudnnGetPooling2dDescriptor, libcudnn), cudnnStatus_t,
          (cudnnPoolingDescriptor_t, Ptr{cudnnPoolingMode_t}, Ptr{cudnnNanPropagation_t},
           Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), poolingDesc,
...
@checked function cudnnSetPoolingNdDescriptor(poolingDesc, mode, maxpoolingNanOpt, nbDims,
    ...
    ccall((:cudnnSetPoolingNdDescriptor, libcudnn), cudnnStatus_t,
          (cudnnPoolingDescriptor_t, cudnnPoolingMode_t, cudnnNanPropagation_t, Cint,
           Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), poolingDesc, mode, maxpoolingNanOpt, nbDims,
          windowDimA, paddingA, strideA)
end
...
@checked function cudnnGetPoolingNdForwardOutputDim(poolingDesc, inputTensorDesc, nbDims,
    ...
    ccall((:cudnnGetPoolingNdForwardOutputDim, libcudnn), cudnnStatus_t,
          (cudnnPoolingDescriptor_t, cudnnTensorDescriptor_t, Cint, Ptr{Cint}), poolingDesc,
          inputTensorDesc, nbDims, outputTensorDimA)
end
...
@checked function cudnnGetPooling2dForwardOutputDim(poolingDesc, inputTensorDesc, n, c, h,
    ...
    ccall((:cudnnGetPooling2dForwardOutputDim, libcudnn), cudnnStatus_t,
          (cudnnPoolingDescriptor_t, cudnnTensorDescriptor_t, Ptr{Cint}, Ptr{Cint},
           Ptr{Cint}, Ptr{Cint}), poolingDesc, inputTensorDesc, n, c, h, w)
end
...
@checked function cudnnPoolingForward(handle, poolingDesc, alpha, xDesc, x, beta, yDesc, y)
    ...
    ccall((:cudnnPoolingForward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnPoolingDescriptor_t, Ptr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle,
...
@checked function cudnnCreateActivationDescriptor(activationDesc)
    ...
    ccall((:cudnnCreateActivationDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnActivationDescriptor_t},), activationDesc)
end
...
@checked function cudnnSetActivationDescriptor(activationDesc, mode, reluNanOpt, coef)
    ...
    ccall((:cudnnSetActivationDescriptor, libcudnn), cudnnStatus_t,
          (cudnnActivationDescriptor_t, cudnnActivationMode_t, cudnnNanPropagation_t,
           Cdouble), activationDesc, mode, reluNanOpt, coef)
end
...
@checked function cudnnGetActivationDescriptor(activationDesc, mode, reluNanOpt, coef)
    ...
    ccall((:cudnnGetActivationDescriptor, libcudnn), cudnnStatus_t,
          (cudnnActivationDescriptor_t, Ptr{cudnnActivationMode_t},
           Ptr{cudnnNanPropagation_t}, Ptr{Cdouble}), activationDesc, mode, reluNanOpt,
          coef)
end

@checked function cudnnSetActivationDescriptorSwishBeta(activationDesc, swish_beta)
    initialize_context()
    ccall((:cudnnSetActivationDescriptorSwishBeta, libcudnn), cudnnStatus_t,
          (cudnnActivationDescriptor_t, Cdouble), activationDesc, swish_beta)
end

@checked function cudnnGetActivationDescriptorSwishBeta(activationDesc, swish_beta)
    initialize_context()
    ccall((:cudnnGetActivationDescriptorSwishBeta, libcudnn), cudnnStatus_t,
          (cudnnActivationDescriptor_t, Ptr{Cdouble}), activationDesc, swish_beta)
end
...
@checked function cudnnCreateLRNDescriptor(normDesc)
    ...
    ccall((:cudnnCreateLRNDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnLRNDescriptor_t},), normDesc)
end
...
@checked function cudnnSetLRNDescriptor(normDesc, lrnN, lrnAlpha, lrnBeta, lrnK)
    ...
    ccall((:cudnnSetLRNDescriptor, libcudnn), cudnnStatus_t,
          (cudnnLRNDescriptor_t, Cuint, Cdouble, Cdouble, Cdouble), normDesc, lrnN,
...
@checked function cudnnGetLRNDescriptor(normDesc, lrnN, lrnAlpha, lrnBeta, lrnK)
    ...
    ccall((:cudnnGetLRNDescriptor, libcudnn), cudnnStatus_t,
          (cudnnLRNDescriptor_t, Ptr{Cuint}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}),
          normDesc, lrnN, lrnAlpha, lrnBeta, lrnK)
end

@checked function cudnnDestroyLRNDescriptor(lrnDesc)
    initialize_context()
    ccall((:cudnnDestroyLRNDescriptor, libcudnn), cudnnStatus_t, (cudnnLRNDescriptor_t,),
          lrnDesc)
end
...
@checked function cudnnLRNCrossChannelForward(handle, normDesc, lrnMode, alpha, xDesc, x,
    ...
    ccall((:cudnnLRNCrossChannelForward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnLRNDescriptor_t, cudnnLRNMode_t, Ptr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, Ptr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}), handle, normDesc, lrnMode, alpha, xDesc, x, beta, yDesc, y)
end
...
@checked function cudnnDivisiveNormalizationForward(handle, normDesc, mode, alpha, xDesc, x,
    ...
    ccall((:cudnnDivisiveNormalizationForward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnLRNDescriptor_t, cudnnDivNormMode_t, Ptr{Cvoid},
           ...
           Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle, normDesc, mode,
          alpha, xDesc, x, means, temp, temp2, beta, yDesc, y)
end
...
@checked function cudnnBatchNormalizationForwardInference(handle, mode, alpha, beta, xDesc,
    ...
    ccall((:cudnnBatchNormalizationForwardInference, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnBatchNormMode_t, Ptr{Cvoid}, Ptr{Cvoid},
           ...
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid}, CuPtr{Cvoid}, CuPtr{Cvoid},
           Cdouble), handle, mode, alpha, beta, xDesc, x, yDesc, y, bnScaleBiasMeanVarDesc,
...
@checked function cudnnDeriveNormTensorDescriptor(derivedNormScaleBiasDesc,
                                                  ...
                                                  groupCnt)
    initialize_context()
    ccall((:cudnnDeriveNormTensorDescriptor, libcudnn), cudnnStatus_t,
          (cudnnTensorDescriptor_t, cudnnTensorDescriptor_t, cudnnTensorDescriptor_t,
           cudnnNormMode_t, Cint), derivedNormScaleBiasDesc, derivedNormMeanVarDesc, xDesc,
          mode, groupCnt)
end
...
@checked function cudnnNormalizationForwardInference(handle, mode, normOps, algo, alpha,
                                                     ...
                                                     epsilon, groupCnt)
    initialize_context()
    ccall((:cudnnNormalizationForwardInference, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnNormMode_t, cudnnNormOps_t, cudnnNormAlgo_t, Ptr{Cvoid},
           Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, CuPtr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnActivationDescriptor_t,
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, Cdouble, Cint), handle, mode, normOps,
          algo, alpha, beta, xDesc, x, normScaleBiasDesc, normScale, normBias,
          normMeanVarDesc, estimatedMean, estimatedVariance, zDesc, z, activationDesc,
          yDesc, y, epsilon, groupCnt)
end
...
@checked function cudnnCreateSpatialTransformerDescriptor(stDesc)
    ...
    ccall((:cudnnCreateSpatialTransformerDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnSpatialTransformerDescriptor_t},), stDesc)
end
...
@checked function cudnnSetSpatialTransformerNdDescriptor(stDesc, samplerType, dataType,
    ...
    ccall((:cudnnSetSpatialTransformerNdDescriptor, libcudnn), cudnnStatus_t,
          (cudnnSpatialTransformerDescriptor_t, cudnnSamplerType_t, cudnnDataType_t, Cint,
           Ptr{Cint}), stDesc, samplerType, dataType, nbDims, dimA)
end
...
@checked function cudnnSpatialTfSamplerForward(handle, stDesc, alpha, xDesc, x, grid, beta,
    ...
    ccall((:cudnnSpatialTfSamplerForward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnSpatialTransformerDescriptor_t, Ptr{Cvoid},
           ...
           cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle, stDesc, alpha, xDesc, x, grid,
          beta, yDesc, y)
end
...
@checked function cudnnCreateDropoutDescriptor(dropoutDesc)
    ...
    ccall((:cudnnCreateDropoutDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnDropoutDescriptor_t},), dropoutDesc)
end
...
@checked function cudnnDropoutGetStatesSize(handle, sizeInBytes)
    ...
    ccall((:cudnnDropoutGetStatesSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, Ptr{Csize_t}), handle, sizeInBytes)
end
...
@checked function cudnnDropoutGetReserveSpaceSize(xdesc, sizeInBytes)
    ...
    ccall((:cudnnDropoutGetReserveSpaceSize, libcudnn), cudnnStatus_t,
          (cudnnTensorDescriptor_t, Ref{Csize_t}), xdesc, sizeInBytes)
end
...
@checked function cudnnSetDropoutDescriptor(dropoutDesc, handle, dropout, states,
    ...
    ccall((:cudnnSetDropoutDescriptor, libcudnn), cudnnStatus_t,
          (cudnnDropoutDescriptor_t, cudnnHandle_t, Cfloat, CuPtr{Cvoid}, Csize_t,
           Culonglong), dropoutDesc, handle, dropout, states, stateSizeInBytes, seed)
end
...
@checked function cudnnGetDropoutDescriptor(dropoutDesc, handle, dropout, states, seed)
    ...
    ccall((:cudnnGetDropoutDescriptor, libcudnn), cudnnStatus_t,
          (cudnnDropoutDescriptor_t, cudnnHandle_t, Ptr{Cfloat}, Ptr{CuPtr{Cvoid}},
           Ptr{Culonglong}), dropoutDesc, handle, dropout, states, seed)
end
...
@checked function cudnnDropoutForward(handle, dropoutDesc, xdesc, x, ydesc, y, reserveSpace,
    ...
    ccall((:cudnnDropoutForward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnDropoutDescriptor_t, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid}, Csize_t), handle,
          dropoutDesc, xdesc, x, ydesc, y, reserveSpace, reserveSpaceSizeInBytes)
end
...
@checked function cudnnCreateAlgorithmPerformance(algoPerf, numberToCreate)
    ...
    ccall((:cudnnCreateAlgorithmPerformance, libcudnn), cudnnStatus_t,
          (Ptr{cudnnAlgorithmPerformance_t}, Cint), algoPerf, numberToCreate)
end
...
@checked function cudnnSetAlgorithmPerformance(algoPerf, algoDesc, status, time, memory)
    ...
    ccall((:cudnnSetAlgorithmPerformance, libcudnn), cudnnStatus_t,
          (cudnnAlgorithmPerformance_t, cudnnAlgorithmDescriptor_t, cudnnStatus_t, Cfloat,
           Csize_t), algoPerf, algoDesc, status, time, memory)
end
...
@checked function cudnnGetAlgorithmPerformance(algoPerf, algoDesc, status, time, memory)
    ...
    ccall((:cudnnGetAlgorithmPerformance, libcudnn), cudnnStatus_t,
          (cudnnAlgorithmPerformance_t, Ptr{cudnnAlgorithmDescriptor_t}, Ptr{cudnnStatus_t},
           Ptr{Cfloat}, Ptr{Csize_t}), algoPerf, algoDesc, status, time, memory)
end
...
@checked function cudnnDestroyAlgorithmPerformance(algoPerf, numberToDestroy)
    ...
    ccall((:cudnnDestroyAlgorithmPerformance, libcudnn), cudnnStatus_t,
          (Ptr{cudnnAlgorithmPerformance_t}, Cint), algoPerf, numberToDestroy)
end
...
@checked function cudnnGetAlgorithmSpaceSize(handle, algoDesc, algoSpaceSizeInBytes)
    ...
    ccall((:cudnnGetAlgorithmSpaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnAlgorithmDescriptor_t, Ptr{Csize_t}), handle, algoDesc,
...
@checked function cudnnSaveAlgorithm(handle, algoDesc, algoSpace, algoSpaceSizeInBytes)
    ...
    ccall((:cudnnSaveAlgorithm, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnAlgorithmDescriptor_t, Ptr{Cvoid}, Csize_t), handle,
          algoDesc, algoSpace, algoSpaceSizeInBytes)
end
...
@checked function cudnnRestoreAlgorithm(handle, algoSpace, algoSpaceSizeInBytes, algoDesc)
    ...
    ccall((:cudnnRestoreAlgorithm, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, Ptr{Cvoid}, Csize_t, cudnnAlgorithmDescriptor_t), handle,
          algoSpace, algoSpaceSizeInBytes, algoDesc)
end
...
@checked function cudnnSetCallback(mask, udata, fptr)
    ccall((:cudnnSetCallback, libcudnn), cudnnStatus_t,
          (Cuint, Ptr{Cvoid}, cudnnCallback_t), mask, udata, fptr)
end

@checked function cudnnGetCallback(mask, udata, fptr)
    ccall((:cudnnGetCallback, libcudnn), cudnnStatus_t,
          (Ptr{Cuint}, Ptr{Ptr{Cvoid}}, Ptr{cudnnCallback_t}), mask, udata, fptr)
end
...
@checked function cudnnSoftmaxBackward(handle, algo, mode, alpha, yDesc, y, dyDesc, dy,
    ...
    ccall((:cudnnSoftmaxBackward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnSoftmaxAlgorithm_t, cudnnSoftmaxMode_t, Ptr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle, algo, mode, alpha,
          yDesc, y, dyDesc, dy, beta, dxDesc, dx)
end
...
@checked function cudnnPoolingBackward(handle, poolingDesc, alpha, yDesc, y, dyDesc, dy,
    ...
    ccall((:cudnnPoolingBackward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnPoolingDescriptor_t, Ptr{Cvoid}, cudnnTensorDescriptor_t,
           ...
           CuPtr{Cvoid}, Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle,
          poolingDesc, alpha, yDesc, y, dyDesc, dy, xDesc, x, beta, dxDesc, dx)
end
...
@checked function cudnnActivationBackward(handle, activationDesc, alpha, yDesc, y, dyDesc,
    ...
    ccall((:cudnnActivationBackward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnActivationDescriptor_t, Ptr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle,
          activationDesc, alpha, yDesc, y, dyDesc, dy, xDesc, x, beta, dxDesc, dx)
end
...
@checked function cudnnLRNCrossChannelBackward(handle, normDesc, lrnMode, alpha, yDesc, y,
    ...
    ccall((:cudnnLRNCrossChannelBackward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnLRNDescriptor_t, cudnnLRNMode_t, Ptr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, Ptr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}), handle, normDesc, lrnMode, alpha, yDesc, y, dyDesc, dy, xDesc, x,
          beta, dxDesc, dx)
end
...
@checked function cudnnGetBatchNormalizationForwardTrainingExWorkspaceSize(handle, mode,
                                                                           ...
                                                                           sizeInBytes)
    initialize_context()
    ccall((:cudnnGetBatchNormalizationForwardTrainingExWorkspaceSize, libcudnn),
          cudnnStatus_t,
          (cudnnHandle_t, cudnnBatchNormMode_t, cudnnBatchNormOps_t,
           cudnnTensorDescriptor_t, cudnnTensorDescriptor_t, cudnnTensorDescriptor_t,
           cudnnTensorDescriptor_t, cudnnActivationDescriptor_t, Ref{Csize_t}), handle,
          mode, bnOps, xDesc, zDesc, yDesc, bnScaleBiasMeanVarDesc, activationDesc,
          sizeInBytes)
end
...
@checked function cudnnGetBatchNormalizationBackwardExWorkspaceSize(handle, mode, bnOps,
    ...
    ccall((:cudnnGetBatchNormalizationBackwardExWorkspaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnBatchNormMode_t, cudnnBatchNormOps_t,
           cudnnTensorDescriptor_t, cudnnTensorDescriptor_t, cudnnTensorDescriptor_t,
           cudnnTensorDescriptor_t, cudnnTensorDescriptor_t, cudnnTensorDescriptor_t,
           cudnnActivationDescriptor_t, Ref{Csize_t}), handle, mode, bnOps, xDesc, yDesc,
          dyDesc, dzDesc, dxDesc, dBnScaleBiasDesc, activationDesc, sizeInBytes)
end
...
@checked function cudnnGetBatchNormalizationTrainingExReserveSpaceSize(handle, mode, bnOps,
    ...
    ccall((:cudnnGetBatchNormalizationTrainingExReserveSpaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnBatchNormMode_t, cudnnBatchNormOps_t,
           cudnnActivationDescriptor_t, cudnnTensorDescriptor_t, Ref{Csize_t}), handle,
...
@checked function cudnnBatchNormalizationForwardTraining(handle, mode, alpha, beta, xDesc,
    ...
    ccall((:cudnnBatchNormalizationForwardTraining, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnBatchNormMode_t, Ptr{Cvoid}, Ptr{Cvoid},
           ...
           CuPtr{Cvoid}, Cdouble, CuPtr{Cvoid}, CuPtr{Cvoid}), handle, mode, alpha, beta,
          xDesc, x, yDesc, y, bnScaleBiasMeanVarDesc, bnScale, bnBias,
          exponentialAverageFactor, resultRunningMean, resultRunningVariance, epsilon,
...
@checked function cudnnBatchNormalizationForwardTrainingEx(handle, mode, bnOps, alpha, beta,
    ...
    ccall((:cudnnBatchNormalizationForwardTrainingEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnBatchNormMode_t, cudnnBatchNormOps_t, Ptr{Cvoid}, Ptr{Cvoid},
           ...
           Csize_t), handle, mode, bnOps, alpha, beta, xDesc, xData, zDesc, zData, yDesc,
...
@checked function cudnnBatchNormalizationBackward(handle, mode, alphaDataDiff, betaDataDiff,
    ...
    ccall((:cudnnBatchNormalizationBackward, libcudnn), cudnnStatus_t,
          ...
          handle, mode, alphaDataDiff, betaDataDiff, alphaParamDiff, betaParamDiff, xDesc,
          x, dyDesc, dy, dxDesc, dx, dBnScaleBiasDesc, bnScale, dBnScaleResult,
          dBnBiasResult, epsilon, savedMean, savedInvVariance)
end
...
@checked function cudnnBatchNormalizationBackwardEx(handle, mode, bnOps, alphaDataDiff,
    ...
    ccall((:cudnnBatchNormalizationBackwardEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnBatchNormMode_t, cudnnBatchNormOps_t, Ptr{Cvoid}, Ptr{Cvoid},
           ...
           Csize_t, CuPtr{Cvoid}, Csize_t), handle, mode, bnOps, alphaDataDiff,
          betaDataDiff, alphaParamDiff, betaParamDiff, xDesc, xData, yDesc, yData, dyDesc,
          dyData, dzDesc, dzData, dxDesc, dxData, dBnScaleBiasDesc, bnScaleData, bnBiasData,
          dBnScaleData, dBnBiasData, epsilon, savedMean, savedInvVariance, activationDesc,
...
@checked function cudnnGetNormalizationForwardTrainingWorkspaceSize(handle, mode, normOps,
    ...
    initialize_context()
    ccall((:cudnnGetNormalizationForwardTrainingWorkspaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnNormMode_t, cudnnNormOps_t, cudnnNormAlgo_t,
           cudnnTensorDescriptor_t, cudnnTensorDescriptor_t, cudnnTensorDescriptor_t,
           cudnnTensorDescriptor_t, cudnnActivationDescriptor_t, cudnnTensorDescriptor_t,
           Ref{Csize_t}, Cint), handle, mode, normOps, algo, xDesc, zDesc, yDesc,
          normScaleBiasDesc, activationDesc, normMeanVarDesc, sizeInBytes, groupCnt)
end
...
@checked function cudnnGetNormalizationBackwardWorkspaceSize(handle, mode, normOps, algo,
                                                             ...
                                                             groupCnt)
    initialize_context()
    ccall((:cudnnGetNormalizationBackwardWorkspaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnNormMode_t, cudnnNormOps_t, cudnnNormAlgo_t,
           cudnnTensorDescriptor_t, cudnnTensorDescriptor_t, cudnnTensorDescriptor_t,
           cudnnTensorDescriptor_t, cudnnTensorDescriptor_t, cudnnTensorDescriptor_t,
           cudnnActivationDescriptor_t, cudnnTensorDescriptor_t, Ref{Csize_t}, Cint),
          handle, mode, normOps, algo, xDesc, yDesc, dyDesc, dzDesc, dxDesc,
          dNormScaleBiasDesc, activationDesc, normMeanVarDesc, sizeInBytes, groupCnt)
end
...
@checked function cudnnGetNormalizationTrainingReserveSpaceSize(handle, mode, normOps, algo,
                                                                ...
                                                                sizeInBytes, groupCnt)
    initialize_context()
    ccall((:cudnnGetNormalizationTrainingReserveSpaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnNormMode_t, cudnnNormOps_t, cudnnNormAlgo_t,
           cudnnActivationDescriptor_t, cudnnTensorDescriptor_t, Ref{Csize_t}, Cint),
...
@checked function cudnnNormalizationForwardTraining(handle, mode, normOps, algo, alpha,
                                                    ...
                                                    groupCnt)
    initialize_context()
    ccall((:cudnnNormalizationForwardTraining, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnNormMode_t, cudnnNormOps_t, cudnnNormAlgo_t, Ptr{Cvoid},
           Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, CuPtr{Cvoid}, Cdouble, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           CuPtr{Cvoid}, Cdouble, CuPtr{Cvoid}, CuPtr{Cvoid}, cudnnActivationDescriptor_t,
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}, Csize_t, Cint), handle, mode, normOps, algo,
          alpha, beta, xDesc, xData, normScaleBiasDesc, normScale, normBias,
          exponentialAverageFactor, normMeanVarDesc, resultRunningMean,
          resultRunningVariance, epsilon, resultSaveMean, resultSaveInvVariance,
          activationDesc, zDesc, zData, yDesc, yData, workspace, workSpaceSizeInBytes,
...
@checked function cudnnNormalizationBackward(handle, mode, normOps, algo, alphaDataDiff,
    ...
    initialize_context()
    ccall((:cudnnNormalizationBackward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnNormMode_t, cudnnNormOps_t, cudnnNormAlgo_t, Ptr{Cvoid},
           Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid}, CuPtr{Cvoid}, CuPtr{Cvoid},
           Cdouble, cudnnTensorDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid},
           cudnnActivationDescriptor_t, CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}, Csize_t, Cint),
          handle, mode, normOps, algo, alphaDataDiff, betaDataDiff, alphaParamDiff,
          betaParamDiff, xDesc, xData, yDesc, yData, dyDesc, dyData, dzDesc, dzData, dxDesc,
          dxData, dNormScaleBiasDesc, normScaleData, normBiasData, dNormScaleData,
          dNormBiasData, epsilon, normMeanVarDesc, savedMean, savedInvVariance,
...
@checked function cudnnSpatialTfSamplerBackward(handle, stDesc, alpha, xDesc, x, beta,
    ...
    ccall((:cudnnSpatialTfSamplerBackward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnSpatialTransformerDescriptor_t, Ptr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, Ptr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid},
           Ptr{Cvoid}, CuPtr{Cvoid}), handle, stDesc, alpha, xDesc, x, beta, dxDesc, dx,
...
@checked function cudnnDropoutBackward(handle, dropoutDesc, dydesc, dy, dxdesc, dx,
    ...
    ccall((:cudnnDropoutBackward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnDropoutDescriptor_t, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid}, Csize_t), handle,
          dropoutDesc, dydesc, dy, dxdesc, dx, reserveSpace, reserveSpaceSizeInBytes)
end
...
@checked function cudnnCreateRNNDescriptor(rnnDesc)
    ...
    ccall((:cudnnCreateRNNDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnRNNDescriptor_t},), rnnDesc)
end

@checked function cudnnDestroyRNNDescriptor(rnnDesc)
    initialize_context()
    ccall((:cudnnDestroyRNNDescriptor, libcudnn), cudnnStatus_t, (cudnnRNNDescriptor_t,),
          rnnDesc)
end
...
@checked function cudnnSetRNNDescriptor_v8(rnnDesc, algo, cellMode, biasMode, dirMode,
    ...
    initialize_context()
    ccall((:cudnnSetRNNDescriptor_v8, libcudnn), cudnnStatus_t,
          (cudnnRNNDescriptor_t, cudnnRNNAlgo_t, cudnnRNNMode_t, cudnnRNNBiasMode_t,
           cudnnDirectionMode_t, cudnnRNNInputMode_t, cudnnDataType_t, cudnnDataType_t,
           cudnnMathType_t, Int32, Int32, Int32, Int32, cudnnDropoutDescriptor_t, UInt32),
          rnnDesc, algo, cellMode, biasMode, dirMode, inputMode, dataType, mathPrec,
          mathType, inputSize, hiddenSize, projSize, numLayers, dropoutDesc, auxFlags)
end
...
@checked function cudnnGetRNNDescriptor_v8(rnnDesc, algo, cellMode, biasMode, dirMode,
                                           ...
                                           dropoutDesc, auxFlags)
    initialize_context()
    ccall((:cudnnGetRNNDescriptor_v8, libcudnn), cudnnStatus_t,
          (cudnnRNNDescriptor_t, Ref{cudnnRNNAlgo_t}, Ref{cudnnRNNMode_t},
           Ref{cudnnRNNBiasMode_t}, Ref{cudnnDirectionMode_t}, Ref{cudnnRNNInputMode_t},
           Ref{cudnnDataType_t}, Ref{cudnnDataType_t}, Ref{cudnnMathType_t}, Ref{Int32},
           Ref{Int32}, Ref{Int32}, Ref{Int32}, Ref{cudnnDropoutDescriptor_t}, Ref{UInt32}),
          rnnDesc, algo, cellMode, biasMode, dirMode, inputMode, dataType, mathPrec,
          mathType, inputSize, hiddenSize, projSize, numLayers, dropoutDesc, auxFlags)
end
...
@checked function cudnnSetRNNDescriptor_v6(handle, rnnDesc, hiddenSize, numLayers,
    ...
    ccall((:cudnnSetRNNDescriptor_v6, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Cint, Cint, cudnnDropoutDescriptor_t,
           ...
           cudnnDataType_t), handle, rnnDesc, hiddenSize, numLayers, dropoutDesc, inputMode,
          direction, cellMode, algo, mathPrec)
end
...
@checked function cudnnGetRNNDescriptor_v6(handle, rnnDesc, hiddenSize, numLayers,
                                           ...
                                           algo, mathPrec)
    initialize_context()
    ccall((:cudnnGetRNNDescriptor_v6, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Ref{Cint}, Ref{Cint},
           Ref{cudnnDropoutDescriptor_t}, Ref{cudnnRNNInputMode_t},
           Ref{cudnnDirectionMode_t}, Ref{cudnnRNNMode_t}, Ref{cudnnRNNAlgo_t},
           Ref{cudnnDataType_t}), handle, rnnDesc, hiddenSize, numLayers, dropoutDesc,
...
@checked function cudnnSetRNNMatrixMathType(rnnDesc, mType)
    ...
    ccall((:cudnnSetRNNMatrixMathType, libcudnn), cudnnStatus_t,
          (cudnnRNNDescriptor_t, cudnnMathType_t), rnnDesc, mType)
end

@checked function cudnnGetRNNMatrixMathType(rnnDesc, mType)
    initialize_context()
    ccall((:cudnnGetRNNMatrixMathType, libcudnn), cudnnStatus_t,
          (cudnnRNNDescriptor_t, Ptr{cudnnMathType_t}), rnnDesc, mType)
end

@checked function cudnnSetRNNBiasMode(rnnDesc, biasMode)
    initialize_context()
    ccall((:cudnnSetRNNBiasMode, libcudnn), cudnnStatus_t,
          (cudnnRNNDescriptor_t, cudnnRNNBiasMode_t), rnnDesc, biasMode)
end

@checked function cudnnGetRNNBiasMode(rnnDesc, biasMode)
    initialize_context()
    ccall((:cudnnGetRNNBiasMode, libcudnn), cudnnStatus_t,
          (cudnnRNNDescriptor_t, Ptr{cudnnRNNBiasMode_t}), rnnDesc, biasMode)
end

@checked function cudnnRNNSetClip_v8(rnnDesc, clipMode, clipNanOpt, lclip, rclip)
    initialize_context()
    ccall((:cudnnRNNSetClip_v8, libcudnn), cudnnStatus_t,
          (cudnnRNNDescriptor_t, cudnnRNNClipMode_t, cudnnNanPropagation_t, Cdouble,
           Cdouble), rnnDesc, clipMode, clipNanOpt, lclip, rclip)
end

@checked function cudnnRNNGetClip_v8(rnnDesc, clipMode, clipNanOpt, lclip, rclip)
    initialize_context()
    ccall((:cudnnRNNGetClip_v8, libcudnn), cudnnStatus_t,
          (cudnnRNNDescriptor_t, Ref{cudnnRNNClipMode_t}, Ref{cudnnNanPropagation_t},
           Ref{Cdouble}, Ref{Cdouble}), rnnDesc, clipMode, clipNanOpt, lclip, rclip)
end
...
@checked function cudnnRNNSetClip(handle, rnnDesc, clipMode, clipNanOpt, lclip, rclip)
    ...
    ccall((:cudnnRNNSetClip, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, cudnnRNNClipMode_t, cudnnNanPropagation_t,
           Cdouble, Cdouble), handle, rnnDesc, clipMode, clipNanOpt, lclip, rclip)
end
...
@checked function cudnnRNNGetClip(handle, rnnDesc, clipMode, clipNanOpt, lclip, rclip)
    ...
    ccall((:cudnnRNNGetClip, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Ptr{cudnnRNNClipMode_t},
           Ptr{cudnnNanPropagation_t}, Ptr{Cdouble}, Ptr{Cdouble}), handle, rnnDesc,
          clipMode, clipNanOpt, lclip, rclip)
end
...
@checked function cudnnSetRNNProjectionLayers(handle, rnnDesc, recProjSize, outProjSize)
    ...
    ccall((:cudnnSetRNNProjectionLayers, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Cint, Cint), handle, rnnDesc, recProjSize,
          outProjSize)
end
...
@checked function cudnnGetRNNProjectionLayers(handle, rnnDesc, recProjSize, outProjSize)
    ...
    ccall((:cudnnGetRNNProjectionLayers, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Ptr{Cint}, Ptr{Cint}), handle, rnnDesc,
...
@checked function cudnnSetPersistentRNNPlan(rnnDesc, plan)
    ...
    ccall((:cudnnSetPersistentRNNPlan, libcudnn), cudnnStatus_t,
          (cudnnRNNDescriptor_t, cudnnPersistentRNNPlan_t), rnnDesc, plan)
end

@checked function cudnnBuildRNNDynamic(handle, rnnDesc, miniBatch)
    initialize_context()
    ccall((:cudnnBuildRNNDynamic, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Cint), handle, rnnDesc, miniBatch)
end
...
@checked function cudnnGetRNNWorkspaceSize(handle, rnnDesc, seqLength, xDesc, sizeInBytes)
    ...
    ccall((:cudnnGetRNNWorkspaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Cint, Ptr{cudnnTensorDescriptor_t},
           Ref{Csize_t}), handle, rnnDesc, seqLength, xDesc, sizeInBytes)
end
...
@checked function cudnnGetRNNTempSpaceSizes(handle, rnnDesc, fMode, xDesc, workSpaceSize,
                                            reserveSpaceSize)
    initialize_context()
    ccall((:cudnnGetRNNTempSpaceSizes, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, cudnnForwardMode_t,
           cudnnRNNDataDescriptor_t, Ref{Csize_t}, Ref{Csize_t}), handle, rnnDesc, fMode,
...
@checked function cudnnGetRNNParamsSize(handle, rnnDesc, xDesc, sizeInBytes, dataType)
    ...
    ccall((:cudnnGetRNNParamsSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, cudnnTensorDescriptor_t, Ref{Csize_t},
           cudnnDataType_t), handle, rnnDesc, xDesc, sizeInBytes, dataType)
end

@checked function cudnnGetRNNWeightSpaceSize(handle, rnnDesc, weightSpaceSize)
    initialize_context()
    ccall((:cudnnGetRNNWeightSpaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Ref{Csize_t}), handle, rnnDesc,
          weightSpaceSize)
end
...
@checked function cudnnGetRNNLinLayerMatrixParams(handle, rnnDesc, pseudoLayer, xDesc,
    ...
    ccall((:cudnnGetRNNLinLayerMatrixParams, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Cint, cudnnTensorDescriptor_t,
           ...
           Ptr{Ptr{Cvoid}}), handle, rnnDesc, pseudoLayer, xDesc, wDesc, w, linLayerID,
...
@checked function cudnnGetRNNWeightParams(handle, rnnDesc, pseudoLayer, weightSpaceSize,
                                          ...
                                          bAddr)
    initialize_context()
    ccall((:cudnnGetRNNWeightParams, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Int32, Csize_t, CuPtr{Cvoid}, Int32,
           cudnnTensorDescriptor_t, Ptr{CuPtr{Cvoid}}, cudnnTensorDescriptor_t,
           Ptr{CuPtr{Cvoid}}), handle, rnnDesc, pseudoLayer, weightSpaceSize, weightSpace,
...
@checked function cudnnSetRNNPaddingMode(rnnDesc, paddingMode)
    initialize_context()
    ccall((:cudnnSetRNNPaddingMode, libcudnn), cudnnStatus_t, (cudnnRNNDescriptor_t, Cuint),
          rnnDesc, paddingMode)
end
...
@checked function cudnnSetRNNDataDescriptor(rnnDataDesc, dataType, layout, maxSeqLength,
    ...
    ccall((:cudnnSetRNNDataDescriptor, libcudnn), cudnnStatus_t,
          (cudnnRNNDataDescriptor_t, cudnnDataType_t, cudnnRNNDataLayout_t, Cint, Cint,
           Cint, Ptr{Cint}, Ptr{Cvoid}), rnnDataDesc, dataType, layout, maxSeqLength,
...
@checked function cudnnGetRNNDataDescriptor(rnnDataDesc, dataType, layout, maxSeqLength,
    ...
    ccall((:cudnnGetRNNDataDescriptor, libcudnn), cudnnStatus_t,
          (cudnnRNNDataDescriptor_t, Ptr{cudnnDataType_t}, Ptr{cudnnRNNDataLayout_t},
           Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Cint, Ptr{Cint}, Ptr{Cvoid}), rnnDataDesc,
          dataType, layout, maxSeqLength, batchSize, vectorSize, arrayLengthRequested,
          seqLengthArray, paddingFill)
end
...
@checked function cudnnRNNForwardInferenceEx(handle, rnnDesc, xDesc, x, hxDesc, hx, cxDesc,
    ...
    ccall((:cudnnRNNForwardInferenceEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, cudnnRNNDataDescriptor_t, CuPtr{Cvoid},
           ...
           CuPtr{Cvoid}, Csize_t), handle, rnnDesc, xDesc, x, hxDesc, hx, cxDesc, cx, wDesc,
          w, yDesc, y, hyDesc, hy, cyDesc, cy, kDesc, keys, cDesc, cAttn, iDesc, iAttn,
...
@checked function cudnnRNNForward(handle, rnnDesc, fwdMode, devSeqLengths, xDesc, x, yDesc,
                                  ...
                                  reserveSpace)
    initialize_context()
    ccall((:cudnnRNNForward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, cudnnForwardMode_t, CuPtr{Int32},
           cudnnRNNDataDescriptor_t, CuPtr{Cvoid}, cudnnRNNDataDescriptor_t, CuPtr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid},
           Csize_t, CuPtr{Cvoid}), handle, rnnDesc, fwdMode, devSeqLengths, xDesc, x, yDesc,
          y, hDesc, hx, hy, cDesc, cx, cy, weightSpaceSize, weightSpace, workSpaceSize,
...
@checked function cudnnSetRNNAlgorithmDescriptor(handle, rnnDesc, algoDesc)
    ...
    ccall((:cudnnSetRNNAlgorithmDescriptor, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, cudnnAlgorithmDescriptor_t), handle,
          rnnDesc, algoDesc)
end
...
@checked function cudnnGetRNNForwardInferenceAlgorithmMaxCount(handle, rnnDesc, count)
    ...
    ccall((:cudnnGetRNNForwardInferenceAlgorithmMaxCount, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Ptr{Cint}), handle, rnnDesc, count)
end
...
@checked function cudnnFindRNNForwardInferenceAlgorithmEx(handle, rnnDesc, seqLength, xDesc,
    ...
    ccall((:cudnnFindRNNForwardInferenceAlgorithmEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Cint, Ptr{cudnnTensorDescriptor_t},
           ...
           Ptr{cudnnAlgorithmPerformance_t}, CuPtr{Cvoid}, Csize_t), handle, rnnDesc,
          seqLength, xDesc, x, hxDesc, hx, cxDesc, cx, wDesc, w, yDesc, y, hyDesc, hy,
          cyDesc, cy, findIntensity, requestedAlgoCount, returnedAlgoCount, perfResults,
          workspace, workSpaceSizeInBytes)
end
...
@checked function cudnnCreateSeqDataDescriptor(seqDataDesc)
    ...
    ccall((:cudnnCreateSeqDataDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnSeqDataDescriptor_t},), seqDataDesc)
end
...
@checked function cudnnSetSeqDataDescriptor(seqDataDesc, dataType, nbDims, dimA, axes,
    ...
    ccall((:cudnnSetSeqDataDescriptor, libcudnn), cudnnStatus_t,
          (cudnnSeqDataDescriptor_t, cudnnDataType_t, Cint, Ptr{Cint},
           Ptr{cudnnSeqDataAxis_t}, Csize_t, Ptr{Cint}, Ptr{Cvoid}), seqDataDesc, dataType,
          nbDims, dimA, axes, seqLengthArraySize, seqLengthArray, paddingFill)
end
...
@checked function cudnnCreateAttnDescriptor(attnDesc)
    ...
    ccall((:cudnnCreateAttnDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnAttnDescriptor_t},), attnDesc)
end

@checked function cudnnDestroyAttnDescriptor(attnDesc)
    initialize_context()
    ccall((:cudnnDestroyAttnDescriptor, libcudnn), cudnnStatus_t, (cudnnAttnDescriptor_t,),
          attnDesc)
end
...
@checked function cudnnSetAttnDescriptor(attnDesc, attnMode, nHeads, smScaler, dataType,
    ...
    ccall((:cudnnSetAttnDescriptor, libcudnn), cudnnStatus_t,
          (cudnnAttnDescriptor_t, Cuint, Cint, Cdouble, cudnnDataType_t, cudnnDataType_t,
           cudnnMathType_t, cudnnDropoutDescriptor_t, cudnnDropoutDescriptor_t, Cint, Cint,
           Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), attnDesc, attnMode,
          nHeads, smScaler, dataType, computePrec, mathType, attnDropoutDesc,
...
@checked function cudnnGetAttnDescriptor(attnDesc, attnMode, nHeads, smScaler, dataType,
    ...
    ccall((:cudnnGetAttnDescriptor, libcudnn), cudnnStatus_t,
          (cudnnAttnDescriptor_t, Ptr{Cuint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{cudnnDataType_t},
...
@checked function cudnnGetMultiHeadAttnWeights(handle, attnDesc, wKind, weightSizeInBytes,
    ...
    ccall((:cudnnGetMultiHeadAttnWeights, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnAttnDescriptor_t, cudnnMultiHeadAttnWeightKind_t, Csize_t,
           CuPtr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Ptr{Cvoid}}), handle, attnDesc,
          wKind, weightSizeInBytes, weights, wDesc, wAddr)
end
...
@checked function cudnnMultiHeadAttnForward(handle, attnDesc, currIdx, loWinIdx, hiWinIdx,
    ...
    ccall((:cudnnMultiHeadAttnForward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnAttnDescriptor_t, Cint, Ptr{Cint}, Ptr{Cint}, CuPtr{Cint},
           CuPtr{Cint}, cudnnSeqDataDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid},
           ...
           CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}), handle, attnDesc, currIdx, loWinIdx,
          hiWinIdx, devSeqLengthsQO, devSeqLengthsKV, qDesc, queries, residuals, kDesc,
          keys, vDesc, values, oDesc, out, weightSizeInBytes, weights, workSpaceSizeInBytes,
...
@checked function cudnnRNNForwardTraining(handle, rnnDesc, seqLength, xDesc, x, hxDesc, hx,
    ...
    ccall((:cudnnRNNForwardTraining, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Cint, Ptr{cudnnTensorDescriptor_t},
           ...
           Ptr{cudnnTensorDescriptor_t}, CuPtr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid}, Csize_t,
           CuPtr{Cvoid}, Csize_t), handle, rnnDesc, seqLength, xDesc, x, hxDesc, hx, cxDesc,
          cx, wDesc, w, yDesc, y, hyDesc, hy, cyDesc, cy, workSpace, workSpaceSizeInBytes,
          reserveSpace, reserveSpaceSizeInBytes)
end
...
@checked function cudnnRNNBackwardData(handle, rnnDesc, seqLength, yDesc, y, dyDesc, dy,
    ...
    ccall((:cudnnRNNBackwardData, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Cint, Ptr{cudnnTensorDescriptor_t},
           ...
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, Ptr{cudnnTensorDescriptor_t},
           CuPtr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}, Csize_t), handle, rnnDesc,
          seqLength, yDesc, y, dyDesc, dy, dhyDesc, dhy, dcyDesc, dcy, wDesc, w, hxDesc, hx,
          cxDesc, cx, dxDesc, dx, dhxDesc, dhx, dcxDesc, dcx, workSpace,
...
@checked function cudnnRNNBackwardData_v8(handle, rnnDesc, devSeqLengths, yDesc, y, dy,
                                          ...
                                          workSpace, reserveSpaceSize, reserveSpace)
    initialize_context()
    ccall((:cudnnRNNBackwardData_v8, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, CuPtr{Int32}, cudnnRNNDataDescriptor_t,
           CuPtr{Cvoid}, CuPtr{Cvoid}, cudnnRNNDataDescriptor_t, CuPtr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid}, CuPtr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid}, CuPtr{Cvoid}, Csize_t,
           CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}), handle, rnnDesc,
          devSeqLengths, yDesc, y, dy, xDesc, dx, hDesc, hx, dhy, dhx, cDesc, cx, dcy, dcx,
          weightSpaceSize, weightSpace, workSpaceSize, workSpace, reserveSpaceSize,
          reserveSpace)
end
...
@checked function cudnnRNNBackwardWeights(handle, rnnDesc, seqLength, xDesc, x, hxDesc, hx,
    ...
    ccall((:cudnnRNNBackwardWeights, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Cint, Ptr{cudnnTensorDescriptor_t},
           ...
           cudnnFilterDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid}, Csize_t), handle, rnnDesc,
          seqLength, xDesc, x, hxDesc, hx, yDesc, y, workSpace, workSpaceSizeInBytes,
...
@checked function cudnnRNNBackwardWeights_v8(handle, rnnDesc, addGrad, devSeqLengths, xDesc,
    ...
    initialize_context()
    ccall((:cudnnRNNBackwardWeights_v8, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, cudnnWgradMode_t, CuPtr{Int32},
           cudnnRNNDataDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           cudnnRNNDataDescriptor_t, CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}, Csize_t,
           CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}), handle, rnnDesc, addGrad, devSeqLengths,
          xDesc, x, hDesc, hx, yDesc, y, weightSpaceSize, dweightSpace, workSpaceSize,
          workSpace, reserveSpaceSize, reserveSpace)
end
...
@checked function cudnnRNNForwardTrainingEx(handle, rnnDesc, xDesc, x, hxDesc, hx, cxDesc,
    ...
    ccall((:cudnnRNNForwardTrainingEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, cudnnRNNDataDescriptor_t, CuPtr{Cvoid},
           ...
           cudnnRNNDataDescriptor_t, CuPtr{Cvoid}, cudnnRNNDataDescriptor_t, CuPtr{Cvoid},
           cudnnRNNDataDescriptor_t, CuPtr{Cvoid}, cudnnRNNDataDescriptor_t, CuPtr{Cvoid},
           CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}, Csize_t), handle, rnnDesc, xDesc, x, hxDesc,
          hx, cxDesc, cx, wDesc, w, yDesc, y, hyDesc, hy, cyDesc, cy, kDesc, keys, cDesc,
...
@checked function cudnnRNNBackwardDataEx(handle, rnnDesc, yDesc, y, dyDesc, dy, dcDesc,
    ...
    ccall((:cudnnRNNBackwardDataEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, cudnnRNNDataDescriptor_t, CuPtr{Cvoid},
           ...
           cudnnRNNDataDescriptor_t, Ptr{Cvoid}, CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid},
           Csize_t), handle, rnnDesc, yDesc, y, dyDesc, dy, dcDesc, dcAttn, dhyDesc, dhy,
          dcyDesc, dcy, wDesc, w, hxDesc, hx, cxDesc, cx, dxDesc, dx, dhxDesc, dhx, dcxDesc,
          dcx, dkDesc, dkeys, workSpace, workSpaceSizeInBytes, reserveSpace,
          reserveSpaceSizeInBytes)
end
...
@checked function cudnnRNNBackwardWeightsEx(handle, rnnDesc, xDesc, x, hxDesc, hx, yDesc, y,
    ...
    ccall((:cudnnRNNBackwardWeightsEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, cudnnRNNDataDescriptor_t, CuPtr{Cvoid},
           ...
           Csize_t), handle, rnnDesc, xDesc, x, hxDesc, hx, yDesc, y, workSpace,
...
@checked function cudnnFindRNNBackwardDataAlgorithmEx(handle, rnnDesc, seqLength, yDesc, y,
    ...
    ccall((:cudnnFindRNNBackwardDataAlgorithmEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Cint, Ptr{cudnnTensorDescriptor_t},
           ...
           CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}, Csize_t), handle, rnnDesc, seqLength, yDesc,
          y, dyDesc, dy, dhyDesc, dhy, dcyDesc, dcy, wDesc, w, hxDesc, hx, cxDesc, cx,
          dxDesc, dx, dhxDesc, dhx, dcxDesc, dcx, findIntensity, requestedAlgoCount,
...
@checked function cudnnFindRNNBackwardWeightsAlgorithmEx(handle, rnnDesc, seqLength, xDesc,
    ...
    ccall((:cudnnFindRNNBackwardWeightsAlgorithmEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnRNNDescriptor_t, Cint, Ptr{cudnnTensorDescriptor_t},
           ...
           Ptr{cudnnAlgorithmPerformance_t}, CuPtr{Cvoid}, Csize_t, cudnnFilterDescriptor_t,
           CuPtr{Cvoid}, CuPtr{Cvoid}, Csize_t), handle, rnnDesc, seqLength, xDesc, x,
          hxDesc, hx, yDesc, y, findIntensity, requestedAlgoCount, returnedAlgoCount,
          perfResults, workspace, workSpaceSizeInBytes, dwDesc, dw, reserveSpace,
          reserveSpaceSizeInBytes)
end
...
@checked function cudnnMultiHeadAttnBackwardData(handle, attnDesc, loWinIdx, hiWinIdx,
    ...
    ccall((:cudnnMultiHeadAttnBackwardData, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnAttnDescriptor_t, Ptr{Cint}, Ptr{Cint}, CuPtr{Cint},
           CuPtr{Cint}, cudnnSeqDataDescriptor_t, CuPtr{Cvoid}, cudnnSeqDataDescriptor_t,
           CuPtr{Cvoid}, CuPtr{Cvoid}, cudnnSeqDataDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid},
           cudnnSeqDataDescriptor_t, CuPtr{Cvoid}, CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid},
           Csize_t, CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}), handle, attnDesc, loWinIdx,
          hiWinIdx, devSeqLengthsDQDO, devSeqLengthsDKDV, doDesc, dout, dqDesc, dqueries,
          queries, dkDesc, dkeys, keys, dvDesc, dvalues, values, weightSizeInBytes, weights,
...
@checked function cudnnMultiHeadAttnBackwardWeights(handle, attnDesc, addGrad, qDesc,
    ...
    ccall((:cudnnMultiHeadAttnBackwardWeights, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnAttnDescriptor_t, cudnnWgradMode_t, cudnnSeqDataDescriptor_t,
           ...
           CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}, Csize_t, CuPtr{Cvoid}), handle, attnDesc,
          addGrad, qDesc, queries, kDesc, keys, vDesc, values, doDesc, dout,
...
@checked function cudnnSetCTCLossDescriptorEx(ctcLossDesc, compType, normMode, gradMode)
    ...
    ccall((:cudnnSetCTCLossDescriptorEx, libcudnn), cudnnStatus_t,
          (cudnnCTCLossDescriptor_t, cudnnDataType_t, cudnnLossNormalizationMode_t,
           cudnnNanPropagation_t), ctcLossDesc, compType, normMode, gradMode)
end

@checked function cudnnSetCTCLossDescriptor_v8(ctcLossDesc, compType, normMode, gradMode,
                                               maxLabelLength)
    initialize_context()
    ccall((:cudnnSetCTCLossDescriptor_v8, libcudnn), cudnnStatus_t,
          (cudnnCTCLossDescriptor_t, cudnnDataType_t, cudnnLossNormalizationMode_t,
           cudnnNanPropagation_t, Cint), ctcLossDesc, compType, normMode, gradMode,
          maxLabelLength)
end
...
@checked function cudnnGetCTCLossDescriptor(ctcLossDesc, compType)
    ...
    ccall((:cudnnGetCTCLossDescriptor, libcudnn), cudnnStatus_t,
          (cudnnCTCLossDescriptor_t, Ptr{cudnnDataType_t}), ctcLossDesc, compType)
end
...
@checked function cudnnGetCTCLossDescriptorEx(ctcLossDesc, compType, normMode, gradMode)
    ...
    ccall((:cudnnGetCTCLossDescriptorEx, libcudnn), cudnnStatus_t,
          (cudnnCTCLossDescriptor_t, Ptr{cudnnDataType_t},
           Ptr{cudnnLossNormalizationMode_t}, Ptr{cudnnNanPropagation_t}), ctcLossDesc,
          compType, normMode, gradMode)
end

@checked function cudnnGetCTCLossDescriptor_v8(ctcLossDesc, compType, normMode, gradMode,
                                               maxLabelLength)
    initialize_context()
    ccall((:cudnnGetCTCLossDescriptor_v8, libcudnn), cudnnStatus_t,
          (cudnnCTCLossDescriptor_t, Ref{cudnnDataType_t},
           Ref{cudnnLossNormalizationMode_t}, Ref{cudnnNanPropagation_t}, Ref{Cint}),
...
@checked function cudnnCTCLoss(handle, probsDesc, probs, hostLabels, hostLabelLengths,
    ...
    ccall((:cudnnCTCLoss, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorDescriptor_t, CuPtr{Cvoid}, Ptr{Cint}, Ptr{Cint},
           ...
           cudnnCTCLossAlgo_t, cudnnCTCLossDescriptor_t, CuPtr{Cvoid}, Csize_t), handle,
          probsDesc, probs, hostLabels, hostLabelLengths, hostInputLengths, costs,
...
@checked function cudnnCTCLoss_v8(handle, algo, ctcLossDesc, probsDesc, probs, labels,
    ...
    initialize_context()
    ccall((:cudnnCTCLoss_v8, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnCTCLossAlgo_t, cudnnCTCLossDescriptor_t,
           cudnnTensorDescriptor_t, Ptr{Cvoid}, CuPtr{Cint}, CuPtr{Cint}, CuPtr{Cint},
           Ptr{Cvoid}, cudnnTensorDescriptor_t, Ptr{Cvoid}, Csize_t, CuPtr{Cvoid}), handle,
          algo, ctcLossDesc, probsDesc, probs, labels, labelLengths, inputLengths, costs,
          gradientsDesc, gradients, workSpaceSizeInBytes, workspace)
end
...
@checked function cudnnGetCTCLossWorkspaceSize(handle, probsDesc, gradientsDesc, labels,
    ...
    ccall((:cudnnGetCTCLossWorkspaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorDescriptor_t, cudnnTensorDescriptor_t, Ptr{Cint},
           Ptr{Cint}, Ptr{Cint}, cudnnCTCLossAlgo_t, cudnnCTCLossDescriptor_t,
           Ref{Csize_t}), handle, probsDesc, gradientsDesc, labels, labelLengths,
...
@checked function cudnnGetCTCLossWorkspaceSize_v8(handle, algo, ctcLossDesc, probsDesc,
    ...
    initialize_context()
    ccall((:cudnnGetCTCLossWorkspaceSize_v8, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnCTCLossAlgo_t, cudnnCTCLossDescriptor_t,
           cudnnTensorDescriptor_t, cudnnTensorDescriptor_t, Ptr{Csize_t}), handle, algo,
          ctcLossDesc, probsDesc, gradientsDesc, sizeInBytes)
end
...
@checked function cudnnCreateConvolutionDescriptor(convDesc)
    ...
    ccall((:cudnnCreateConvolutionDescriptor, libcudnn), cudnnStatus_t,
          (Ptr{cudnnConvolutionDescriptor_t},), convDesc)
end
...
@checked function cudnnSetConvolutionMathType(convDesc, mathType)
    ...
    ccall((:cudnnSetConvolutionMathType, libcudnn), cudnnStatus_t,
          (cudnnConvolutionDescriptor_t, cudnnMathType_t), convDesc, mathType)
end

@checked function cudnnGetConvolutionMathType(convDesc, mathType)
    initialize_context()
    ccall((:cudnnGetConvolutionMathType, libcudnn), cudnnStatus_t,
          (cudnnConvolutionDescriptor_t, Ptr{cudnnMathType_t}), convDesc, mathType)
end
...
@checked function cudnnSetConvolutionGroupCount(convDesc, groupCount)
    ...
    ccall((:cudnnSetConvolutionGroupCount, libcudnn), cudnnStatus_t,
          (cudnnConvolutionDescriptor_t, Cint), convDesc, groupCount)
end
...
@checked function cudnnGetConvolutionGroupCount(convDesc, groupCount)
    ...
    ccall((:cudnnGetConvolutionGroupCount, libcudnn), cudnnStatus_t,
          (cudnnConvolutionDescriptor_t, Ptr{Cint}), convDesc, groupCount)
end
...
@checked function cudnnSetConvolutionReorderType(convDesc, reorderType)
    ...
    ccall((:cudnnSetConvolutionReorderType, libcudnn), cudnnStatus_t,
          (cudnnConvolutionDescriptor_t, cudnnReorderType_t), convDesc, reorderType)
end
...
@checked function cudnnGetConvolutionReorderType(convDesc, reorderType)
    ...
    ccall((:cudnnGetConvolutionReorderType, libcudnn), cudnnStatus_t,
          (cudnnConvolutionDescriptor_t, Ptr{cudnnReorderType_t}), convDesc, reorderType)
end
...
@checked function cudnnSetConvolution2dDescriptor(convDesc, pad_h, pad_w, u, v, dilation_h,
    ...
    ccall((:cudnnSetConvolution2dDescriptor, libcudnn), cudnnStatus_t,
          (cudnnConvolutionDescriptor_t, Cint, Cint, Cint, Cint, Cint, Cint,
           cudnnConvolutionMode_t, cudnnDataType_t), convDesc, pad_h, pad_w, u, v,
...
@checked function cudnnSetConvolutionNdDescriptor(convDesc, arrayLength, padA,
    ...
    ccall((:cudnnSetConvolutionNdDescriptor, libcudnn), cudnnStatus_t,
          (cudnnConvolutionDescriptor_t, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint},
           cudnnConvolutionMode_t, cudnnDataType_t), convDesc, arrayLength, padA,
          filterStrideA, dilationA, mode, computeType)
end
...
@checked function cudnnGetConvolutionNdDescriptor(convDesc, arrayLengthRequested,
    ...
    ccall((:cudnnGetConvolutionNdDescriptor, libcudnn), cudnnStatus_t,
          (cudnnConvolutionDescriptor_t, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint},
           Ptr{cudnnConvolutionMode_t}, Ptr{cudnnDataType_t}), convDesc,
          arrayLengthRequested, arrayLength, padA, strideA, dilationA, mode, computeType)
end
...
@checked function cudnnGetConvolution2dForwardOutputDim(convDesc, inputTensorDesc,
    ...
    ccall((:cudnnGetConvolution2dForwardOutputDim, libcudnn), cudnnStatus_t,
          (cudnnConvolutionDescriptor_t, cudnnTensorDescriptor_t, cudnnFilterDescriptor_t,
           Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), convDesc, inputTensorDesc,
          filterDesc, n, c, h, w)
end
...
@checked function cudnnGetConvolutionNdForwardOutputDim(convDesc, inputTensorDesc,
    ...
    ccall((:cudnnGetConvolutionNdForwardOutputDim, libcudnn), cudnnStatus_t,
          (cudnnConvolutionDescriptor_t, cudnnTensorDescriptor_t, cudnnFilterDescriptor_t,
           Cint, Ptr{Cint}), convDesc, inputTensorDesc, filterDesc, nbDims, tensorOuputDimA)
end
...
@checked function cudnnGetConvolutionForwardAlgorithmMaxCount(handle, count)
    ...
    ccall((:cudnnGetConvolutionForwardAlgorithmMaxCount, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, Ptr{Cint}), handle, count)
end
...
@checked function cudnnGetConvolutionForwardAlgorithm_v7(handle, srcDesc, filterDesc,
    ...
    ccall((:cudnnGetConvolutionForwardAlgorithm_v7, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorDescriptor_t, cudnnFilterDescriptor_t,
           ...
           Ptr{cudnnConvolutionFwdAlgoPerf_t}), handle, srcDesc, filterDesc, convDesc,
...
@checked function cudnnFindConvolutionForwardAlgorithm(handle, xDesc, wDesc, convDesc,
    ...
    ccall((:cudnnFindConvolutionForwardAlgorithm, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorDescriptor_t, cudnnFilterDescriptor_t,
           cudnnConvolutionDescriptor_t, cudnnTensorDescriptor_t, Cint, Ptr{Cint},
           Ptr{cudnnConvolutionFwdAlgoPerf_t}), handle, xDesc, wDesc, convDesc, yDesc,
...
@checked function cudnnFindConvolutionForwardAlgorithmEx(handle, xDesc, x, wDesc, w,
    ...
    ccall((:cudnnFindConvolutionForwardAlgorithmEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnFilterDescriptor_t,
           CuPtr{Cvoid}, cudnnConvolutionDescriptor_t, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, Cint, Ptr{Cint}, Ptr{cudnnConvolutionFwdAlgoPerf_t}, CuPtr{Cvoid},
           Csize_t), handle, xDesc, x, wDesc, w, convDesc, yDesc, y, requestedAlgoCount,
...
@checked function cudnnIm2Col(handle, xDesc, x, wDesc, convDesc, colBuffer)
    ...
    ccall((:cudnnIm2Col, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnFilterDescriptor_t,
           cudnnConvolutionDescriptor_t, CuPtr{Cvoid}), handle, xDesc, x, wDesc, convDesc,
          colBuffer)
end
...
@checked function cudnnReorderFilterAndBias(handle, filterDesc, reorderType, filterData,
    ...
    ccall((:cudnnReorderFilterAndBias, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnFilterDescriptor_t, cudnnReorderType_t, CuPtr{Cvoid},
           CuPtr{Cvoid}, Cint, CuPtr{Cvoid}, CuPtr{Cvoid}), handle, filterDesc, reorderType,
          filterData, reorderedFilterData, reorderBias, biasData, reorderedBiasData)
end
...
@checked function cudnnGetConvolutionForwardWorkspaceSize(handle, xDesc, wDesc, convDesc,
    ...
    ccall((:cudnnGetConvolutionForwardWorkspaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorDescriptor_t, cudnnFilterDescriptor_t,
           ...
           Ref{Csize_t}), handle, xDesc, wDesc, convDesc, yDesc, algo, sizeInBytes)
end
...
@checked function cudnnConvolutionForward(handle, alpha, xDesc, x, wDesc, w, convDesc, algo,
    ...
    ccall((:cudnnConvolutionForward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           ...
           cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle, alpha, xDesc, x, wDesc, w,
...
@checked function cudnnConvolutionBiasActivationForward(handle, alpha1, xDesc, x, wDesc, w,
    ...
    ccall((:cudnnConvolutionBiasActivationForward, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           ...
           cudnnConvolutionFwdAlgo_t, CuPtr{Cvoid}, Csize_t, Ptr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           cudnnActivationDescriptor_t, cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle,
          alpha1, xDesc, x, wDesc, w, convDesc, algo, workSpace, workSpaceSizeInBytes,
          alpha2, zDesc, z, biasDesc, bias, activationDesc, yDesc, y)
end
...
@checked function cudnnFindConvolutionBackwardDataAlgorithm(handle, wDesc, dyDesc, convDesc,
    ...
    ccall((:cudnnFindConvolutionBackwardDataAlgorithm, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnFilterDescriptor_t, cudnnTensorDescriptor_t,
           cudnnConvolutionDescriptor_t, cudnnTensorDescriptor_t, Cint, Ptr{Cint},
           Ptr{cudnnConvolutionBwdDataAlgoPerf_t}), handle, wDesc, dyDesc, convDesc, dxDesc,
          requestedAlgoCount, returnedAlgoCount, perfResults)
end
...
@checked function cudnnFindConvolutionBackwardDataAlgorithmEx(handle, wDesc, w, dyDesc, dy,
    ...
    ccall((:cudnnFindConvolutionBackwardDataAlgorithmEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnFilterDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, cudnnConvolutionDescriptor_t, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, Cint, Ptr{Cint}, Ptr{cudnnConvolutionBwdDataAlgoPerf_t},
           CuPtr{Cvoid}, Csize_t), handle, wDesc, w, dyDesc, dy, convDesc, dxDesc, dx,
...
@checked function cudnnGetConvolutionBackwardDataAlgorithm_v7(handle, filterDesc, diffDesc,
    ...
    ccall((:cudnnGetConvolutionBackwardDataAlgorithm_v7, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnFilterDescriptor_t, cudnnTensorDescriptor_t,
           cudnnConvolutionDescriptor_t, cudnnTensorDescriptor_t, Cint, Ptr{Cint},
           Ptr{cudnnConvolutionBwdDataAlgoPerf_t}), handle, filterDesc, diffDesc, convDesc,
...
@checked function cudnnGetConvolutionBackwardDataWorkspaceSize(handle, wDesc, dyDesc,
    ...
    ccall((:cudnnGetConvolutionBackwardDataWorkspaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnFilterDescriptor_t, cudnnTensorDescriptor_t,
           ...
           cudnnConvolutionBwdDataAlgo_t, Ref{Csize_t}), handle, wDesc, dyDesc, convDesc,
...
@checked function cudnnConvolutionBackwardData(handle, alpha, wDesc, w, dyDesc, dy,
    ...
    ccall((:cudnnConvolutionBackwardData, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, Ptr{Cvoid}, cudnnFilterDescriptor_t, CuPtr{Cvoid},
           ...
           cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle, alpha, wDesc, w, dyDesc, dy,
          convDesc, algo, workSpace, workSpaceSizeInBytes, beta, dxDesc, dx)
end
...
@checked function cudnnGetFoldedConvBackwardDataDescriptors(handle, filterDesc, diffDesc,
    ...
    ccall((:cudnnGetFoldedConvBackwardDataDescriptors, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnFilterDescriptor_t, cudnnTensorDescriptor_t,
           ...
           cudnnTensorTransformDescriptor_t), handle, filterDesc, diffDesc, convDesc,
          gradDesc, transformFormat, foldedFilterDesc, paddedDiffDesc, foldedConvDesc,
          foldedGradDesc, filterFoldTransDesc, diffPadTransDesc, gradFoldTransDesc,
          gradUnfoldTransDesc)
end
...
@checked function cudnnFindConvolutionBackwardFilterAlgorithm(handle, xDesc, dyDesc,
    ...
    ccall((:cudnnFindConvolutionBackwardFilterAlgorithm, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorDescriptor_t, cudnnTensorDescriptor_t,
           ...
           Ptr{cudnnConvolutionBwdFilterAlgoPerf_t}), handle, xDesc, dyDesc, convDesc,
...
@checked function cudnnFindConvolutionBackwardFilterAlgorithmEx(handle, xDesc, x, dyDesc, y,
    ...
    ccall((:cudnnFindConvolutionBackwardFilterAlgorithmEx, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorDescriptor_t, CuPtr{Cvoid}, cudnnTensorDescriptor_t,
           CuPtr{Cvoid}, cudnnConvolutionDescriptor_t, cudnnFilterDescriptor_t,
           CuPtr{Cvoid}, Cint, Ptr{Cint}, Ptr{cudnnConvolutionBwdFilterAlgoPerf_t},
           CuPtr{Cvoid}, Csize_t), handle, xDesc, x, dyDesc, y, convDesc, dwDesc, dw,
          requestedAlgoCount, returnedAlgoCount, perfResults, workSpace,
          workSpaceSizeInBytes)
end
...
@checked function cudnnGetConvolutionBackwardFilterAlgorithm_v7(handle, srcDesc, diffDesc,
    ...
    ccall((:cudnnGetConvolutionBackwardFilterAlgorithm_v7, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorDescriptor_t, cudnnTensorDescriptor_t,
           cudnnConvolutionDescriptor_t, cudnnFilterDescriptor_t, Cint, Ptr{Cint},
           Ptr{cudnnConvolutionBwdFilterAlgoPerf_t}), handle, srcDesc, diffDesc, convDesc,
          gradDesc, requestedAlgoCount, returnedAlgoCount, perfResults)
end
...
@checked function cudnnGetConvolutionBackwardFilterWorkspaceSize(handle, xDesc, dyDesc,
    ...
    ccall((:cudnnGetConvolutionBackwardFilterWorkspaceSize, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnTensorDescriptor_t, cudnnTensorDescriptor_t,
           ...
           cudnnConvolutionBwdFilterAlgo_t, Ref{Csize_t}), handle, xDesc, dyDesc, convDesc,
...
@checked function cudnnConvolutionBackwardFilter(handle, alpha, xDesc, x, dyDesc, dy,
    ...
    ccall((:cudnnConvolutionBackwardFilter, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid},
           ...
           cudnnFilterDescriptor_t, CuPtr{Cvoid}), handle, alpha, xDesc, x, dyDesc, dy,
          convDesc, algo, workSpace, workSpaceSizeInBytes, beta, dwDesc, dw)
end
...
@checked function cudnnConvolutionBackwardBias(handle, alpha, dyDesc, dy, beta, dbDesc, db)
    ...
    ccall((:cudnnConvolutionBackwardBias, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, Ptr{Cvoid}, cudnnTensorDescriptor_t, CuPtr{Cvoid}, Ptr{Cvoid},
           cudnnTensorDescriptor_t, CuPtr{Cvoid}), handle, alpha, dyDesc, dy, beta, dbDesc,
          db)
end
...
@checked function cudnnCreateFusedOpsConstParamPack(constPack, ops)
    ...
    ccall((:cudnnCreateFusedOpsConstParamPack, libcudnn), cudnnStatus_t,
          (Ptr{cudnnFusedOpsConstParamPack_t}, cudnnFusedOps_t), constPack, ops)
end
...
@checked function cudnnGetFusedOpsConstParamPackAttribute(constPack, paramLabel, param,
    ...
    ccall((:cudnnGetFusedOpsConstParamPackAttribute, libcudnn), cudnnStatus_t,
          (cudnnFusedOpsConstParamPack_t, cudnnFusedOpsConstParamLabel_t, Ptr{Cvoid},
           Ptr{Cint}), constPack, paramLabel, param, isNULL)
end
...
@checked function cudnnCreateFusedOpsVariantParamPack(varPack, ops)
    ...
    ccall((:cudnnCreateFusedOpsVariantParamPack, libcudnn), cudnnStatus_t,
          (Ptr{cudnnFusedOpsVariantParamPack_t}, cudnnFusedOps_t), varPack, ops)
end
...
@checked function cudnnSetFusedOpsVariantParamPackAttribute(varPack, paramLabel, ptr)
    ...
    ccall((:cudnnSetFusedOpsVariantParamPackAttribute, libcudnn), cudnnStatus_t,
          (cudnnFusedOpsVariantParamPack_t, cudnnFusedOpsVariantParamLabel_t,
           PtrOrCuPtr{Cvoid}), varPack, paramLabel, ptr)
end
...
@checked function cudnnCreateFusedOpsPlan(plan, ops)
    ...
    ccall((:cudnnCreateFusedOpsPlan, libcudnn), cudnnStatus_t,
          (Ptr{cudnnFusedOpsPlan_t}, cudnnFusedOps_t), plan, ops)
end

@checked function cudnnDestroyFusedOpsPlan(plan)
    initialize_context()
    ccall((:cudnnDestroyFusedOpsPlan, libcudnn), cudnnStatus_t, (cudnnFusedOpsPlan_t,),
          plan)
end
...
@checked function cudnnFusedOpsExecute(handle, plan, varPack)
    ...
    ccall((:cudnnFusedOpsExecute, libcudnn), cudnnStatus_t,
          (cudnnHandle_t, cudnnFusedOpsPlan_t, cudnnFusedOpsVariantParamPack_t), handle,
          plan, varPack)
end
