...
let
    ...
    src = Mem.alloc(Mem.Host, nb, CUDAdrv.CU_MEMHOSTALLOC_DEVICEMAP)
...
let
    ...
    src = Mem.register(Mem.Host, pointer(data), nb, CUDAdrv.CU_MEMHOSTREGISTER_DEVICEMAP)
...
let
    ...
    Mem.advise(src, CUDAdrv.CU_MEM_ADVISE_SET_READ_MOSTLY)
