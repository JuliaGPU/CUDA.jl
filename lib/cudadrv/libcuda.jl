...
function Base.getproperty(x::Ptr{CUlaunchAttributeValue_union}, f::Symbol)
    ...
    f === :clusterDim && return Ptr{var"##Ctag#5875"}(x + 0)
    ...
    f === :programmaticEvent && return Ptr{var"##Ctag#5876"}(x + 0)
...
struct var"##Ctag#5879"
    data::NTuple{4,UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#5879"}, f::Symbol)
    f === :smCount && return Ptr{CUexecAffinitySmCount}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5879", f::Symbol)
    r = Ref{var"##Ctag#5879"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5879"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5879"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{CUexecAffinityParam_st}, f::Symbol)
    ...
    f === :param && return Ptr{var"##Ctag#5879"}(x + 4)
    return getfield(x, f)
end
...
struct var"##Ctag#5865"
    width::Cuint
    height::Cuint
    depth::Cuint
end
function Base.getproperty(x::Ptr{var"##Ctag#5865"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#5865", f::Symbol)
    r = Ref{var"##Ctag#5865"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5865"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5865"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{CUDA_ARRAY_SPARSE_PROPERTIES_st}, f::Symbol)
    f === :tileExtent && return Ptr{var"##Ctag#5865"}(x + 0)
...
struct var"##Ctag#5857"
    data::NTuple{128,UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#5857"}, f::Symbol)
    f === :array && return Ptr{var"##Ctag#5858"}(x + 0)
    f === :mipmap && return Ptr{var"##Ctag#5859"}(x + 0)
    f === :linear && return Ptr{var"##Ctag#5860"}(x + 0)
    f === :pitch2D && return Ptr{var"##Ctag#5861"}(x + 0)
    f === :reserved && return Ptr{var"##Ctag#5862"}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5857", f::Symbol)
    r = Ref{var"##Ctag#5857"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5857"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5857"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{CUDA_RESOURCE_DESC_st}, f::Symbol)
    ...
    f === :res && return Ptr{var"##Ctag#5857"}(x + 8)
...
struct var"##Ctag#5877"
    data::NTuple{16,UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#5877"}, f::Symbol)
    f === :fd && return Ptr{Cint}(x + 0)
    f === :win32 && return Ptr{var"##Ctag#5878"}(x + 0)
    f === :nvSciBufObject && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5877", f::Symbol)
    r = Ref{var"##Ctag#5877"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5877"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5877"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{CUDA_EXTERNAL_MEMORY_HANDLE_DESC_st}, f::Symbol)
    ...
    f === :handle && return Ptr{var"##Ctag#5877"}(x + 8)
...
function Base.getproperty(x::Ptr{var"##Ctag#5863"}, f::Symbol)
    f === :fd && return Ptr{Cint}(x + 0)
    f === :win32 && return Ptr{var"##Ctag#5864"}(x + 0)
...
function Base.getproperty(x::Ptr{CUDA_EXTERNAL_SEMAPHORE_HANDLE_DESC_st}, f::Symbol)
    ...
    f === :handle && return Ptr{var"##Ctag#5863"}(x + 8)
    f === :flags && return Ptr{Cuint}(x + 24)
...
struct var"##Ctag#5881"
    value::Culonglong
end
function Base.getproperty(x::Ptr{var"##Ctag#5881"}, f::Symbol)
    f === :value && return Ptr{Culonglong}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5881", f::Symbol)
    r = Ref{var"##Ctag#5881"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5881"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5881"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5882"
    data::NTuple{8,UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#5882"}, f::Symbol)
    f === :fence && return Ptr{Ptr{Cvoid}}(x + 0)
    f === :reserved && return Ptr{Culonglong}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5882", f::Symbol)
    r = Ref{var"##Ctag#5882"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5882"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5882"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5883"
    key::Culonglong
end
function Base.getproperty(x::Ptr{var"##Ctag#5883"}, f::Symbol)
    f === :key && return Ptr{Culonglong}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5883", f::Symbol)
    r = Ref{var"##Ctag#5883"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5883"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5883"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5880"
    data::NTuple{72,UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#5880"}, f::Symbol)
    f === :fence && return Ptr{var"##Ctag#5881"}(x + 0)
    f === :nvSciSync && return Ptr{var"##Ctag#5882"}(x + 8)
    f === :keyedMutex && return Ptr{var"##Ctag#5883"}(x + 16)
    f === :reserved && return Ptr{NTuple{12,Cuint}}(x + 24)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5880", f::Symbol)
    r = Ref{var"##Ctag#5880"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5880"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5880"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end
...
struct var"##Ctag#5872"
    value::Culonglong
end
function Base.getproperty(x::Ptr{var"##Ctag#5872"}, f::Symbol)
    f === :value && return Ptr{Culonglong}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5872", f::Symbol)
    r = Ref{var"##Ctag#5872"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5872"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5872"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5873"
    data::NTuple{8,UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#5873"}, f::Symbol)
    f === :fence && return Ptr{Ptr{Cvoid}}(x + 0)
    f === :reserved && return Ptr{Culonglong}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5873", f::Symbol)
    r = Ref{var"##Ctag#5873"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5873"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5873"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5874"
    key::Culonglong
    timeoutMs::Cuint
end
function Base.getproperty(x::Ptr{var"##Ctag#5874"}, f::Symbol)
    f === :key && return Ptr{Culonglong}(x + 0)
    f === :timeoutMs && return Ptr{Cuint}(x + 8)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5874", f::Symbol)
    r = Ref{var"##Ctag#5874"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5874"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5874"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5871"
    data::NTuple{72,UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#5871"}, f::Symbol)
    f === :fence && return Ptr{var"##Ctag#5872"}(x + 0)
    f === :nvSciSync && return Ptr{var"##Ctag#5873"}(x + 8)
    f === :keyedMutex && return Ptr{var"##Ctag#5874"}(x + 16)
    f === :reserved && return Ptr{NTuple{10,Cuint}}(x + 32)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5871", f::Symbol)
    r = Ref{var"##Ctag#5871"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5871"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5871"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end
...
struct var"##Ctag#5866"
    data::NTuple{8,UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#5866"}, f::Symbol)
    f === :mipmap && return Ptr{CUmipmappedArray}(x + 0)
    f === :array && return Ptr{CUarray}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5866", f::Symbol)
    r = Ref{var"##Ctag#5866"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5866"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5866"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5867"
    data::NTuple{32,UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#5867"}, f::Symbol)
    f === :sparseLevel && return Ptr{var"##Ctag#5868"}(x + 0)
    f === :miptail && return Ptr{var"##Ctag#5869"}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5867", f::Symbol)
    r = Ref{var"##Ctag#5867"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5867"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5867"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5870"
    data::NTuple{8,UInt8}
end

function Base.getproperty(x::Ptr{var"##Ctag#5870"}, f::Symbol)
    f === :memHandle && return Ptr{CUmemGenericAllocationHandle}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5870", f::Symbol)
    r = Ref{var"##Ctag#5870"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5870"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5870"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end
...
struct var"##Ctag#5856"
    compressionType::Cuchar
    gpuDirectRDMACapable::Cuchar
    usage::Cushort
    reserved::NTuple{4,Cuchar}
end
function Base.getproperty(x::Ptr{var"##Ctag#5856"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#5856", f::Symbol)
    r = Ref{var"##Ctag#5856"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5856"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5856"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{CUmemAllocationProp_st}, f::Symbol)
    ...
    f === :allocFlags && return Ptr{var"##Ctag#5856"}(x + 24)
    return getfield(x, f)
end
...
struct var"##Ctag#5858"
    hArray::CUarray
end
function Base.getproperty(x::Ptr{var"##Ctag#5858"}, f::Symbol)
    f === :hArray && return Ptr{CUarray}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5858", f::Symbol)
    r = Ref{var"##Ctag#5858"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5858"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5858"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5859"
    hMipmappedArray::CUmipmappedArray
end
function Base.getproperty(x::Ptr{var"##Ctag#5859"}, f::Symbol)
    f === :hMipmappedArray && return Ptr{CUmipmappedArray}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5859", f::Symbol)
    r = Ref{var"##Ctag#5859"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5859"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5859"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5860"
    devPtr::CUdeviceptr
    format::CUarray_format
    numChannels::Cuint
    sizeInBytes::Csize_t
end
function Base.getproperty(x::Ptr{var"##Ctag#5860"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#5860", f::Symbol)
    r = Ref{var"##Ctag#5860"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5860"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5860"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end
...
struct var"##Ctag#5862"
    reserved::NTuple{32,Cint}
end
function Base.getproperty(x::Ptr{var"##Ctag#5862"}, f::Symbol)
    f === :reserved && return Ptr{NTuple{32,Cint}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5862", f::Symbol)
    r = Ref{var"##Ctag#5862"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5862"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5862"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5864"
    handle::Ptr{Cvoid}
    name::Ptr{Cvoid}
end
function Base.getproperty(x::Ptr{var"##Ctag#5864"}, f::Symbol)
    f === :handle && return Ptr{Ptr{Cvoid}}(x + 0)
    f === :name && return Ptr{Ptr{Cvoid}}(x + 8)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5864", f::Symbol)
    r = Ref{var"##Ctag#5864"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5864"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5864"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5868"
    level::Cuint
    layer::Cuint
    offsetX::Cuint
    offsetY::Cuint
...
function Base.getproperty(x::Ptr{var"##Ctag#5868"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#5868", f::Symbol)
    r = Ref{var"##Ctag#5868"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5868"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5868"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5869"
    layer::Cuint
    offset::Culonglong
    size::Culonglong
end
function Base.getproperty(x::Ptr{var"##Ctag#5869"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#5869", f::Symbol)
    r = Ref{var"##Ctag#5869"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5869"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5869"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5875"
    x::Cuint
    y::Cuint
    z::Cuint
end
function Base.getproperty(x::Ptr{var"##Ctag#5875"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#5875", f::Symbol)
    r = Ref{var"##Ctag#5875"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5875"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5875"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end

struct var"##Ctag#5876"
    event::CUevent
    flags::Cint
    triggerAtBlockStart::Cint
end
function Base.getproperty(x::Ptr{var"##Ctag#5876"}, f::Symbol)
...
function Base.getproperty(x::var"##Ctag#5876", f::Symbol)
    r = Ref{var"##Ctag#5876"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5876"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5876"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end
...
struct var"##Ctag#5878"
    handle::Ptr{Cvoid}
    name::Ptr{Cvoid}
end
function Base.getproperty(x::Ptr{var"##Ctag#5878"}, f::Symbol)
    f === :handle && return Ptr{Ptr{Cvoid}}(x + 0)
    f === :name && return Ptr{Ptr{Cvoid}}(x + 8)
    return getfield(x, f)
end

function Base.getproperty(x::var"##Ctag#5878", f::Symbol)
    r = Ref{var"##Ctag#5878"}(x)
    ptr = Base.unsafe_convert(Ptr{var"##Ctag#5878"}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{var"##Ctag#5878"}, f::Symbol, v)
    return unsafe_store!(getproperty(x, f), v)
end
