...
@checked function cusolverDnCreate(handle)
    initialize_context()
    ccall((:cusolverDnCreate, libcusolver), cusolverStatus_t, (Ptr{cusolverDnHandle_t},),
          handle)
end

@checked function cusolverDnDestroy(handle)
    initialize_context()
    ccall((:cusolverDnDestroy, libcusolver), cusolverStatus_t, (cusolverDnHandle_t,),
          handle)
end
...
@checked function cusolverDnIRSParamsSetRefinementSolver(params, refinement_solver)
    ...
    ccall((:cusolverDnIRSParamsSetRefinementSolver, libcusolver), cusolverStatus_t,
          (cusolverDnIRSParams_t, cusolverIRSRefinement_t), params, refinement_solver)
end
...
@checked function cusolverDnIRSParamsSetSolverMainPrecision(params, solver_main_precision)
    ...
    ccall((:cusolverDnIRSParamsSetSolverMainPrecision, libcusolver), cusolverStatus_t,
          (cusolverDnIRSParams_t, cusolverPrecType_t), params, solver_main_precision)
end
...
@checked function cusolverDnIRSParamsSetSolverLowestPrecision(params,
    ...
    ccall((:cusolverDnIRSParamsSetSolverLowestPrecision, libcusolver), cusolverStatus_t,
          (cusolverDnIRSParams_t, cusolverPrecType_t), params, solver_lowest_precision)
end
...
@checked function cusolverDnIRSParamsSetSolverPrecisions(params, solver_main_precision,
    ...
    ccall((:cusolverDnIRSParamsSetSolverPrecisions, libcusolver), cusolverStatus_t,
          (cusolverDnIRSParams_t, cusolverPrecType_t, cusolverPrecType_t), params,
          solver_main_precision, solver_lowest_precision)
end

@checked function cusolverDnIRSParamsSetTol(params, val)
    initialize_context()
    ccall((:cusolverDnIRSParamsSetTol, libcusolver), cusolverStatus_t,
          (cusolverDnIRSParams_t, Cdouble), params, val)
end
...
@checked function cusolverDnIRSParamsSetMaxIters(params, maxiters)
    ...
    ccall((:cusolverDnIRSParamsSetMaxIters, libcusolver), cusolverStatus_t,
          (cusolverDnIRSParams_t, cusolver_int_t), params, maxiters)
end
...
@checked function cusolverDnIRSParamsSetMaxItersInner(params, maxiters_inner)
    ...
    ccall((:cusolverDnIRSParamsSetMaxItersInner, libcusolver), cusolverStatus_t,
          (cusolverDnIRSParams_t, cusolver_int_t), params, maxiters_inner)
end
...
@checked function cusolverDnIRSParamsGetMaxIters(params, maxiters)
    ...
    ccall((:cusolverDnIRSParamsGetMaxIters, libcusolver), cusolverStatus_t,
          (cusolverDnIRSParams_t, Ptr{cusolver_int_t}), params, maxiters)
end
...
@checked function cusolverDnIRSInfosGetOuterNiters(infos, outer_niters)
    ...
    ccall((:cusolverDnIRSInfosGetOuterNiters, libcusolver), cusolverStatus_t,
          (cusolverDnIRSInfos_t, Ptr{cusolver_int_t}), infos, outer_niters)
end
...
@checked function cusolverDnIRSInfosGetResidualHistory(infos, residual_history)
    ...
    ccall((:cusolverDnIRSInfosGetResidualHistory, libcusolver), cusolverStatus_t,
          (cusolverDnIRSInfos_t, Ptr{Ptr{Cvoid}}), infos, residual_history)
end
...
@checked function cusolverDnIRSInfosGetMaxIters(infos, maxiters)
    ...
    ccall((:cusolverDnIRSInfosGetMaxIters, libcusolver), cusolverStatus_t,
          (cusolverDnIRSInfos_t, Ptr{cusolver_int_t}), infos, maxiters)
end
...
@checked function cusolverDnZZgesv(handle, n, nrhs, dA, ldda, dipiv, dB, lddb, dX, lddx,
    ...
    ccall((:cusolverDnZZgesv, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, CuPtr{cuDoubleComplex},
           cusolver_int_t, CuPtr{cusolver_int_t}, CuPtr{cuDoubleComplex}, cusolver_int_t,
           CuPtr{cuDoubleComplex}, cusolver_int_t, CuPtr{Cvoid}, Csize_t,
           Ptr{cusolver_int_t}, CuPtr{cusolver_int_t}), handle, n, nrhs, dA, ldda, dipiv,
          dB, lddb, dX, lddx, dWorkspace, lwork_bytes, iter, d_info)
end
...
@checked function cusolverDnCCgesv(handle, n, nrhs, dA, ldda, dipiv, dB, lddb, dX, lddx,
    ...
    ccall((:cusolverDnCCgesv, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, CuPtr{cuComplex},
           cusolver_int_t, CuPtr{cusolver_int_t}, CuPtr{cuComplex}, cusolver_int_t,
           CuPtr{cuComplex}, cusolver_int_t, CuPtr{Cvoid}, Csize_t, Ptr{cusolver_int_t},
           CuPtr{cusolver_int_t}), handle, n, nrhs, dA, ldda, dipiv, dB, lddb, dX, lddx,
          dWorkspace, lwork_bytes, iter, d_info)
end
...
@checked function cusolverDnDDgesv(handle, n, nrhs, dA, ldda, dipiv, dB, lddb, dX, lddx,
    ...
    ccall((:cusolverDnDDgesv, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, CuPtr{Cdouble},
           ...
           CuPtr{Cdouble}, cusolver_int_t, CuPtr{Cvoid}, Csize_t, Ptr{cusolver_int_t},
           CuPtr{cusolver_int_t}), handle, n, nrhs, dA, ldda, dipiv, dB, lddb, dX, lddx,
          dWorkspace, lwork_bytes, iter, d_info)
end
...
@checked function cusolverDnSSgesv(handle, n, nrhs, dA, ldda, dipiv, dB, lddb, dX, lddx,
    ...
    ccall((:cusolverDnSSgesv, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, CuPtr{Cfloat},
           ...
           CuPtr{Cfloat}, cusolver_int_t, CuPtr{Cvoid}, Csize_t, Ptr{cusolver_int_t},
           CuPtr{cusolver_int_t}), handle, n, nrhs, dA, ldda, dipiv, dB, lddb, dX, lddx,
          dWorkspace, lwork_bytes, iter, d_info)
end
...
@checked function cusolverDnZZgesv_bufferSize(handle, n, nrhs, dA, ldda, dipiv, dB, lddb,
    ...
    ccall((:cusolverDnZZgesv_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, CuPtr{cuDoubleComplex},
           cusolver_int_t, CuPtr{cusolver_int_t}, CuPtr{cuDoubleComplex}, cusolver_int_t,
           CuPtr{cuDoubleComplex}, cusolver_int_t, CuPtr{Cvoid}, Ptr{Csize_t}), handle, n,
          nrhs, dA, ldda, dipiv, dB, lddb, dX, lddx, dWorkspace, lwork_bytes)
end
...
@checked function cusolverDnCCgesv_bufferSize(handle, n, nrhs, dA, ldda, dipiv, dB, lddb,
    ...
    ccall((:cusolverDnCCgesv_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, CuPtr{cuComplex},
           cusolver_int_t, CuPtr{cusolver_int_t}, CuPtr{cuComplex}, cusolver_int_t,
           CuPtr{cuComplex}, cusolver_int_t, CuPtr{Cvoid}, Ptr{Csize_t}), handle, n, nrhs,
          dA, ldda, dipiv, dB, lddb, dX, lddx, dWorkspace, lwork_bytes)
end
...
@checked function cusolverDnDDgesv_bufferSize(handle, n, nrhs, dA, ldda, dipiv, dB, lddb,
    ...
    ccall((:cusolverDnDDgesv_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, CuPtr{Cdouble},
           cusolver_int_t, CuPtr{cusolver_int_t}, CuPtr{Cdouble}, cusolver_int_t,
           CuPtr{Cdouble}, cusolver_int_t, CuPtr{Cvoid}, Ptr{Csize_t}), handle, n, nrhs, dA,
          ldda, dipiv, dB, lddb, dX, lddx, dWorkspace, lwork_bytes)
end
...
@checked function cusolverDnSSgesv_bufferSize(handle, n, nrhs, dA, ldda, dipiv, dB, lddb,
    ...
    ccall((:cusolverDnSSgesv_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, CuPtr{Cfloat},
           cusolver_int_t, CuPtr{cusolver_int_t}, CuPtr{Cfloat}, cusolver_int_t,
           CuPtr{Cfloat}, cusolver_int_t, CuPtr{Cvoid}, Ptr{Csize_t}), handle, n, nrhs, dA,
          ldda, dipiv, dB, lddb, dX, lddx, dWorkspace, lwork_bytes)
end
...
@checked function cusolverDnZZgels(handle, m, n, nrhs, dA, ldda, dB, lddb, dX, lddx,
    ...
    ccall((:cusolverDnZZgels, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, cusolver_int_t,
           CuPtr{cuDoubleComplex}, cusolver_int_t, CuPtr{cuDoubleComplex}, cusolver_int_t,
           CuPtr{cuDoubleComplex}, cusolver_int_t, CuPtr{Cvoid}, Csize_t,
           Ptr{cusolver_int_t}, CuPtr{cusolver_int_t}), handle, m, n, nrhs, dA, ldda, dB,
          lddb, dX, lddx, dWorkspace, lwork_bytes, iter, d_info)
end
...
@checked function cusolverDnCCgels(handle, m, n, nrhs, dA, ldda, dB, lddb, dX, lddx,
    ...
    ccall((:cusolverDnCCgels, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, cusolver_int_t,
           ...
           CuPtr{cuComplex}, cusolver_int_t, CuPtr{Cvoid}, Csize_t, Ptr{cusolver_int_t},
           CuPtr{cusolver_int_t}), handle, m, n, nrhs, dA, ldda, dB, lddb, dX, lddx,
          dWorkspace, lwork_bytes, iter, d_info)
end
...
@checked function cusolverDnDDgels(handle, m, n, nrhs, dA, ldda, dB, lddb, dX, lddx,
    ...
    ccall((:cusolverDnDDgels, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, cusolver_int_t,
           CuPtr{Cdouble}, cusolver_int_t, CuPtr{Cdouble}, cusolver_int_t, CuPtr{Cdouble},
...
@checked function cusolverDnSSgels(handle, m, n, nrhs, dA, ldda, dB, lddb, dX, lddx,
    ...
    ccall((:cusolverDnSSgels, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, cusolver_int_t,
           CuPtr{Cfloat}, cusolver_int_t, CuPtr{Cfloat}, cusolver_int_t, CuPtr{Cfloat},
           cusolver_int_t, CuPtr{Cvoid}, Csize_t, Ptr{cusolver_int_t},
           CuPtr{cusolver_int_t}), handle, m, n, nrhs, dA, ldda, dB, lddb, dX, lddx,
          dWorkspace, lwork_bytes, iter, d_info)
end
...
@checked function cusolverDnZZgels_bufferSize(handle, m, n, nrhs, dA, ldda, dB, lddb, dX,
    ...
    ccall((:cusolverDnZZgels_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, cusolver_int_t,
           CuPtr{cuDoubleComplex}, cusolver_int_t, CuPtr{cuDoubleComplex}, cusolver_int_t,
           CuPtr{cuDoubleComplex}, cusolver_int_t, CuPtr{Cvoid}, Ptr{Csize_t}), handle, m,
          n, nrhs, dA, ldda, dB, lddb, dX, lddx, dWorkspace, lwork_bytes)
end
...
@checked function cusolverDnCCgels_bufferSize(handle, m, n, nrhs, dA, ldda, dB, lddb, dX,
    ...
    ccall((:cusolverDnCCgels_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, cusolver_int_t,
           CuPtr{cuComplex}, cusolver_int_t, CuPtr{cuComplex}, cusolver_int_t,
           CuPtr{cuComplex}, cusolver_int_t, CuPtr{Cvoid}, Ptr{Csize_t}), handle, m, n,
          nrhs, dA, ldda, dB, lddb, dX, lddx, dWorkspace, lwork_bytes)
end
...
@checked function cusolverDnDDgels_bufferSize(handle, m, n, nrhs, dA, ldda, dB, lddb, dX,
    ...
    ccall((:cusolverDnDDgels_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolver_int_t, cusolver_int_t, cusolver_int_t,
           CuPtr{Cdouble}, cusolver_int_t, CuPtr{Cdouble}, cusolver_int_t, CuPtr{Cdouble},
           cusolver_int_t, CuPtr{Cvoid}, Ptr{Csize_t}), handle, m, n, nrhs, dA, ldda, dB,
...
@checked function cusolverDnIRSXgesv(handle, gesv_irs_params, gesv_irs_infos, n, nrhs, dA,
    ...
    ccall((:cusolverDnIRSXgesv, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnIRSParams_t, cusolverDnIRSInfos_t, cusolver_int_t,
           cusolver_int_t, CuPtr{Cvoid}, cusolver_int_t, CuPtr{Cvoid}, cusolver_int_t,
           CuPtr{Cvoid}, cusolver_int_t, CuPtr{Cvoid}, Csize_t, Ptr{cusolver_int_t},
           CuPtr{cusolver_int_t}), handle, gesv_irs_params, gesv_irs_infos, n, nrhs, dA,
          ldda, dB, lddb, dX, lddx, dWorkspace, lwork_bytes, niters, d_info)
end
...
@checked function cusolverDnIRSXgesv_bufferSize(handle, params, n, nrhs, lwork_bytes)
    ...
    ccall((:cusolverDnIRSXgesv_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnIRSParams_t, cusolver_int_t, cusolver_int_t,
           Ptr{Csize_t}), handle, params, n, nrhs, lwork_bytes)
end
...
@checked function cusolverDnIRSXgels(handle, gels_irs_params, gels_irs_infos, m, n, nrhs,
    ...
    ccall((:cusolverDnIRSXgels, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnIRSParams_t, cusolverDnIRSInfos_t, cusolver_int_t,
           cusolver_int_t, cusolver_int_t, CuPtr{Cvoid}, cusolver_int_t, CuPtr{Cvoid},
           cusolver_int_t, CuPtr{Cvoid}, cusolver_int_t, CuPtr{Cvoid}, Csize_t,
           Ptr{cusolver_int_t}, CuPtr{cusolver_int_t}), handle, gels_irs_params,
          gels_irs_infos, m, n, nrhs, dA, ldda, dB, lddb, dX, lddx, dWorkspace, lwork_bytes,
          niters, d_info)
end
...
@checked function cusolverDnIRSXgels_bufferSize(handle, params, m, n, nrhs, lwork_bytes)
    ...
    ccall((:cusolverDnIRSXgels_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnIRSParams_t, cusolver_int_t, cusolver_int_t,
           cusolver_int_t, Ptr{Csize_t}), handle, params, m, n, nrhs, lwork_bytes)
end
...
@checked function cusolverDnSpotrf_bufferSize(handle, uplo, n, A, lda, Lwork)
    ...
    ccall((:cusolverDnSpotrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cfloat}, Cint, Ptr{Cint}),
...
@checked function cusolverDnDpotrf_bufferSize(handle, uplo, n, A, lda, Lwork)
    ...
    ccall((:cusolverDnDpotrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cdouble}, Cint, Ptr{Cint}),
          handle, uplo, n, A, lda, Lwork)
end
...
@checked function cusolverDnCpotrf_bufferSize(handle, uplo, n, A, lda, Lwork)
    ...
    ccall((:cusolverDnCpotrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuComplex}, Cint, Ptr{Cint}),
          handle, uplo, n, A, lda, Lwork)
end
...
@checked function cusolverDnZpotrf_bufferSize(handle, uplo, n, A, lda, Lwork)
    ...
    ccall((:cusolverDnZpotrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuDoubleComplex}, Cint,
           Ptr{Cint}), handle, uplo, n, A, lda, Lwork)
end
...
@checked function cusolverDnSpotrf(handle, uplo, n, A, lda, Workspace, Lwork, devInfo)
    ...
    ccall((:cusolverDnSpotrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           Cint, CuPtr{Cint}), handle, uplo, n, A, lda, Workspace, Lwork, devInfo)
end
...
@checked function cusolverDnDpotrf(handle, uplo, n, A, lda, Workspace, Lwork, devInfo)
    ...
    ccall((:cusolverDnDpotrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble},
           Cint, CuPtr{Cint}), handle, uplo, n, A, lda, Workspace, Lwork, devInfo)
end
...
@checked function cusolverDnCpotrf(handle, uplo, n, A, lda, Workspace, Lwork, devInfo)
    ...
    ccall((:cusolverDnCpotrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, uplo, n, A, lda, Workspace, Lwork,
          devInfo)
end
...
@checked function cusolverDnZpotrf(handle, uplo, n, A, lda, Workspace, Lwork, devInfo)
    ...
    ccall((:cusolverDnZpotrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle, uplo, n, A, lda, Workspace,
          Lwork, devInfo)
end
...
@checked function cusolverDnSpotrs(handle, uplo, n, nrhs, A, lda, B, ldb, devInfo)
    ...
    ccall((:cusolverDnSpotrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, Cint, CuPtr{Cfloat}, Cint,
           CuPtr{Cfloat}, Cint, CuPtr{Cint}), handle, uplo, n, nrhs, A, lda, B, ldb,
          devInfo)
end
...
@checked function cusolverDnDpotrs(handle, uplo, n, nrhs, A, lda, B, ldb, devInfo)
    ...
    ccall((:cusolverDnDpotrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, Cint, CuPtr{Cdouble}, Cint,
           CuPtr{Cdouble}, Cint, CuPtr{Cint}), handle, uplo, n, nrhs, A, lda, B, ldb,
          devInfo)
end
...
@checked function cusolverDnCpotrs(handle, uplo, n, nrhs, A, lda, B, ldb, devInfo)
    ...
    ccall((:cusolverDnCpotrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, uplo, n, nrhs, A, lda, B, ldb,
          devInfo)
end
...
@checked function cusolverDnZpotrs(handle, uplo, n, nrhs, A, lda, B, ldb, devInfo)
    ...
    ccall((:cusolverDnZpotrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle, uplo, n, nrhs, A, lda, B,
          ldb, devInfo)
end
...
@checked function cusolverDnSpotrfBatched(handle, uplo, n, Aarray, lda, infoArray,
    ...
    ccall((:cusolverDnSpotrfBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Ptr{Cfloat}}, Cint,
           CuPtr{Cint}, Cint), handle, uplo, n, Aarray, lda, infoArray, batchSize)
end
...
@checked function cusolverDnZpotrfBatched(handle, uplo, n, Aarray, lda, infoArray,
    ...
    ccall((:cusolverDnZpotrfBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Ptr{cuDoubleComplex}}, Cint,
           CuPtr{Cint}, Cint), handle, uplo, n, Aarray, lda, infoArray, batchSize)
end
...
@checked function cusolverDnSpotrsBatched(handle, uplo, n, nrhs, A, lda, B, ldb, d_info,
    ...
    ccall((:cusolverDnSpotrsBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, Cint, CuPtr{Ptr{Cfloat}}, Cint,
           CuPtr{Ptr{Cfloat}}, Cint, CuPtr{Cint}, Cint), handle, uplo, n, nrhs, A, lda, B,
          ldb, d_info, batchSize)
end
...
@checked function cusolverDnDpotrsBatched(handle, uplo, n, nrhs, A, lda, B, ldb, d_info,
    ...
    ccall((:cusolverDnDpotrsBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, Cint, CuPtr{Ptr{Cdouble}}, Cint,
           CuPtr{Ptr{Cdouble}}, Cint, CuPtr{Cint}, Cint), handle, uplo, n, nrhs, A, lda, B,
          ldb, d_info, batchSize)
end
...
@checked function cusolverDnCpotrsBatched(handle, uplo, n, nrhs, A, lda, B, ldb, d_info,
    ...
    ccall((:cusolverDnCpotrsBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, Cint, CuPtr{Ptr{cuComplex}}, Cint,
           CuPtr{Ptr{cuComplex}}, Cint, CuPtr{Cint}, Cint), handle, uplo, n, nrhs, A, lda,
          B, ldb, d_info, batchSize)
end
...
@checked function cusolverDnZpotrsBatched(handle, uplo, n, nrhs, A, lda, B, ldb, d_info,
    ...
    ccall((:cusolverDnZpotrsBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, Cint, CuPtr{Ptr{cuDoubleComplex}},
           Cint, CuPtr{Ptr{cuDoubleComplex}}, Cint, CuPtr{Cint}, Cint), handle, uplo, n,
          nrhs, A, lda, B, ldb, d_info, batchSize)
end
...
@checked function cusolverDnSpotri(handle, uplo, n, A, lda, work, lwork, devInfo)
    ...
    ccall((:cusolverDnSpotri, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           Cint, CuPtr{Cint}), handle, uplo, n, A, lda, work, lwork, devInfo)
end
...
@checked function cusolverDnCpotri(handle, uplo, n, A, lda, work, lwork, devInfo)
    ...
    ccall((:cusolverDnCpotri, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, uplo, n, A, lda, work, lwork,
          devInfo)
end
...
@checked function cusolverDnZpotri(handle, uplo, n, A, lda, work, lwork, devInfo)
    ...
    ccall((:cusolverDnZpotri, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle, uplo, n, A, lda, work, lwork,
          devInfo)
end
...
@checked function cusolverDnXtrtri_bufferSize(handle, uplo, diag, n, dataTypeA, A, lda,
    ...
    initialize_context()
    ccall((:cusolverDnXtrtri_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, cublasDiagType_t, Int64, cudaDataType,
           Ptr{Cvoid}, Int64, Ptr{Csize_t}, Ptr{Csize_t}), handle, uplo, diag, n, dataTypeA,
          A, lda, workspaceInBytesOnDevice, workspaceInBytesOnHost)
end
...
@checked function cusolverDnXtrtri(handle, uplo, diag, n, dataTypeA, A, lda, bufferOnDevice,
    ...
    initialize_context()
    ccall((:cusolverDnXtrtri, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, cublasDiagType_t, Int64, cudaDataType,
           Ptr{Cvoid}, Int64, Ptr{Cvoid}, Csize_t, Ptr{Cvoid}, Csize_t, Ptr{Cint}), handle,
          uplo, diag, n, dataTypeA, A, lda, bufferOnDevice, workspaceInBytesOnDevice,
...
@checked function cusolverDnSgetrf_bufferSize(handle, m, n, A, lda, Lwork)
    ...
    ccall((:cusolverDnSgetrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{Cfloat}, Cint, Ptr{Cint}), handle, m, n, A,
          lda, Lwork)
end
...
@checked function cusolverDnDgetrf_bufferSize(handle, m, n, A, lda, Lwork)
    ...
    ccall((:cusolverDnDgetrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{Cdouble}, Cint, Ptr{Cint}), handle, m, n,
          A, lda, Lwork)
end
...
@checked function cusolverDnCgetrf_bufferSize(handle, m, n, A, lda, Lwork)
    ...
    ccall((:cusolverDnCgetrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{cuComplex}, Cint, Ptr{Cint}), handle, m, n,
          A, lda, Lwork)
end
...
@checked function cusolverDnZgetrf_bufferSize(handle, m, n, A, lda, Lwork)
    ...
    ccall((:cusolverDnZgetrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{cuDoubleComplex}, Cint, Ptr{Cint}), handle,
          m, n, A, lda, Lwork)
end
...
@checked function cusolverDnSgetrf(handle, m, n, A, lda, Workspace, devIpiv, devInfo)
    ...
    ccall((:cusolverDnSgetrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, CuPtr{Cint},
           CuPtr{Cint}), handle, m, n, A, lda, Workspace, devIpiv, devInfo)
end
...
@checked function cusolverDnDgetrf(handle, m, n, A, lda, Workspace, devIpiv, devInfo)
    ...
    ccall((:cusolverDnDgetrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble},
           CuPtr{Cint}, CuPtr{Cint}), handle, m, n, A, lda, Workspace, devIpiv, devInfo)
end
...
@checked function cusolverDnCgetrf(handle, m, n, A, lda, Workspace, devIpiv, devInfo)
    ...
    ccall((:cusolverDnCgetrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{cuComplex}, Cint, CuPtr{cuComplex},
           CuPtr{Cint}, CuPtr{Cint}), handle, m, n, A, lda, Workspace, devIpiv, devInfo)
end
...
@checked function cusolverDnZgetrf(handle, m, n, A, lda, Workspace, devIpiv, devInfo)
    ...
    ccall((:cusolverDnZgetrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{cuDoubleComplex}, CuPtr{Cint}, CuPtr{Cint}), handle, m, n, A, lda,
...
@checked function cusolverDnSlaswp(handle, n, A, lda, k1, k2, devIpiv, incx)
    ...
    ccall((:cusolverDnSlaswp, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, CuPtr{Cfloat}, Cint, Cint, Cint, CuPtr{Cint}, Cint),
...
@checked function cusolverDnDlaswp(handle, n, A, lda, k1, k2, devIpiv, incx)
    ...
    ccall((:cusolverDnDlaswp, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, CuPtr{Cdouble}, Cint, Cint, Cint, CuPtr{Cint}, Cint),
          handle, n, A, lda, k1, k2, devIpiv, incx)
end
...
@checked function cusolverDnClaswp(handle, n, A, lda, k1, k2, devIpiv, incx)
    ...
    ccall((:cusolverDnClaswp, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, CuPtr{cuComplex}, Cint, Cint, Cint, CuPtr{Cint}, Cint),
          handle, n, A, lda, k1, k2, devIpiv, incx)
end
...
@checked function cusolverDnZlaswp(handle, n, A, lda, k1, k2, devIpiv, incx)
    ...
    ccall((:cusolverDnZlaswp, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, CuPtr{cuDoubleComplex}, Cint, Cint, Cint, CuPtr{Cint},
           Cint), handle, n, A, lda, k1, k2, devIpiv, incx)
end
...
@checked function cusolverDnSgetrs(handle, trans, n, nrhs, A, lda, devIpiv, B, ldb, devInfo)
    ...
    ccall((:cusolverDnSgetrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasOperation_t, Cint, Cint, CuPtr{Cfloat}, Cint,
           CuPtr{Cint}, CuPtr{Cfloat}, Cint, CuPtr{Cint}), handle, trans, n, nrhs, A, lda,
...
@checked function cusolverDnDgetrs(handle, trans, n, nrhs, A, lda, devIpiv, B, ldb, devInfo)
    ...
    ccall((:cusolverDnDgetrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasOperation_t, Cint, Cint, CuPtr{Cdouble}, Cint,
           CuPtr{Cint}, CuPtr{Cdouble}, Cint, CuPtr{Cint}), handle, trans, n, nrhs, A, lda,
          devIpiv, B, ldb, devInfo)
end
...
@checked function cusolverDnCgetrs(handle, trans, n, nrhs, A, lda, devIpiv, B, ldb, devInfo)
    ...
    ccall((:cusolverDnCgetrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasOperation_t, Cint, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{Cint}, CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, trans, n, nrhs, A,
          lda, devIpiv, B, ldb, devInfo)
end
...
@checked function cusolverDnZgetrs(handle, trans, n, nrhs, A, lda, devIpiv, B, ldb, devInfo)
    ...
    ccall((:cusolverDnZgetrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasOperation_t, Cint, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{Cint}, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle, trans, n, nrhs,
          A, lda, devIpiv, B, ldb, devInfo)
end
...
@checked function cusolverDnSgeqrf(handle, m, n, A, lda, TAU, Workspace, Lwork, devInfo)
    ...
    ccall((:cusolverDnSgeqrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           CuPtr{Cfloat}, Cint, CuPtr{Cint}), handle, m, n, A, lda, TAU, Workspace, Lwork,
          devInfo)
end
...
@checked function cusolverDnDgeqrf(handle, m, n, A, lda, TAU, Workspace, Lwork, devInfo)
    ...
    ccall((:cusolverDnDgeqrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble},
           CuPtr{Cdouble}, Cint, CuPtr{Cint}), handle, m, n, A, lda, TAU, Workspace, Lwork,
          devInfo)
end
...
@checked function cusolverDnCgeqrf(handle, m, n, A, lda, TAU, Workspace, Lwork, devInfo)
    ...
    ccall((:cusolverDnCgeqrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{cuComplex}, Cint, CuPtr{cuComplex},
           CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, m, n, A, lda, TAU, Workspace,
          Lwork, devInfo)
end
...
@checked function cusolverDnZgeqrf(handle, m, n, A, lda, TAU, Workspace, Lwork, devInfo)
    ...
    ccall((:cusolverDnZgeqrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{cuDoubleComplex}, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle, m, n,
          A, lda, TAU, Workspace, Lwork, devInfo)
end
...
@checked function cusolverDnSorgqr_bufferSize(handle, m, n, k, A, lda, tau, lwork)
    ...
    ccall((:cusolverDnSorgqr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           Ptr{Cint}), handle, m, n, k, A, lda, tau, lwork)
end
...
@checked function cusolverDnDorgqr_bufferSize(handle, m, n, k, A, lda, tau, lwork)
    ...
    ccall((:cusolverDnDorgqr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble},
           Ptr{Cint}), handle, m, n, k, A, lda, tau, lwork)
end
...
@checked function cusolverDnCungqr_bufferSize(handle, m, n, k, A, lda, tau, lwork)
    ...
    ccall((:cusolverDnCungqr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, Cint, CuPtr{cuComplex}, Cint, CuPtr{cuComplex},
           Ptr{Cint}), handle, m, n, k, A, lda, tau, lwork)
end
...
@checked function cusolverDnZungqr_bufferSize(handle, m, n, k, A, lda, tau, lwork)
    ...
    ccall((:cusolverDnZungqr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{cuDoubleComplex}, Ptr{Cint}), handle, m, n, k, A, lda, tau, lwork)
end
...
@checked function cusolverDnSorgqr(handle, m, n, k, A, lda, tau, work, lwork, info)
    ...
    ccall((:cusolverDnSorgqr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           CuPtr{Cfloat}, Cint, CuPtr{Cint}), handle, m, n, k, A, lda, tau, work, lwork,
          info)
end
...
@checked function cusolverDnDorgqr(handle, m, n, k, A, lda, tau, work, lwork, info)
    ...
    ccall((:cusolverDnDorgqr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble},
           CuPtr{Cdouble}, Cint, CuPtr{Cint}), handle, m, n, k, A, lda, tau, work, lwork,
          info)
end
...
@checked function cusolverDnCungqr(handle, m, n, k, A, lda, tau, work, lwork, info)
    ...
    ccall((:cusolverDnCungqr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, Cint, CuPtr{cuComplex}, Cint, CuPtr{cuComplex},
           CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, m, n, k, A, lda, tau, work, lwork,
          info)
end
...
@checked function cusolverDnSormqr_bufferSize(handle, side, trans, m, n, k, A, lda, tau, C,
    ...
    ccall((:cusolverDnSormqr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasOperation_t, Cint, Cint, Cint,
           CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, Ptr{Cint}), handle,
...
@checked function cusolverDnDormqr_bufferSize(handle, side, trans, m, n, k, A, lda, tau, C,
    ...
    ccall((:cusolverDnDormqr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasOperation_t, Cint, Cint, Cint,
           CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, Ptr{Cint}), handle,
          side, trans, m, n, k, A, lda, tau, C, ldc, lwork)
end
...
@checked function cusolverDnCunmqr_bufferSize(handle, side, trans, m, n, k, A, lda, tau, C,
    ...
    ccall((:cusolverDnCunmqr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasOperation_t, Cint, Cint, Cint,
           CuPtr{cuComplex}, Cint, CuPtr{cuComplex}, CuPtr{cuComplex}, Cint, Ptr{Cint}),
...
@checked function cusolverDnZunmqr_bufferSize(handle, side, trans, m, n, k, A, lda, tau, C,
    ...
    ccall((:cusolverDnZunmqr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasOperation_t, Cint, Cint, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex}, CuPtr{cuDoubleComplex},
           Cint, Ptr{Cint}), handle, side, trans, m, n, k, A, lda, tau, C, ldc, lwork)
end
...
@checked function cusolverDnSormqr(handle, side, trans, m, n, k, A, lda, tau, C, ldc, work,
    ...
    ccall((:cusolverDnSormqr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasOperation_t, Cint, Cint, Cint,
           CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint,
           CuPtr{Cint}), handle, side, trans, m, n, k, A, lda, tau, C, ldc, work, lwork,
          devInfo)
end
...
@checked function cusolverDnDormqr(handle, side, trans, m, n, k, A, lda, tau, C, ldc, work,
    ...
    ccall((:cusolverDnDormqr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasOperation_t, Cint, Cint, Cint,
           CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Cint,
           CuPtr{Cint}), handle, side, trans, m, n, k, A, lda, tau, C, ldc, work, lwork,
          devInfo)
end
...
@checked function cusolverDnCunmqr(handle, side, trans, m, n, k, A, lda, tau, C, ldc, work,
    ...
    ccall((:cusolverDnCunmqr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasOperation_t, Cint, Cint, Cint,
           ...
           CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, side, trans, m, n, k, A, lda, tau,
...
@checked function cusolverDnZunmqr(handle, side, trans, m, n, k, A, lda, tau, C, ldc, work,
    ...
    ccall((:cusolverDnZunmqr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasOperation_t, Cint, Cint, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex}, CuPtr{cuDoubleComplex},
           Cint, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle, side, trans, m, n, k,
          A, lda, tau, C, ldc, work, lwork, devInfo)
end
...
@checked function cusolverDnSsytrf_bufferSize(handle, n, A, lda, lwork)
    ...
    ccall((:cusolverDnSsytrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, CuPtr{Cfloat}, Cint, Ptr{Cint}), handle, n, A, lda,
          lwork)
end
...
@checked function cusolverDnDsytrf_bufferSize(handle, n, A, lda, lwork)
    ...
    ccall((:cusolverDnDsytrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, CuPtr{Cdouble}, Cint, Ptr{Cint}), handle, n, A, lda,
          lwork)
end
...
@checked function cusolverDnCsytrf_bufferSize(handle, n, A, lda, lwork)
    ...
    ccall((:cusolverDnCsytrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, CuPtr{cuComplex}, Cint, Ptr{Cint}), handle, n, A, lda,
          lwork)
end
...
@checked function cusolverDnZsytrf_bufferSize(handle, n, A, lda, lwork)
    ...
    ccall((:cusolverDnZsytrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, CuPtr{cuDoubleComplex}, Cint, Ptr{Cint}), handle, n, A,
          lda, lwork)
end
...
@checked function cusolverDnSsytrf(handle, uplo, n, A, lda, ipiv, work, lwork, info)
    ...
    ccall((:cusolverDnSsytrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cint},
           CuPtr{Cfloat}, Cint, CuPtr{Cint}), handle, uplo, n, A, lda, ipiv, work, lwork,
          info)
end
...
@checked function cusolverDnDsytrf(handle, uplo, n, A, lda, ipiv, work, lwork, info)
    ...
    ccall((:cusolverDnDsytrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cint},
           CuPtr{Cdouble}, Cint, CuPtr{Cint}), handle, uplo, n, A, lda, ipiv, work, lwork,
          info)
end
...
@checked function cusolverDnCsytrf(handle, uplo, n, A, lda, ipiv, work, lwork, info)
    ...
    ccall((:cusolverDnCsytrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuComplex}, Cint, CuPtr{Cint},
           CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, uplo, n, A, lda, ipiv, work, lwork,
          info)
end
...
@checked function cusolverDnZsytrf(handle, uplo, n, A, lda, ipiv, work, lwork, info)
    ...
    ccall((:cusolverDnZsytrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{Cint}, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle, uplo, n, A, lda,
...
@checked function cusolverDnXsytrs_bufferSize(handle, uplo, n, nrhs, dataTypeA, A, lda,
    ...
    ccall((:cusolverDnXsytrs_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Int64, Int64, cudaDataType, Ptr{Cvoid},
           Int64, Ptr{Int64}, cudaDataType, Ptr{Cvoid}, Int64, Ptr{Csize_t}, Ptr{Csize_t}),
          handle, uplo, n, nrhs, dataTypeA, A, lda, ipiv, dataTypeB, B, ldb,
...
@checked function cusolverDnXsytrs(handle, uplo, n, nrhs, dataTypeA, A, lda, ipiv,
    ...
    ccall((:cusolverDnXsytrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Int64, Int64, cudaDataType, Ptr{Cvoid},
           Int64, Ptr{Int64}, cudaDataType, Ptr{Cvoid}, Int64, Ptr{Cvoid}, Csize_t,
           Ptr{Cvoid}, Csize_t, Ptr{Cint}), handle, uplo, n, nrhs, dataTypeA, A, lda, ipiv,
          dataTypeB, B, ldb, bufferOnDevice, workspaceInBytesOnDevice, bufferOnHost,
          workspaceInBytesOnHost, info)
end
...
@checked function cusolverDnSsytri_bufferSize(handle, uplo, n, A, lda, ipiv, lwork)
    ...
    ccall((:cusolverDnSsytri_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cint},
           Ptr{Cint}), handle, uplo, n, A, lda, ipiv, lwork)
end
...
@checked function cusolverDnZsytri_bufferSize(handle, uplo, n, A, lda, ipiv, lwork)
    ...
    ccall((:cusolverDnZsytri_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{Cint}, Ptr{Cint}), handle, uplo, n, A, lda, ipiv, lwork)
end
...
@checked function cusolverDnSgebrd_bufferSize(handle, m, n, Lwork)
    ...
    ccall((:cusolverDnSgebrd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, Ptr{Cint}), handle, m, n, Lwork)
end
...
@checked function cusolverDnSgebrd(handle, m, n, A, lda, D, E, TAUQ, TAUP, Work, Lwork,
    ...
    ccall((:cusolverDnSgebrd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           CuPtr{Cfloat}, CuPtr{Cfloat}, CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cint}),
...
@checked function cusolverDnDgebrd(handle, m, n, A, lda, D, E, TAUQ, TAUP, Work, Lwork,
    ...
    ccall((:cusolverDnDgebrd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble},
           ...
           CuPtr{Cint}), handle, m, n, A, lda, D, E, TAUQ, TAUP, Work, Lwork, devInfo)
end
...
@checked function cusolverDnCgebrd(handle, m, n, A, lda, D, E, TAUQ, TAUP, Work, Lwork,
    ...
    ccall((:cusolverDnCgebrd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{cuComplex}, Cint, CuPtr{Cfloat},
           CuPtr{Cfloat}, CuPtr{cuComplex}, CuPtr{cuComplex}, CuPtr{cuComplex}, Cint,
           CuPtr{Cint}), handle, m, n, A, lda, D, E, TAUQ, TAUP, Work, Lwork, devInfo)
end
...
@checked function cusolverDnZgebrd(handle, m, n, A, lda, D, E, TAUQ, TAUP, Work, Lwork,
    ...
    ccall((:cusolverDnZgebrd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Cint, Cint, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cdouble},
           CuPtr{Cdouble}, CuPtr{cuDoubleComplex}, CuPtr{cuDoubleComplex},
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle, m, n, A, lda, D, E, TAUQ,
          TAUP, Work, Lwork, devInfo)
end
...
@checked function cusolverDnSorgbr_bufferSize(handle, side, m, n, k, A, lda, tau, lwork)
    ...
    ccall((:cusolverDnSorgbr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, Cint, Cint, Cint, CuPtr{Cfloat}, Cint,
           CuPtr{Cfloat}, Ptr{Cint}), handle, side, m, n, k, A, lda, tau, lwork)
end
...
@checked function cusolverDnDorgbr_bufferSize(handle, side, m, n, k, A, lda, tau, lwork)
    ...
    ccall((:cusolverDnDorgbr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, Cint, Cint, Cint, CuPtr{Cdouble}, Cint,
           CuPtr{Cdouble}, Ptr{Cint}), handle, side, m, n, k, A, lda, tau, lwork)
end
...
@checked function cusolverDnCungbr_bufferSize(handle, side, m, n, k, A, lda, tau, lwork)
    ...
    ccall((:cusolverDnCungbr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, Cint, Cint, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{cuComplex}, Ptr{Cint}), handle, side, m, n, k, A, lda, tau, lwork)
end
...
@checked function cusolverDnZungbr_bufferSize(handle, side, m, n, k, A, lda, tau, lwork)
    ...
    ccall((:cusolverDnZungbr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, Cint, Cint, Cint, CuPtr{cuDoubleComplex},
           Cint, CuPtr{cuDoubleComplex}, Ptr{Cint}), handle, side, m, n, k, A, lda, tau,
          lwork)
end
...
@checked function cusolverDnSorgbr(handle, side, m, n, k, A, lda, tau, work, lwork, info)
    ...
    ccall((:cusolverDnSorgbr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, Cint, Cint, Cint, CuPtr{Cfloat}, Cint,
           CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cint}), handle, side, m, n, k, A, lda,
          tau, work, lwork, info)
end
...
@checked function cusolverDnDorgbr(handle, side, m, n, k, A, lda, tau, work, lwork, info)
    ...
    ccall((:cusolverDnDorgbr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, Cint, Cint, Cint, CuPtr{Cdouble}, Cint,
           CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, CuPtr{Cint}), handle, side, m, n, k, A,
...
@checked function cusolverDnCungbr(handle, side, m, n, k, A, lda, tau, work, lwork, info)
    ...
    ccall((:cusolverDnCungbr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, Cint, Cint, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{cuComplex}, CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, side, m, n, k, A,
          lda, tau, work, lwork, info)
end
...
@checked function cusolverDnZungbr(handle, side, m, n, k, A, lda, tau, work, lwork, info)
    ...
    ccall((:cusolverDnZungbr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, Cint, Cint, Cint, CuPtr{cuDoubleComplex},
           Cint, CuPtr{cuDoubleComplex}, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle,
          side, m, n, k, A, lda, tau, work, lwork, info)
end
...
@checked function cusolverDnSsytrd_bufferSize(handle, uplo, n, A, lda, d, e, tau, lwork)
    ...
    ccall((:cusolverDnSsytrd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           CuPtr{Cfloat}, CuPtr{Cfloat}, Ptr{Cint}), handle, uplo, n, A, lda, d, e, tau,
          lwork)
end
...
@checked function cusolverDnDsytrd_bufferSize(handle, uplo, n, A, lda, d, e, tau, lwork)
    ...
    ccall((:cusolverDnDsytrd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble},
           CuPtr{Cdouble}, CuPtr{Cdouble}, Ptr{Cint}), handle, uplo, n, A, lda, d, e, tau,
          lwork)
end
...
@checked function cusolverDnChetrd_bufferSize(handle, uplo, n, A, lda, d, e, tau, lwork)
    ...
    ccall((:cusolverDnChetrd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{Cfloat}, CuPtr{Cfloat}, CuPtr{cuComplex}, Ptr{Cint}), handle, uplo, n, A,
          lda, d, e, tau, lwork)
end
...
@checked function cusolverDnZhetrd_bufferSize(handle, uplo, n, A, lda, d, e, tau, lwork)
    ...
    ccall((:cusolverDnZhetrd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{Cdouble}, CuPtr{Cdouble}, CuPtr{cuDoubleComplex}, Ptr{Cint}), handle, uplo,
          n, A, lda, d, e, tau, lwork)
end
...
@checked function cusolverDnSsytrd(handle, uplo, n, A, lda, d, e, tau, work, lwork, info)
    ...
    ccall((:cusolverDnSsytrd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           CuPtr{Cfloat}, CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cint}), handle, uplo, n,
          A, lda, d, e, tau, work, lwork, info)
end
...
@checked function cusolverDnDsytrd(handle, uplo, n, A, lda, d, e, tau, work, lwork, info)
    ...
    ccall((:cusolverDnDsytrd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble},
           CuPtr{Cdouble}, CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, CuPtr{Cint}), handle, uplo,
          n, A, lda, d, e, tau, work, lwork, info)
end
...
@checked function cusolverDnChetrd(handle, uplo, n, A, lda, d, e, tau, work, lwork, info)
    ...
    ccall((:cusolverDnChetrd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuComplex}, Cint,
           ...
           CuPtr{Cint}), handle, uplo, n, A, lda, d, e, tau, work, lwork, info)
end
...
@checked function cusolverDnZhetrd(handle, uplo, n, A, lda, d, e, tau, work, lwork, info)
    ...
    ccall((:cusolverDnZhetrd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{Cdouble}, CuPtr{Cdouble}, CuPtr{cuDoubleComplex}, CuPtr{cuDoubleComplex},
           Cint, CuPtr{Cint}), handle, uplo, n, A, lda, d, e, tau, work, lwork, info)
end
...
@checked function cusolverDnSorgtr_bufferSize(handle, uplo, n, A, lda, tau, lwork)
    ...
    ccall((:cusolverDnSorgtr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           Ptr{Cint}), handle, uplo, n, A, lda, tau, lwork)
end
...
@checked function cusolverDnCungtr_bufferSize(handle, uplo, n, A, lda, tau, lwork)
    ...
    ccall((:cusolverDnCungtr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{cuComplex}, Ptr{Cint}), handle, uplo, n, A, lda, tau, lwork)
end
...
@checked function cusolverDnZungtr_bufferSize(handle, uplo, n, A, lda, tau, lwork)
    ...
    ccall((:cusolverDnZungtr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{cuDoubleComplex}, Ptr{Cint}), handle, uplo, n, A, lda, tau, lwork)
end
...
@checked function cusolverDnSorgtr(handle, uplo, n, A, lda, tau, work, lwork, info)
    ...
    ccall((:cusolverDnSorgtr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           CuPtr{Cfloat}, Cint, CuPtr{Cint}), handle, uplo, n, A, lda, tau, work, lwork,
          info)
end
...
@checked function cusolverDnDorgtr(handle, uplo, n, A, lda, tau, work, lwork, info)
    ...
    ccall((:cusolverDnDorgtr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble},
           CuPtr{Cdouble}, Cint, CuPtr{Cint}), handle, uplo, n, A, lda, tau, work, lwork,
          info)
end
...
@checked function cusolverDnCungtr(handle, uplo, n, A, lda, tau, work, lwork, info)
    ...
    ccall((:cusolverDnCungtr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{cuComplex}, CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, uplo, n, A, lda,
          tau, work, lwork, info)
end
...
@checked function cusolverDnZungtr(handle, uplo, n, A, lda, tau, work, lwork, info)
    ...
    ccall((:cusolverDnZungtr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasFillMode_t, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{cuDoubleComplex}, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle, uplo,
...
@checked function cusolverDnSormtr_bufferSize(handle, side, uplo, trans, m, n, A, lda, tau,
    ...
    ccall((:cusolverDnSormtr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasFillMode_t, cublasOperation_t, Cint,
...
@checked function cusolverDnDormtr_bufferSize(handle, side, uplo, trans, m, n, A, lda, tau,
    ...
    ccall((:cusolverDnDormtr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasFillMode_t, cublasOperation_t, Cint,
           Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, Ptr{Cint}),
          handle, side, uplo, trans, m, n, A, lda, tau, C, ldc, lwork)
end
...
@checked function cusolverDnCunmtr_bufferSize(handle, side, uplo, trans, m, n, A, lda, tau,
    ...
    ccall((:cusolverDnCunmtr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasFillMode_t, cublasOperation_t, Cint,
           ...
           Ptr{Cint}), handle, side, uplo, trans, m, n, A, lda, tau, C, ldc, lwork)
end
...
@checked function cusolverDnZunmtr_bufferSize(handle, side, uplo, trans, m, n, A, lda, tau,
    ...
    ccall((:cusolverDnZunmtr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasFillMode_t, cublasOperation_t, Cint,
           ...
           CuPtr{cuDoubleComplex}, Cint, Ptr{Cint}), handle, side, uplo, trans, m, n, A,
          lda, tau, C, ldc, lwork)
end
...
@checked function cusolverDnSormtr(handle, side, uplo, trans, m, n, A, lda, tau, C, ldc,
    ...
    ccall((:cusolverDnSormtr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasFillMode_t, cublasOperation_t, Cint,
           Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           Cint, CuPtr{Cint}), handle, side, uplo, trans, m, n, A, lda, tau, C, ldc, work,
          lwork, info)
end
...
@checked function cusolverDnDormtr(handle, side, uplo, trans, m, n, A, lda, tau, C, ldc,
    ...
    ccall((:cusolverDnDormtr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasFillMode_t, cublasOperation_t, Cint,
           Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, CuPtr{Cdouble},
           Cint, CuPtr{Cint}), handle, side, uplo, trans, m, n, A, lda, tau, C, ldc, work,
          lwork, info)
end
...
@checked function cusolverDnCunmtr(handle, side, uplo, trans, m, n, A, lda, tau, C, ldc,
    ...
    ccall((:cusolverDnCunmtr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasFillMode_t, cublasOperation_t, Cint,
           Cint, CuPtr{cuComplex}, Cint, CuPtr{cuComplex}, CuPtr{cuComplex}, Cint,
           CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, side, uplo, trans, m, n, A, lda,
...
@checked function cusolverDnZunmtr(handle, side, uplo, trans, m, n, A, lda, tau, C, ldc,
    ...
    ccall((:cusolverDnZunmtr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cublasSideMode_t, cublasFillMode_t, cublasOperation_t, Cint,
           Cint, CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex},
           CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle,
...
@checked function cusolverDnSgesvd(handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt,
    ...
    ccall((:cusolverDnSgesvd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Int8, Int8, Cint, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat},
           CuPtr{Cint}), handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt, work,
          lwork, rwork, info)
end
...
@checked function cusolverDnDgesvd(handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt,
    ...
    ccall((:cusolverDnDgesvd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Int8, Int8, Cint, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble},
           CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble},
           CuPtr{Cint}), handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt, work,
          lwork, rwork, info)
end
...
@checked function cusolverDnCgesvd(handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt,
    ...
    ccall((:cusolverDnCgesvd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Int8, Int8, Cint, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{Cfloat}, CuPtr{cuComplex}, Cint, CuPtr{cuComplex}, Cint, CuPtr{cuComplex},
           Cint, CuPtr{Cfloat}, CuPtr{Cint}), handle, jobu, jobvt, m, n, A, lda, S, U, ldu,
...
@checked function cusolverDnZgesvd(handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt,
    ...
    ccall((:cusolverDnZgesvd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, Int8, Int8, Cint, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{Cdouble}, CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cdouble}, CuPtr{Cint}), handle, jobu, jobvt,
          m, n, A, lda, S, U, ldu, VT, ldvt, work, lwork, rwork, info)
end
...
@checked function cusolverDnSsyevd_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork)
    ...
    ccall((:cusolverDnSsyevd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{Cfloat},
           Cint, CuPtr{Cfloat}, Ptr{Cint}), handle, jobz, uplo, n, A, lda, W, lwork)
end
...
@checked function cusolverDnDsyevd_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork)
    ...
    ccall((:cusolverDnDsyevd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{Cdouble},
           Cint, CuPtr{Cdouble}, Ptr{Cint}), handle, jobz, uplo, n, A, lda, W, lwork)
end
...
@checked function cusolverDnCheevd_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork)
    ...
    ccall((:cusolverDnCheevd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{cuComplex},
           Cint, CuPtr{Cfloat}, Ptr{Cint}), handle, jobz, uplo, n, A, lda, W, lwork)
end
...
@checked function cusolverDnZheevd_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork)
    ...
    ccall((:cusolverDnZheevd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cdouble}, Ptr{Cint}), handle, jobz, uplo, n,
          A, lda, W, lwork)
end
...
@checked function cusolverDnSsyevd(handle, jobz, uplo, n, A, lda, W, work, lwork, info)
    ...
    ccall((:cusolverDnSsyevd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{Cfloat},
           Cint, CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cint}), handle, jobz, uplo, n, A,
...
@checked function cusolverDnDsyevd(handle, jobz, uplo, n, A, lda, W, work, lwork, info)
    ...
    ccall((:cusolverDnDsyevd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{Cdouble},
           Cint, CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, CuPtr{Cint}), handle, jobz, uplo, n,
          A, lda, W, work, lwork, info)
end
...
@checked function cusolverDnCheevd(handle, jobz, uplo, n, A, lda, W, work, lwork, info)
    ...
    ccall((:cusolverDnCheevd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{cuComplex},
           Cint, CuPtr{Cfloat}, CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, jobz, uplo, n,
          A, lda, W, work, lwork, info)
end
...
@checked function cusolverDnZheevd(handle, jobz, uplo, n, A, lda, W, work, lwork, info)
    ...
    ccall((:cusolverDnZheevd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cdouble}, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{Cint}), handle, jobz, uplo, n, A, lda, W, work, lwork, info)
end
...
@checked function cusolverDnSsyevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl, vu,
    ...
    ccall((:cusolverDnSsyevdx_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cusolverEigRange_t, cublasFillMode_t,
           Cint, CuPtr{Cfloat}, Cint, Cfloat, Cfloat, Cint, Cint, Ptr{Cint}, CuPtr{Cfloat},
           Ptr{Cint}), handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, meig, W, lwork)
end
...
@checked function cusolverDnDsyevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl, vu,
    ...
    ccall((:cusolverDnDsyevdx_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cusolverEigRange_t, cublasFillMode_t,
           Cint, CuPtr{Cdouble}, Cint, Cdouble, Cdouble, Cint, Cint, Ptr{Cint},
           CuPtr{Cdouble}, Ptr{Cint}), handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu,
          meig, W, lwork)
end
...
@checked function cusolverDnCheevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl, vu,
    ...
    ccall((:cusolverDnCheevdx_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cusolverEigRange_t, cublasFillMode_t,
           Cint, CuPtr{cuComplex}, Cint, Cfloat, Cfloat, Cint, Cint, Ptr{Cint},
           CuPtr{Cfloat}, Ptr{Cint}), handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu,
          meig, W, lwork)
end
...
@checked function cusolverDnZheevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl, vu,
    ...
    ccall((:cusolverDnZheevdx_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cusolverEigRange_t, cublasFillMode_t,
           Cint, CuPtr{cuDoubleComplex}, Cint, Cdouble, Cdouble, Cint, Cint, Ptr{Cint},
           CuPtr{Cdouble}, Ptr{Cint}), handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu,
          meig, W, lwork)
end
...
@checked function cusolverDnSsyevdx(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu,
    ...
    ccall((:cusolverDnSsyevdx, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cusolverEigRange_t, cublasFillMode_t,
           Cint, CuPtr{Cfloat}, Cint, Cfloat, Cfloat, Cint, Cint, Ptr{Cint}, CuPtr{Cfloat},
           CuPtr{Cfloat}, Cint, CuPtr{Cint}), handle, jobz, range, uplo, n, A, lda, vl, vu,
...
@checked function cusolverDnDsyevdx(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu,
    ...
    ccall((:cusolverDnDsyevdx, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cusolverEigRange_t, cublasFillMode_t,
           Cint, CuPtr{Cdouble}, Cint, Cdouble, Cdouble, Cint, Cint, Ptr{Cint},
           CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, CuPtr{Cint}), handle, jobz, range, uplo, n,
          A, lda, vl, vu, il, iu, meig, W, work, lwork, info)
end
...
@checked function cusolverDnCheevdx(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu,
    ...
    ccall((:cusolverDnCheevdx, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cusolverEigRange_t, cublasFillMode_t,
           Cint, CuPtr{cuComplex}, Cint, Cfloat, Cfloat, Cint, Cint, Ptr{Cint},
           CuPtr{Cfloat}, CuPtr{cuComplex}, Cint, CuPtr{Cint}), handle, jobz, range, uplo,
          n, A, lda, vl, vu, il, iu, meig, W, work, lwork, info)
end
...
@checked function cusolverDnZheevdx(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu,
    ...
    ccall((:cusolverDnZheevdx, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cusolverEigRange_t, cublasFillMode_t,
           Cint, CuPtr{cuDoubleComplex}, Cint, Cdouble, Cdouble, Cint, Cint, Ptr{Cint},
           CuPtr{Cdouble}, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle, jobz, range,
          uplo, n, A, lda, vl, vu, il, iu, meig, W, work, lwork, info)
end
...
@checked function cusolverDnSsygvdx_bufferSize(handle, itype, jobz, range, uplo, n, A, lda,
    ...
    ccall((:cusolverDnSsygvdx_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cusolverEigRange_t,
           cublasFillMode_t, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint, Cfloat, Cfloat,
           Cint, Cint, Ptr{Cint}, CuPtr{Cfloat}, Ptr{Cint}), handle, itype, jobz, range,
          uplo, n, A, lda, B, ldb, vl, vu, il, iu, meig, W, lwork)
end
...
@checked function cusolverDnDsygvdx_bufferSize(handle, itype, jobz, range, uplo, n, A, lda,
    ...
    ccall((:cusolverDnDsygvdx_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cusolverEigRange_t,
           cublasFillMode_t, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Cint, Cdouble,
           Cdouble, Cint, Cint, Ptr{Cint}, CuPtr{Cdouble}, Ptr{Cint}), handle, itype, jobz,
          range, uplo, n, A, lda, B, ldb, vl, vu, il, iu, meig, W, lwork)
end
...
@checked function cusolverDnChegvdx_bufferSize(handle, itype, jobz, range, uplo, n, A, lda,
    ...
    ccall((:cusolverDnChegvdx_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cusolverEigRange_t,
           cublasFillMode_t, Cint, CuPtr{cuComplex}, Cint, CuPtr{cuComplex}, Cint, Cfloat,
           Cfloat, Cint, Cint, Ptr{Cint}, CuPtr{Cfloat}, Ptr{Cint}), handle, itype, jobz,
          range, uplo, n, A, lda, B, ldb, vl, vu, il, iu, meig, W, lwork)
end
...
@checked function cusolverDnZhegvdx_bufferSize(handle, itype, jobz, range, uplo, n, A, lda,
    ...
    ccall((:cusolverDnZhegvdx_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cusolverEigRange_t,
           cublasFillMode_t, Cint, CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex},
           Cint, Cdouble, Cdouble, Cint, Cint, Ptr{Cint}, CuPtr{Cdouble}, Ptr{Cint}),
          handle, itype, jobz, range, uplo, n, A, lda, B, ldb, vl, vu, il, iu, meig, W,
          lwork)
end
...
@checked function cusolverDnSsygvdx(handle, itype, jobz, range, uplo, n, A, lda, B, ldb, vl,
    ...
    ccall((:cusolverDnSsygvdx, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cusolverEigRange_t,
           cublasFillMode_t, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint, Cfloat, Cfloat,
           Cint, Cint, Ptr{Cint}, CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cint}), handle,
          itype, jobz, range, uplo, n, A, lda, B, ldb, vl, vu, il, iu, meig, W, work, lwork,
          info)
end
...
@checked function cusolverDnDsygvdx(handle, itype, jobz, range, uplo, n, A, lda, B, ldb, vl,
    ...
    ccall((:cusolverDnDsygvdx, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cusolverEigRange_t,
           cublasFillMode_t, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Cint, Cdouble,
           Cdouble, Cint, Cint, Ptr{Cint}, CuPtr{Cdouble}, CuPtr{Cdouble}, Cint,
           CuPtr{Cint}), handle, itype, jobz, range, uplo, n, A, lda, B, ldb, vl, vu, il,
...
@checked function cusolverDnChegvdx(handle, itype, jobz, range, uplo, n, A, lda, B, ldb, vl,
    ...
    ccall((:cusolverDnChegvdx, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cusolverEigRange_t,
           cublasFillMode_t, Cint, CuPtr{cuComplex}, Cint, CuPtr{cuComplex}, Cint, Cfloat,
           Cfloat, Cint, Cint, Ptr{Cint}, CuPtr{Cfloat}, CuPtr{cuComplex}, Cint,
           CuPtr{Cint}), handle, itype, jobz, range, uplo, n, A, lda, B, ldb, vl, vu, il,
          iu, meig, W, work, lwork, info)
end
...
@checked function cusolverDnZhegvdx(handle, itype, jobz, range, uplo, n, A, lda, B, ldb, vl,
    ...
    ccall((:cusolverDnZhegvdx, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cusolverEigRange_t,
           cublasFillMode_t, Cint, CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex},
           Cint, Cdouble, Cdouble, Cint, Cint, Ptr{Cint}, CuPtr{Cdouble},
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle, itype, jobz, range, uplo, n,
          A, lda, B, ldb, vl, vu, il, iu, meig, W, work, lwork, info)
end
...
@checked function cusolverDnSsygvd_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb,
    ...
    ccall((:cusolverDnSsygvd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Ptr{Cint}), handle,
...
@checked function cusolverDnDsygvd_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb,
    ...
    ccall((:cusolverDnDsygvd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Ptr{Cint}), handle,
          itype, jobz, uplo, n, A, lda, B, ldb, W, lwork)
end
...
@checked function cusolverDnChegvd_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb,
    ...
    ccall((:cusolverDnChegvd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuComplex}, Cint, CuPtr{cuComplex}, Cint, CuPtr{Cfloat}, Ptr{Cint}),
...
@checked function cusolverDnZhegvd_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb,
    ...
    ccall((:cusolverDnZhegvd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cdouble},
           Ptr{Cint}), handle, itype, jobz, uplo, n, A, lda, B, ldb, W, lwork)
end
...
@checked function cusolverDnSsygvd(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work,
    ...
    ccall((:cusolverDnSsygvd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, CuPtr{Cfloat}, Cint,
           CuPtr{Cint}), handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work, lwork, info)
end
...
@checked function cusolverDnDsygvd(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work,
    ...
    ccall((:cusolverDnDsygvd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, CuPtr{Cdouble}, Cint,
           CuPtr{Cint}), handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work, lwork, info)
end
...
@checked function cusolverDnChegvd(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work,
    ...
    ccall((:cusolverDnChegvd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuComplex}, Cint, CuPtr{cuComplex}, Cint, CuPtr{Cfloat}, CuPtr{cuComplex},
           Cint, CuPtr{Cint}), handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work, lwork,
          info)
end
...
@checked function cusolverDnZhegvd(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work,
    ...
    ccall((:cusolverDnZhegvd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cdouble},
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}), handle, itype, jobz, uplo, n, A, lda,
          B, ldb, W, work, lwork, info)
end

@checked function cusolverDnCreateSyevjInfo(info)
    initialize_context()
    ccall((:cusolverDnCreateSyevjInfo, libcusolver), cusolverStatus_t, (Ptr{syevjInfo_t},),
          info)
end

@checked function cusolverDnDestroySyevjInfo(info)
    initialize_context()
    ccall((:cusolverDnDestroySyevjInfo, libcusolver), cusolverStatus_t, (syevjInfo_t,),
          info)
end
...
@checked function cusolverDnXsyevjSetTolerance(info, tolerance)
    ...
    ccall((:cusolverDnXsyevjSetTolerance, libcusolver), cusolverStatus_t,
          (syevjInfo_t, Cdouble), info, tolerance)
end
...
@checked function cusolverDnXsyevjSetMaxSweeps(info, max_sweeps)
    ...
    ccall((:cusolverDnXsyevjSetMaxSweeps, libcusolver), cusolverStatus_t,
          (syevjInfo_t, Cint), info, max_sweeps)
end

@checked function cusolverDnXsyevjSetSortEig(info, sort_eig)
    initialize_context()
    ccall((:cusolverDnXsyevjSetSortEig, libcusolver), cusolverStatus_t, (syevjInfo_t, Cint),
          info, sort_eig)
end
...
@checked function cusolverDnXsyevjGetResidual(handle, info, residual)
    ...
    ccall((:cusolverDnXsyevjGetResidual, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, syevjInfo_t, Ptr{Cdouble}), handle, info, residual)
end
...
@checked function cusolverDnXsyevjGetSweeps(handle, info, executed_sweeps)
    ...
    ccall((:cusolverDnXsyevjGetSweeps, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, syevjInfo_t, Ptr{Cint}), handle, info, executed_sweeps)
end
...
@checked function cusolverDnSsyevjBatched_bufferSize(handle, jobz, uplo, n, A, lda, W,
    ...
    ccall((:cusolverDnSsyevjBatched_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{Cfloat},
           Cint, CuPtr{Cfloat}, Ptr{Cint}, syevjInfo_t, Cint), handle, jobz, uplo, n, A,
...
@checked function cusolverDnDsyevjBatched_bufferSize(handle, jobz, uplo, n, A, lda, W,
    ...
    ccall((:cusolverDnDsyevjBatched_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{Cdouble},
           Cint, CuPtr{Cdouble}, Ptr{Cint}, syevjInfo_t, Cint), handle, jobz, uplo, n, A,
          lda, W, lwork, params, batchSize)
end
...
@checked function cusolverDnZheevjBatched_bufferSize(handle, jobz, uplo, n, A, lda, W,
    ...
    ccall((:cusolverDnZheevjBatched_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cdouble}, Ptr{Cint}, syevjInfo_t, Cint),
...
@checked function cusolverDnSsyevjBatched(handle, jobz, uplo, n, A, lda, W, work, lwork,
    ...
    ccall((:cusolverDnSsyevjBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{Cfloat},
           Cint, CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cint}, syevjInfo_t, Cint),
...
@checked function cusolverDnDsyevjBatched(handle, jobz, uplo, n, A, lda, W, work, lwork,
    ...
    ccall((:cusolverDnDsyevjBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{Cdouble},
           Cint, CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, CuPtr{Cint}, syevjInfo_t, Cint),
          handle, jobz, uplo, n, A, lda, W, work, lwork, info, params, batchSize)
end
...
@checked function cusolverDnCheevjBatched(handle, jobz, uplo, n, A, lda, W, work, lwork,
    ...
    ccall((:cusolverDnCheevjBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{cuComplex},
           Cint, CuPtr{Cfloat}, CuPtr{cuComplex}, Cint, CuPtr{Cint}, syevjInfo_t, Cint),
          handle, jobz, uplo, n, A, lda, W, work, lwork, info, params, batchSize)
end
...
@checked function cusolverDnZheevjBatched(handle, jobz, uplo, n, A, lda, W, work, lwork,
    ...
    ccall((:cusolverDnZheevjBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cdouble}, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{Cint}, syevjInfo_t, Cint), handle, jobz, uplo, n, A, lda, W, work, lwork,
          info, params, batchSize)
end
...
@checked function cusolverDnSsyevj_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork,
    ...
    ccall((:cusolverDnSsyevj_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{Cfloat},
           Cint, CuPtr{Cfloat}, Ptr{Cint}, syevjInfo_t), handle, jobz, uplo, n, A, lda, W,
          lwork, params)
end
...
@checked function cusolverDnDsyevj_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork,
    ...
    ccall((:cusolverDnDsyevj_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{Cdouble},
           Cint, CuPtr{Cdouble}, Ptr{Cint}, syevjInfo_t), handle, jobz, uplo, n, A, lda, W,
          lwork, params)
end
...
@checked function cusolverDnZheevj_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork,
    ...
    ccall((:cusolverDnZheevj_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cdouble}, Ptr{Cint}, syevjInfo_t), handle,
...
@checked function cusolverDnSsyevj(handle, jobz, uplo, n, A, lda, W, work, lwork, info,
    ...
    ccall((:cusolverDnSsyevj, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{Cfloat},
           Cint, CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cint}, syevjInfo_t), handle,
          jobz, uplo, n, A, lda, W, work, lwork, info, params)
end
...
@checked function cusolverDnDsyevj(handle, jobz, uplo, n, A, lda, W, work, lwork, info,
    ...
    ccall((:cusolverDnDsyevj, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{Cdouble},
           Cint, CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, CuPtr{Cint}, syevjInfo_t), handle,
          jobz, uplo, n, A, lda, W, work, lwork, info, params)
end
...
@checked function cusolverDnCheevj(handle, jobz, uplo, n, A, lda, W, work, lwork, info,
    ...
    ccall((:cusolverDnCheevj, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint, CuPtr{cuComplex},
           Cint, CuPtr{Cfloat}, CuPtr{cuComplex}, Cint, CuPtr{Cint}, syevjInfo_t), handle,
          jobz, uplo, n, A, lda, W, work, lwork, info, params)
end
...
@checked function cusolverDnZheevj(handle, jobz, uplo, n, A, lda, W, work, lwork, info,
    ...
    ccall((:cusolverDnZheevj, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cdouble}, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{Cint}, syevjInfo_t), handle, jobz, uplo, n, A, lda, W, work, lwork, info,
          params)
end
...
@checked function cusolverDnSsygvj_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb,
    ...
    ccall((:cusolverDnSsygvj_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Ptr{Cint}, syevjInfo_t),
...
@checked function cusolverDnDsygvj_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb,
    ...
    ccall((:cusolverDnDsygvj_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Ptr{Cint},
           syevjInfo_t), handle, itype, jobz, uplo, n, A, lda, B, ldb, W, lwork, params)
end
...
@checked function cusolverDnZhegvj_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb,
    ...
    ccall((:cusolverDnZhegvj_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cdouble},
           Ptr{Cint}, syevjInfo_t), handle, itype, jobz, uplo, n, A, lda, B, ldb, W, lwork,
          params)
end
...
@checked function cusolverDnSsygvj(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work,
    ...
    ccall((:cusolverDnSsygvj, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, CuPtr{Cfloat}, Cint,
           CuPtr{Cint}, syevjInfo_t), handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work,
          lwork, info, params)
end
...
@checked function cusolverDnChegvj(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work,
    ...
    ccall((:cusolverDnChegvj, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuComplex}, Cint, CuPtr{cuComplex}, Cint, CuPtr{Cfloat}, CuPtr{cuComplex},
           Cint, CuPtr{Cint}, syevjInfo_t), handle, itype, jobz, uplo, n, A, lda, B, ldb, W,
...
@checked function cusolverDnZhegvj(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work,
    ...
    ccall((:cusolverDnZhegvj, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigType_t, cusolverEigMode_t, cublasFillMode_t, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex}, Cint, CuPtr{Cdouble},
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}, syevjInfo_t), handle, itype, jobz,
          uplo, n, A, lda, B, ldb, W, work, lwork, info, params)
end

@checked function cusolverDnCreateGesvdjInfo(info)
    initialize_context()
    ccall((:cusolverDnCreateGesvdjInfo, libcusolver), cusolverStatus_t,
          (Ptr{gesvdjInfo_t},), info)
end

@checked function cusolverDnDestroyGesvdjInfo(info)
    initialize_context()
    ccall((:cusolverDnDestroyGesvdjInfo, libcusolver), cusolverStatus_t, (gesvdjInfo_t,),
          info)
end
...
@checked function cusolverDnXgesvdjSetTolerance(info, tolerance)
    ...
    ccall((:cusolverDnXgesvdjSetTolerance, libcusolver), cusolverStatus_t,
          (gesvdjInfo_t, Cdouble), info, tolerance)
end
...
@checked function cusolverDnXgesvdjGetResidual(handle, info, residual)
    ...
    ccall((:cusolverDnXgesvdjGetResidual, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, gesvdjInfo_t, Ptr{Cdouble}), handle, info, residual)
end
...
@checked function cusolverDnXgesvdjGetSweeps(handle, info, executed_sweeps)
    ...
    ccall((:cusolverDnXgesvdjGetSweeps, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, gesvdjInfo_t, Ptr{Cint}), handle, info, executed_sweeps)
end
...
@checked function cusolverDnSgesvdjBatched_bufferSize(handle, jobz, m, n, A, lda, S, U, ldu,
    ...
    ccall((:cusolverDnSgesvdjBatched_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, CuPtr{Cfloat}, Cint,
           CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint, Ptr{Cint}, gesvdjInfo_t,
           Cint), handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, lwork, params, batchSize)
end
...
@checked function cusolverDnDgesvdjBatched_bufferSize(handle, jobz, m, n, A, lda, S, U, ldu,
    ...
    ccall((:cusolverDnDgesvdjBatched_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, CuPtr{Cdouble}, Cint,
           ...
           gesvdjInfo_t, Cint), handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, lwork,
          params, batchSize)
end
...
@checked function cusolverDnCgesvdjBatched_bufferSize(handle, jobz, m, n, A, lda, S, U, ldu,
    ...
    ccall((:cusolverDnCgesvdjBatched_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{Cfloat}, CuPtr{cuComplex}, Cint, CuPtr{cuComplex}, Cint, Ptr{Cint},
           gesvdjInfo_t, Cint), handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, lwork,
          params, batchSize)
end
...
@checked function cusolverDnZgesvdjBatched_bufferSize(handle, jobz, m, n, A, lda, S, U, ldu,
    ...
    ccall((:cusolverDnZgesvdjBatched_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{Cdouble}, CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex}, Cint,
           Ptr{Cint}, gesvdjInfo_t, Cint), handle, jobz, m, n, A, lda, S, U, ldu, V, ldv,
          lwork, params, batchSize)
end
...
@checked function cusolverDnSgesvdjBatched(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv,
    ...
    ccall((:cusolverDnSgesvdjBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, CuPtr{Cfloat}, Cint,
           CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint,
           CuPtr{Cint}, gesvdjInfo_t, Cint), handle, jobz, m, n, A, lda, S, U, ldu, V, ldv,
          work, lwork, info, params, batchSize)
end
...
@checked function cusolverDnDgesvdjBatched(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv,
    ...
    ccall((:cusolverDnDgesvdjBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, CuPtr{Cdouble}, Cint,
           CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Cint,
           CuPtr{Cint}, gesvdjInfo_t, Cint), handle, jobz, m, n, A, lda, S, U, ldu, V, ldv,
          work, lwork, info, params, batchSize)
end
...
@checked function cusolverDnCgesvdjBatched(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv,
    ...
    ccall((:cusolverDnCgesvdjBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{Cfloat}, CuPtr{cuComplex}, Cint, CuPtr{cuComplex}, Cint, CuPtr{cuComplex},
           Cint, CuPtr{Cint}, gesvdjInfo_t, Cint), handle, jobz, m, n, A, lda, S, U, ldu, V,
          ldv, work, lwork, info, params, batchSize)
end
...
@checked function cusolverDnZgesvdjBatched(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv,
    ...
    ccall((:cusolverDnZgesvdjBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{Cdouble}, CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}, gesvdjInfo_t, Cint), handle, jobz, m,
          n, A, lda, S, U, ldu, V, ldv, work, lwork, info, params, batchSize)
end
...
@checked function cusolverDnSgesvdj_bufferSize(handle, jobz, econ, m, n, A, lda, S, U, ldu,
    ...
    ccall((:cusolverDnSgesvdj_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{Cfloat}, Cint,
           CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint, Ptr{Cint},
           gesvdjInfo_t), handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, lwork,
          params)
end
...
@checked function cusolverDnDgesvdj_bufferSize(handle, jobz, econ, m, n, A, lda, S, U, ldu,
    ...
    ccall((:cusolverDnDgesvdj_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{Cdouble}, Cint,
           CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, CuPtr{Cdouble}, Cint, Ptr{Cint},
           gesvdjInfo_t), handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, lwork,
          params)
end
...
@checked function cusolverDnCgesvdj_bufferSize(handle, jobz, econ, m, n, A, lda, S, U, ldu,
    ...
    ccall((:cusolverDnCgesvdj_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{Cfloat}, CuPtr{cuComplex}, Cint, CuPtr{cuComplex}, Cint, Ptr{Cint},
           gesvdjInfo_t), handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, lwork,
          params)
end
...
@checked function cusolverDnZgesvdj_bufferSize(handle, jobz, econ, m, n, A, lda, S, U, ldu,
    ...
    ccall((:cusolverDnZgesvdj_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{cuDoubleComplex},
           Cint, CuPtr{Cdouble}, CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex}, Cint,
           Ptr{Cint}, gesvdjInfo_t), handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv,
          lwork, params)
end
...
@checked function cusolverDnSgesvdj(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv,
    ...
    ccall((:cusolverDnSgesvdj, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{Cfloat}, Cint,
           CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint, CuPtr{Cfloat}, Cint,
           CuPtr{Cint}, gesvdjInfo_t), handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv,
          work, lwork, info, params)
end
...
@checked function cusolverDnCgesvdj(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv,
    ...
    ccall((:cusolverDnCgesvdj, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{cuComplex}, Cint,
           CuPtr{Cfloat}, CuPtr{cuComplex}, Cint, CuPtr{cuComplex}, Cint, CuPtr{cuComplex},
           Cint, CuPtr{Cint}, gesvdjInfo_t), handle, jobz, econ, m, n, A, lda, S, U, ldu, V,
...
@checked function cusolverDnZgesvdj(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv,
    ...
    ccall((:cusolverDnZgesvdj, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{cuDoubleComplex},
           Cint, CuPtr{Cdouble}, CuPtr{cuDoubleComplex}, Cint, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{cuDoubleComplex}, Cint, CuPtr{Cint}, gesvdjInfo_t), handle, jobz, econ, m,
          n, A, lda, S, U, ldu, V, ldv, work, lwork, info, params)
end
...
@checked function cusolverDnSgesvdaStridedBatched_bufferSize(handle, jobz, rank, m, n, d_A,
    ...
    ccall((:cusolverDnSgesvdaStridedBatched_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{Cfloat}, Cint,
           Clonglong, CuPtr{Cfloat}, Clonglong, CuPtr{Cfloat}, Cint, Clonglong,
           CuPtr{Cfloat}, Cint, Clonglong, Ptr{Cint}, Cint), handle, jobz, rank, m, n, d_A,
          lda, strideA, d_S, strideS, d_U, ldu, strideU, d_V, ldv, strideV, lwork,
          batchSize)
end
...
@checked function cusolverDnDgesvdaStridedBatched_bufferSize(handle, jobz, rank, m, n, d_A,
    ...
    ccall((:cusolverDnDgesvdaStridedBatched_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{Cdouble}, Cint,
           Clonglong, CuPtr{Cdouble}, Clonglong, CuPtr{Cdouble}, Cint, Clonglong,
           CuPtr{Cdouble}, Cint, Clonglong, Ptr{Cint}, Cint), handle, jobz, rank, m, n, d_A,
          lda, strideA, d_S, strideS, d_U, ldu, strideU, d_V, ldv, strideV, lwork,
          batchSize)
end
...
@checked function cusolverDnCgesvdaStridedBatched_bufferSize(handle, jobz, rank, m, n, d_A,
    ...
    ccall((:cusolverDnCgesvdaStridedBatched_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{cuComplex}, Cint,
           Clonglong, CuPtr{Cfloat}, Clonglong, CuPtr{cuComplex}, Cint, Clonglong,
           CuPtr{cuComplex}, Cint, Clonglong, Ptr{Cint}, Cint), handle, jobz, rank, m, n,
          d_A, lda, strideA, d_S, strideS, d_U, ldu, strideU, d_V, ldv, strideV, lwork,
          batchSize)
end
...
@checked function cusolverDnZgesvdaStridedBatched_bufferSize(handle, jobz, rank, m, n, d_A,
    ...
    ccall((:cusolverDnZgesvdaStridedBatched_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{cuDoubleComplex},
           Cint, Clonglong, CuPtr{Cdouble}, Clonglong, CuPtr{cuDoubleComplex}, Cint,
           Clonglong, CuPtr{cuDoubleComplex}, Cint, Clonglong, Ptr{Cint}, Cint), handle,
          jobz, rank, m, n, d_A, lda, strideA, d_S, strideS, d_U, ldu, strideU, d_V, ldv,
          strideV, lwork, batchSize)
end
...
@checked function cusolverDnSgesvdaStridedBatched(handle, jobz, rank, m, n, d_A, lda,
    ...
    ccall((:cusolverDnSgesvdaStridedBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{Cfloat}, Cint,
           Clonglong, CuPtr{Cfloat}, Clonglong, CuPtr{Cfloat}, Cint, Clonglong,
           CuPtr{Cfloat}, Cint, Clonglong, CuPtr{Cfloat}, Cint, CuPtr{Cint}, Ptr{Cdouble},
           Cint), handle, jobz, rank, m, n, d_A, lda, strideA, d_S, strideS, d_U, ldu,
...
@checked function cusolverDnDgesvdaStridedBatched(handle, jobz, rank, m, n, d_A, lda,
    ...
    ccall((:cusolverDnDgesvdaStridedBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{Cdouble}, Cint,
           Clonglong, CuPtr{Cdouble}, Clonglong, CuPtr{Cdouble}, Cint, Clonglong,
           CuPtr{Cdouble}, Cint, Clonglong, CuPtr{Cdouble}, Cint, CuPtr{Cint}, Ptr{Cdouble},
           Cint), handle, jobz, rank, m, n, d_A, lda, strideA, d_S, strideS, d_U, ldu,
          strideU, d_V, ldv, strideV, d_work, lwork, d_info, h_R_nrmF, batchSize)
end
...
@checked function cusolverDnCgesvdaStridedBatched(handle, jobz, rank, m, n, d_A, lda,
    ...
    ccall((:cusolverDnCgesvdaStridedBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{cuComplex}, Cint,
           Clonglong, CuPtr{Cfloat}, Clonglong, CuPtr{cuComplex}, Cint, Clonglong,
           CuPtr{cuComplex}, Cint, Clonglong, CuPtr{cuComplex}, Cint, CuPtr{Cint},
           Ptr{Cdouble}, Cint), handle, jobz, rank, m, n, d_A, lda, strideA, d_S, strideS,
          d_U, ldu, strideU, d_V, ldv, strideV, d_work, lwork, d_info, h_R_nrmF, batchSize)
end
...
@checked function cusolverDnZgesvdaStridedBatched(handle, jobz, rank, m, n, d_A, lda,
    ...
    ccall((:cusolverDnZgesvdaStridedBatched, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverEigMode_t, Cint, Cint, Cint, CuPtr{cuDoubleComplex},
           Cint, Clonglong, CuPtr{Cdouble}, Clonglong, CuPtr{cuDoubleComplex}, Cint,
           Clonglong, CuPtr{cuDoubleComplex}, Cint, Clonglong, CuPtr{cuDoubleComplex}, Cint,
           CuPtr{Cint}, Ptr{Cdouble}, Cint), handle, jobz, rank, m, n, d_A, lda, strideA,
          d_S, strideS, d_U, ldu, strideU, d_V, ldv, strideV, d_work, lwork, d_info,
          h_R_nrmF, batchSize)
end
...
@checked function cusolverDnCreateParams(params)
    ...
    ccall((:cusolverDnCreateParams, libcusolver), cusolverStatus_t,
          (Ptr{cusolverDnParams_t},), params)
end

@checked function cusolverDnDestroyParams(params)
    initialize_context()
    ccall((:cusolverDnDestroyParams, libcusolver), cusolverStatus_t, (cusolverDnParams_t,),
          params)
end
...
@checked function cusolverDnSetAdvOptions(params, _function, algo)
    ...
    ccall((:cusolverDnSetAdvOptions, libcusolver), cusolverStatus_t,
          (cusolverDnParams_t, cusolverDnFunction_t, cusolverAlgMode_t), params, _function,
          algo)
end
...
@checked function cusolverDnPotrf_bufferSize(handle, params, uplo, n, dataTypeA, A, lda,
    ...
    ccall((:cusolverDnPotrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cublasFillMode_t, Int64, cudaDataType,
           CuPtr{Cvoid}, Int64, cudaDataType, Ptr{Csize_t}), handle, params, uplo, n,
          dataTypeA, A, lda, computeType, workspaceInBytes)
end
...
@checked function cusolverDnPotrf(handle, params, uplo, n, dataTypeA, A, lda, computeType,
    ...
    ccall((:cusolverDnPotrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cublasFillMode_t, Int64, cudaDataType,
           CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, Csize_t, CuPtr{Cint}), handle,
          params, uplo, n, dataTypeA, A, lda, computeType, pBuffer, workspaceInBytes, info)
end
...
@checked function cusolverDnPotrs(handle, params, uplo, n, nrhs, dataTypeA, A, lda,
    ...
    ccall((:cusolverDnPotrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cublasFillMode_t, Int64, Int64,
           cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, Int64,
           CuPtr{Cint}), handle, params, uplo, n, nrhs, dataTypeA, A, lda, dataTypeB, B,
          ldb, info)
end
...
@checked function cusolverDnGeqrf_bufferSize(handle, params, m, n, dataTypeA, A, lda,
    ...
    ccall((:cusolverDnGeqrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int64, Int64, cudaDataType, CuPtr{Cvoid},
           Int64, cudaDataType, CuPtr{Cvoid}, cudaDataType, Ptr{Csize_t}), handle, params,
          m, n, dataTypeA, A, lda, dataTypeTau, tau, computeType, workspaceInBytes)
end
...
@checked function cusolverDnGeqrf(handle, params, m, n, dataTypeA, A, lda, dataTypeTau, tau,
    ...
    ccall((:cusolverDnGeqrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int64, Int64, cudaDataType, CuPtr{Cvoid},
           Int64, cudaDataType, CuPtr{Cvoid}, cudaDataType, CuPtr{Cvoid}, Csize_t,
           CuPtr{Cint}), handle, params, m, n, dataTypeA, A, lda, dataTypeTau, tau,
          computeType, pBuffer, workspaceInBytes, info)
end
...
@checked function cusolverDnGetrf_bufferSize(handle, params, m, n, dataTypeA, A, lda,
    ...
    ccall((:cusolverDnGetrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int64, Int64, cudaDataType, CuPtr{Cvoid},
           Int64, cudaDataType, Ptr{Csize_t}), handle, params, m, n, dataTypeA, A, lda,
          computeType, workspaceInBytes)
end
...
@checked function cusolverDnGetrf(handle, params, m, n, dataTypeA, A, lda, ipiv,
    ...
    ccall((:cusolverDnGetrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int64, Int64, cudaDataType, CuPtr{Cvoid},
           Int64, CuPtr{Int64}, cudaDataType, CuPtr{Cvoid}, Csize_t, CuPtr{Cint}), handle,
          params, m, n, dataTypeA, A, lda, ipiv, computeType, pBuffer, workspaceInBytes,
          info)
end
...
@checked function cusolverDnGetrs(handle, params, trans, n, nrhs, dataTypeA, A, lda, ipiv,
    ...
    ccall((:cusolverDnGetrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cublasOperation_t, Int64, Int64,
           cudaDataType, CuPtr{Cvoid}, Int64, CuPtr{Int64}, cudaDataType, CuPtr{Cvoid},
           Int64, CuPtr{Cint}), handle, params, trans, n, nrhs, dataTypeA, A, lda, ipiv,
          dataTypeB, B, ldb, info)
end
...
@checked function cusolverDnSyevd_bufferSize(handle, params, jobz, uplo, n, dataTypeA, A,
    ...
    ccall((:cusolverDnSyevd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cusolverEigMode_t, cublasFillMode_t,
           ...
           cudaDataType, Ptr{Csize_t}), handle, params, jobz, uplo, n, dataTypeA, A, lda,
...
@checked function cusolverDnSyevd(handle, params, jobz, uplo, n, dataTypeA, A, lda,
    ...
    ccall((:cusolverDnSyevd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cusolverEigMode_t, cublasFillMode_t,
           Int64, cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid},
           cudaDataType, CuPtr{Cvoid}, Csize_t, CuPtr{Cint}), handle, params, jobz, uplo, n,
          dataTypeA, A, lda, dataTypeW, W, computeType, pBuffer, workspaceInBytes, info)
end
...
@checked function cusolverDnSyevdx_bufferSize(handle, params, jobz, range, uplo, n,
    ...
    ccall((:cusolverDnSyevdx_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cusolverEigMode_t, cusolverEigRange_t,
           cublasFillMode_t, Int64, cudaDataType, CuPtr{Cvoid}, Int64, Ptr{Cvoid},
           Ptr{Cvoid}, Int64, Int64, Ptr{Int64}, cudaDataType, CuPtr{Cvoid}, cudaDataType,
           Ptr{Csize_t}), handle, params, jobz, range, uplo, n, dataTypeA, A, lda, vl, vu,
          il, iu, h_meig, dataTypeW, W, computeType, workspaceInBytes)
end
...
@checked function cusolverDnSyevdx(handle, params, jobz, range, uplo, n, dataTypeA, A, lda,
    ...
    ccall((:cusolverDnSyevdx, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cusolverEigMode_t, cusolverEigRange_t,
           cublasFillMode_t, Int64, cudaDataType, CuPtr{Cvoid}, Int64, Ptr{Cvoid},
           Ptr{Cvoid}, Int64, Int64, Ptr{Int64}, cudaDataType, CuPtr{Cvoid}, cudaDataType,
           CuPtr{Cvoid}, Csize_t, CuPtr{Cint}), handle, params, jobz, range, uplo, n,
          dataTypeA, A, lda, vl, vu, il, iu, meig64, dataTypeW, W, computeType, pBuffer,
...
@checked function cusolverDnGesvd_bufferSize(handle, params, jobu, jobvt, m, n, dataTypeA,
    ...
    ccall((:cusolverDnGesvd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int8, Int8, Int64, Int64, cudaDataType,
           CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, cudaDataType, CuPtr{Cvoid},
           Int64, cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, Ptr{Csize_t}), handle,
          params, jobu, jobvt, m, n, dataTypeA, A, lda, dataTypeS, S, dataTypeU, U, ldu,
          dataTypeVT, VT, ldvt, computeType, workspaceInBytes)
end
...
@checked function cusolverDnGesvd(handle, params, jobu, jobvt, m, n, dataTypeA, A, lda,
    ...
    ccall((:cusolverDnGesvd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int8, Int8, Int64, Int64, cudaDataType,
           CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, cudaDataType, CuPtr{Cvoid},
           Int64, cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, Csize_t,
           CuPtr{Cint}), handle, params, jobu, jobvt, m, n, dataTypeA, A, lda, dataTypeS, S,
          dataTypeU, U, ldu, dataTypeVT, VT, ldvt, computeType, pBuffer, workspaceInBytes,
          info)
end
...
@checked function cusolverDnXpotrf_bufferSize(handle, params, uplo, n, dataTypeA, A, lda,
                                              ...
                                              workspaceInBytesOnHost)
    initialize_context()
    ccall((:cusolverDnXpotrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cublasFillMode_t, Int64, cudaDataType,
           CuPtr{Cvoid}, Int64, cudaDataType, Ptr{Csize_t}, Ptr{Csize_t}), handle, params,
          uplo, n, dataTypeA, A, lda, computeType, workspaceInBytesOnDevice,
          workspaceInBytesOnHost)
end
...
@checked function cusolverDnXpotrf(handle, params, uplo, n, dataTypeA, A, lda, computeType,
                                   ...
                                   workspaceInBytesOnHost, info)
    initialize_context()
    ccall((:cusolverDnXpotrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cublasFillMode_t, Int64, cudaDataType,
           CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, Csize_t, Ptr{Cvoid}, Csize_t,
           CuPtr{Cint}), handle, params, uplo, n, dataTypeA, A, lda, computeType,
...
@checked function cusolverDnXpotrs(handle, params, uplo, n, nrhs, dataTypeA, A, lda,
                                   dataTypeB, B, ldb, info)
    initialize_context()
    ccall((:cusolverDnXpotrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cublasFillMode_t, Int64, Int64,
           cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, Int64,
           CuPtr{Cint}), handle, params, uplo, n, nrhs, dataTypeA, A, lda, dataTypeB, B,
          ldb, info)
...
@checked function cusolverDnXgeqrf_bufferSize(handle, params, m, n, dataTypeA, A, lda,
                                              ...
                                              workspaceInBytesOnHost)
    initialize_context()
    ccall((:cusolverDnXgeqrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int64, Int64, cudaDataType, CuPtr{Cvoid},
           Int64, cudaDataType, CuPtr{Cvoid}, cudaDataType, Ptr{Csize_t}, Ptr{Csize_t}),
...
@checked function cusolverDnXgeqrf(handle, params, m, n, dataTypeA, A, lda, dataTypeTau,
                                   ...
                                   workspaceInBytesOnHost, info)
    initialize_context()
    ccall((:cusolverDnXgeqrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int64, Int64, cudaDataType, CuPtr{Cvoid},
           Int64, cudaDataType, CuPtr{Cvoid}, cudaDataType, CuPtr{Cvoid}, Csize_t,
           Ptr{Cvoid}, Csize_t, CuPtr{Cint}), handle, params, m, n, dataTypeA, A, lda,
          dataTypeTau, tau, computeType, bufferOnDevice, workspaceInBytesOnDevice,
...
@checked function cusolverDnXgetrf_bufferSize(handle, params, m, n, dataTypeA, A, lda,
                                              ...
                                              workspaceInBytesOnHost)
    initialize_context()
    ccall((:cusolverDnXgetrf_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int64, Int64, cudaDataType, CuPtr{Cvoid},
           Int64, cudaDataType, Ptr{Csize_t}, Ptr{Csize_t}), handle, params, m, n,
          dataTypeA, A, lda, computeType, workspaceInBytesOnDevice, workspaceInBytesOnHost)
end
...
@checked function cusolverDnXgetrf(handle, params, m, n, dataTypeA, A, lda, ipiv,
                                   ...
                                   bufferOnHost, workspaceInBytesOnHost, info)
    initialize_context()
    ccall((:cusolverDnXgetrf, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int64, Int64, cudaDataType, CuPtr{Cvoid},
           Int64, CuPtr{Int64}, cudaDataType, CuPtr{Cvoid}, Csize_t, Ptr{Cvoid}, Csize_t,
           CuPtr{Cint}), handle, params, m, n, dataTypeA, A, lda, ipiv, computeType,
          bufferOnDevice, workspaceInBytesOnDevice, bufferOnHost, workspaceInBytesOnHost,
          info)
end
...
@checked function cusolverDnXgetrs(handle, params, trans, n, nrhs, dataTypeA, A, lda, ipiv,
                                   dataTypeB, B, ldb, info)
    initialize_context()
    ccall((:cusolverDnXgetrs, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cublasOperation_t, Int64, Int64,
           cudaDataType, CuPtr{Cvoid}, Int64, CuPtr{Int64}, cudaDataType, CuPtr{Cvoid},
           Int64, CuPtr{Cint}), handle, params, trans, n, nrhs, dataTypeA, A, lda, ipiv,
          dataTypeB, B, ldb, info)
...
@checked function cusolverDnXsyevd_bufferSize(handle, params, jobz, uplo, n, dataTypeA, A,
                                              ...
                                              workspaceInBytesOnHost)
    initialize_context()
    ccall((:cusolverDnXsyevd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cusolverEigMode_t, cublasFillMode_t,
           Int64, cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid},
           cudaDataType, Ptr{Csize_t}, Ptr{Csize_t}), handle, params, jobz, uplo, n,
          dataTypeA, A, lda, dataTypeW, W, computeType, workspaceInBytesOnDevice,
          workspaceInBytesOnHost)
end
...
@checked function cusolverDnXsyevd(handle, params, jobz, uplo, n, dataTypeA, A, lda,
                                   ...
                                   workspaceInBytesOnHost, info)
    initialize_context()
    ccall((:cusolverDnXsyevd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cusolverEigMode_t, cublasFillMode_t,
           Int64, cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid},
           cudaDataType, CuPtr{Cvoid}, Csize_t, Ptr{Cvoid}, Csize_t, CuPtr{Cint}), handle,
          params, jobz, uplo, n, dataTypeA, A, lda, dataTypeW, W, computeType,
          bufferOnDevice, workspaceInBytesOnDevice, bufferOnHost, workspaceInBytesOnHost,
          info)
end
...
@checked function cusolverDnXsyevdx_bufferSize(handle, params, jobz, range, uplo, n,
                                               ...
                                               workspaceInBytesOnHost)
    initialize_context()
    ccall((:cusolverDnXsyevdx_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cusolverEigMode_t, cusolverEigRange_t,
           cublasFillMode_t, Int64, cudaDataType, CuPtr{Cvoid}, Int64, CuPtr{Cvoid},
           CuPtr{Cvoid}, Int64, Int64, CuPtr{Int64}, cudaDataType, CuPtr{Cvoid},
           cudaDataType, Ptr{Csize_t}, Ptr{Csize_t}), handle, params, jobz, range, uplo, n,
          dataTypeA, A, lda, vl, vu, il, iu, h_meig, dataTypeW, W, computeType,
          workspaceInBytesOnDevice, workspaceInBytesOnHost)
end
...
@checked function cusolverDnXsyevdx(handle, params, jobz, range, uplo, n, dataTypeA, A, lda,
                                    ...
                                    workspaceInBytesOnHost, info)
    initialize_context()
    ccall((:cusolverDnXsyevdx, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cusolverEigMode_t, cusolverEigRange_t,
           cublasFillMode_t, Int64, cudaDataType, CuPtr{Cvoid}, Int64, CuPtr{Cvoid},
           CuPtr{Cvoid}, Int64, Int64, CuPtr{Int64}, cudaDataType, CuPtr{Cvoid},
           cudaDataType, CuPtr{Cvoid}, Csize_t, Ptr{Cvoid}, Csize_t, CuPtr{Cint}), handle,
          params, jobz, range, uplo, n, dataTypeA, A, lda, vl, vu, il, iu, meig64,
          dataTypeW, W, computeType, bufferOnDevice, workspaceInBytesOnDevice, bufferOnHost,
          workspaceInBytesOnHost, info)
end
...
@checked function cusolverDnXgesvd_bufferSize(handle, params, jobu, jobvt, m, n, dataTypeA,
                                              ...
                                              workspaceInBytesOnHost)
    initialize_context()
    ccall((:cusolverDnXgesvd_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int8, Int8, Int64, Int64, cudaDataType,
           CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, cudaDataType, CuPtr{Cvoid},
           Int64, cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, Ptr{Csize_t},
           Ptr{Csize_t}), handle, params, jobu, jobvt, m, n, dataTypeA, A, lda, dataTypeS,
          S, dataTypeU, U, ldu, dataTypeVT, VT, ldvt, computeType, workspaceInBytesOnDevice,
          workspaceInBytesOnHost)
end
...
@checked function cusolverDnXgesvd(handle, params, jobu, jobvt, m, n, dataTypeA, A, lda,
                                   ...
                                   bufferOnHost, workspaceInBytesOnHost, info)
    initialize_context()
    ccall((:cusolverDnXgesvd, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int8, Int8, Int64, Int64, cudaDataType,
           CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, cudaDataType, CuPtr{Cvoid},
           Int64, cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, Csize_t,
           Ptr{Cvoid}, Csize_t, CuPtr{Cint}), handle, params, jobu, jobvt, m, n, dataTypeA,
          A, lda, dataTypeS, S, dataTypeU, U, ldu, dataTypeVT, VT, ldvt, computeType,
          bufferOnDevice, workspaceInBytesOnDevice, bufferOnHost, workspaceInBytesOnHost,
          info)
end
...
@checked function cusolverDnXgesvdp_bufferSize(handle, params, jobz, econ, m, n, dataTypeA,
                                               ...
                                               workspaceInBytesOnHost)
    initialize_context()
    ccall((:cusolverDnXgesvdp_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cusolverEigMode_t, Cint, Int64, Int64,
           cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, cudaDataType,
           CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType,
           Ptr{Csize_t}, Ptr{Csize_t}), handle, params, jobz, econ, m, n, dataTypeA, A, lda,
          dataTypeS, S, dataTypeU, U, ldu, dataTypeV, V, ldv, computeType,
          workspaceInBytesOnDevice, workspaceInBytesOnHost)
end
...
@checked function cusolverDnXgesvdp(handle, params, jobz, econ, m, n, dataTypeA, A, lda,
                                    ...
                                    h_err_sigma)
    initialize_context()
    ccall((:cusolverDnXgesvdp, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, cusolverEigMode_t, Cint, Int64, Int64,
           cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, cudaDataType,
           CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType,
           CuPtr{Cvoid}, Csize_t, Ptr{Cvoid}, Csize_t, CuPtr{Cint}, Ptr{Cdouble}), handle,
          params, jobz, econ, m, n, dataTypeA, A, lda, dataTypeS, S, dataTypeU, U, ldu,
          dataTypeV, V, ldv, computeType, bufferOnDevice, workspaceInBytesOnDevice,
...
@checked function cusolverDnXgesvdr_bufferSize(handle, params, jobu, jobv, m, n, k, p,
                                               ...
                                               workspaceInBytesOnHost)
    initialize_context()
    ccall((:cusolverDnXgesvdr_bufferSize, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int8, Int8, Int64, Int64, Int64, Int64,
           Int64, cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid},
           cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, Int64,
           cudaDataType, Ptr{Csize_t}, Ptr{Csize_t}), handle, params, jobu, jobv, m, n, k,
          p, niters, dataTypeA, A, lda, dataTypeSrand, Srand, dataTypeUrand, Urand, ldUrand,
          dataTypeVrand, Vrand, ldVrand, computeType, workspaceInBytesOnDevice,
          workspaceInBytesOnHost)
end
...
@checked function cusolverDnXgesvdr(handle, params, jobu, jobv, m, n, k, p, niters,
                                    ...
                                    bufferOnHost, workspaceInBytesOnHost, d_info)
    initialize_context()
    ccall((:cusolverDnXgesvdr, libcusolver), cusolverStatus_t,
          (cusolverDnHandle_t, cusolverDnParams_t, Int8, Int8, Int64, Int64, Int64, Int64,
           Int64, cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid},
           cudaDataType, CuPtr{Cvoid}, Int64, cudaDataType, CuPtr{Cvoid}, Int64,
           cudaDataType, CuPtr{Cvoid}, Csize_t, Ptr{Cvoid}, Csize_t, CuPtr{Cint}), handle,
          params, jobu, jobv, m, n, k, p, niters, dataTypeA, A, lda, dataTypeSrand, Srand,
...
@checked function cusolverDnLoggerSetCallback(callback)
    initialize_context()
    ccall((:cusolverDnLoggerSetCallback, libcusolver), cusolverStatus_t,
          (cusolverDnLoggerCallback_t,), callback)
end

@checked function cusolverDnLoggerSetFile(file)
    initialize_context()
    ccall((:cusolverDnLoggerSetFile, libcusolver), cusolverStatus_t, (Ptr{Libc.FILE},),
          file)
end
...
@checked function cusolverSpCreate(handle)
    initialize_context()
    ccall((:cusolverSpCreate, libcusolver), cusolverStatus_t, (Ptr{cusolverSpHandle_t},),
          handle)
end

@checked function cusolverSpDestroy(handle)
    initialize_context()
    ccall((:cusolverSpDestroy, libcusolver), cusolverStatus_t, (cusolverSpHandle_t,),
          handle)
end
...
@checked function cusolverSpXcsrissymHost(handle, m, nnzA, descrA, csrRowPtrA, csrEndPtrA,
    ...
    ccall((:cusolverSpXcsrissymHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cint}, Ptr{Cint},
           Ptr{Cint}, Ptr{Cint}), handle, m, nnzA, descrA, csrRowPtrA, csrEndPtrA,
          csrColIndA, issym)
end
...
@checked function cusolverSpScsrlsvluHost(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpScsrlsvluHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, Ptr{Cfloat}, Cfloat, Cint, Ptr{Cfloat}, Ptr{Cint}), handle, n, nnzA,
...
@checked function cusolverSpDcsrlsvluHost(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpDcsrlsvluHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble}, Ptr{Cint},
           Ptr{Cint}, Ptr{Cdouble}, Cdouble, Cint, Ptr{Cdouble}, Ptr{Cint}), handle, n,
          nnzA, descrA, csrValA, csrRowPtrA, csrColIndA, b, tol, reorder, x, singularity)
end
...
@checked function cusolverSpCcsrlsvluHost(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpCcsrlsvluHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex}, Ptr{Cint},
           Ptr{Cint}, Ptr{cuComplex}, Cfloat, Cint, Ptr{cuComplex}, Ptr{Cint}), handle, n,
          nnzA, descrA, csrValA, csrRowPtrA, csrColIndA, b, tol, reorder, x, singularity)
end
...
@checked function cusolverSpZcsrlsvluHost(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpZcsrlsvluHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, Ptr{cuDoubleComplex}, Cdouble, Cint, Ptr{cuDoubleComplex},
           Ptr{Cint}), handle, n, nnzA, descrA, csrValA, csrRowPtrA, csrColIndA, b, tol,
...
@checked function cusolverSpScsrlsvqr(handle, m, nnz, descrA, csrVal, csrRowPtr, csrColInd,
    ...
    ccall((:cusolverSpScsrlsvqr, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, CuPtr{Cfloat}, CuPtr{Cint},
           CuPtr{Cint}, CuPtr{Cfloat}, Cfloat, Cint, CuPtr{Cfloat}, Ptr{Cint}), handle, m,
          nnz, descrA, csrVal, csrRowPtr, csrColInd, b, tol, reorder, x, singularity)
end
...
@checked function cusolverSpDcsrlsvqr(handle, m, nnz, descrA, csrVal, csrRowPtr, csrColInd,
    ...
    ccall((:cusolverSpDcsrlsvqr, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, CuPtr{Cdouble}, CuPtr{Cint},
           CuPtr{Cint}, CuPtr{Cdouble}, Cdouble, Cint, CuPtr{Cdouble}, Ptr{Cint}), handle,
          m, nnz, descrA, csrVal, csrRowPtr, csrColInd, b, tol, reorder, x, singularity)
end
...
@checked function cusolverSpCcsrlsvqr(handle, m, nnz, descrA, csrVal, csrRowPtr, csrColInd,
    ...
    ccall((:cusolverSpCcsrlsvqr, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, CuPtr{cuComplex},
           CuPtr{Cint}, CuPtr{Cint}, CuPtr{cuComplex}, Cfloat, Cint, CuPtr{cuComplex},
           Ptr{Cint}), handle, m, nnz, descrA, csrVal, csrRowPtr, csrColInd, b, tol,
          reorder, x, singularity)
end
...
@checked function cusolverSpZcsrlsvqr(handle, m, nnz, descrA, csrVal, csrRowPtr, csrColInd,
    ...
    ccall((:cusolverSpZcsrlsvqr, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, CuPtr{cuDoubleComplex},
           CuPtr{Cint}, CuPtr{Cint}, CuPtr{cuDoubleComplex}, Cdouble, Cint,
           CuPtr{cuDoubleComplex}, Ptr{Cint}), handle, m, nnz, descrA, csrVal, csrRowPtr,
...
@checked function cusolverSpScsrlsvqrHost(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpScsrlsvqrHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, Ptr{Cfloat}, Cfloat, Cint, Ptr{Cfloat}, Ptr{Cint}), handle, m, nnz,
          descrA, csrValA, csrRowPtrA, csrColIndA, b, tol, reorder, x, singularity)
end
...
@checked function cusolverSpDcsrlsvqrHost(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpDcsrlsvqrHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble}, Ptr{Cint},
           Ptr{Cint}, Ptr{Cdouble}, Cdouble, Cint, Ptr{Cdouble}, Ptr{Cint}), handle, m, nnz,
          descrA, csrValA, csrRowPtrA, csrColIndA, b, tol, reorder, x, singularity)
end
...
@checked function cusolverSpCcsrlsvqrHost(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpCcsrlsvqrHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex}, Ptr{Cint},
           Ptr{Cint}, Ptr{cuComplex}, Cfloat, Cint, Ptr{cuComplex}, Ptr{Cint}), handle, m,
          nnz, descrA, csrValA, csrRowPtrA, csrColIndA, b, tol, reorder, x, singularity)
end
...
@checked function cusolverSpZcsrlsvqrHost(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpZcsrlsvqrHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, Ptr{cuDoubleComplex}, Cdouble, Cint, Ptr{cuDoubleComplex},
           Ptr{Cint}), handle, m, nnz, descrA, csrValA, csrRowPtrA, csrColIndA, b, tol,
          reorder, x, singularity)
end
...
@checked function cusolverSpScsrlsvcholHost(handle, m, nnz, descrA, csrVal, csrRowPtr,
    ...
    ccall((:cusolverSpScsrlsvcholHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, Ptr{Cfloat}, Cfloat, Cint, Ptr{Cfloat}, Ptr{Cint}), handle, m, nnz,
          descrA, csrVal, csrRowPtr, csrColInd, b, tol, reorder, x, singularity)
end
...
@checked function cusolverSpScsrlsqvqrHost(handle, m, n, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpScsrlsqvqrHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, Ptr{Cfloat}, Cfloat, Ptr{Cint}, Ptr{Cfloat}, Ptr{Cint}, Ptr{Cfloat}),
...
@checked function cusolverSpDcsrlsqvqrHost(handle, m, n, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpDcsrlsqvqrHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble},
           Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Cdouble, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cint},
           Ptr{Cdouble}), handle, m, n, nnz, descrA, csrValA, csrRowPtrA, csrColIndA, b,
...
@checked function cusolverSpCcsrlsqvqrHost(handle, m, n, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpCcsrlsqvqrHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex},
           Ptr{Cint}, Ptr{Cint}, Ptr{cuComplex}, Cfloat, Ptr{Cint}, Ptr{cuComplex},
           Ptr{Cint}, Ptr{Cfloat}), handle, m, n, nnz, descrA, csrValA, csrRowPtrA,
          csrColIndA, b, tol, rankA, x, p, min_norm)
end
...
@checked function cusolverSpZcsrlsqvqrHost(handle, m, n, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpZcsrlsqvqrHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, Ptr{cuDoubleComplex}, Cdouble, Ptr{Cint},
           Ptr{cuDoubleComplex}, Ptr{Cint}, Ptr{Cdouble}), handle, m, n, nnz, descrA,
          csrValA, csrRowPtrA, csrColIndA, b, tol, rankA, x, p, min_norm)
end
...
@checked function cusolverSpScsreigvsiHost(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpScsreigvsiHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, Cfloat, Ptr{Cfloat}, Cint, Cfloat, Ptr{Cfloat}, Ptr{Cfloat}), handle,
          m, nnz, descrA, csrValA, csrRowPtrA, csrColIndA, mu0, x0, maxite, tol, mu, x)
end
...
@checked function cusolverSpDcsreigvsiHost(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpDcsreigvsiHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble}, Ptr{Cint},
           Ptr{Cint}, Cdouble, Ptr{Cdouble}, Cint, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}),
          handle, m, nnz, descrA, csrValA, csrRowPtrA, csrColIndA, mu0, x0, maxite, tol, mu,
          x)
end
...
@checked function cusolverSpCcsreigvsiHost(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpCcsreigvsiHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex}, Ptr{Cint},
           Ptr{Cint}, cuComplex, Ptr{cuComplex}, Cint, Cfloat, Ptr{cuComplex},
           Ptr{cuComplex}), handle, m, nnz, descrA, csrValA, csrRowPtrA, csrColIndA, mu0,
          x0, maxite, tol, mu, x)
end
...
@checked function cusolverSpZcsreigvsiHost(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpZcsreigvsiHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, cuDoubleComplex, Ptr{cuDoubleComplex}, Cint, Cdouble,
           Ptr{cuDoubleComplex}, Ptr{cuDoubleComplex}), handle, m, nnz, descrA, csrValA,
          csrRowPtrA, csrColIndA, mu0, x0, maxite, tol, mu, x)
end
...
@checked function cusolverSpScsreigvsi(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpScsreigvsi, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, CuPtr{Cfloat}, CuPtr{Cint},
           CuPtr{Cint}, Cfloat, CuPtr{Cfloat}, Cint, Cfloat, CuPtr{Cfloat}, CuPtr{Cfloat}),
          handle, m, nnz, descrA, csrValA, csrRowPtrA, csrColIndA, mu0, x0, maxite, eps, mu,
          x)
end
...
@checked function cusolverSpDcsreigvsi(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpDcsreigvsi, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, CuPtr{Cdouble}, CuPtr{Cint},
           CuPtr{Cint}, Cdouble, CuPtr{Cdouble}, Cint, Cdouble, CuPtr{Cdouble},
           CuPtr{Cdouble}), handle, m, nnz, descrA, csrValA, csrRowPtrA, csrColIndA, mu0,
          x0, maxite, eps, mu, x)
end
...
@checked function cusolverSpCcsreigvsi(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpCcsreigvsi, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, CuPtr{cuComplex},
           ...
           CuPtr{cuComplex}, CuPtr{cuComplex}), handle, m, nnz, descrA, csrValA, csrRowPtrA,
          csrColIndA, mu0, x0, maxite, eps, mu, x)
end
...
@checked function cusolverSpZcsreigvsi(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpZcsreigvsi, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, CuPtr{cuDoubleComplex},
           CuPtr{Cint}, CuPtr{Cint}, cuDoubleComplex, CuPtr{cuDoubleComplex}, Cint, Cdouble,
           CuPtr{cuDoubleComplex}, CuPtr{cuDoubleComplex}), handle, m, nnz, descrA, csrValA,
          csrRowPtrA, csrColIndA, mu0, x0, maxite, eps, mu, x)
end
...
@checked function cusolverSpScsreigsHost(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpScsreigsHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, cuComplex, cuComplex, Ptr{Cint}), handle, m, nnz, descrA, csrValA,
          csrRowPtrA, csrColIndA, left_bottom_corner, right_upper_corner, num_eigs)
end
...
@checked function cusolverSpDcsreigsHost(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpDcsreigsHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble}, Ptr{Cint},
           Ptr{Cint}, cuDoubleComplex, cuDoubleComplex, Ptr{Cint}), handle, m, nnz, descrA,
          csrValA, csrRowPtrA, csrColIndA, left_bottom_corner, right_upper_corner, num_eigs)
end
...
@checked function cusolverSpZcsreigsHost(handle, m, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpZcsreigsHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, cuDoubleComplex, cuDoubleComplex, Ptr{Cint}), handle, m,
          nnz, descrA, csrValA, csrRowPtrA, csrColIndA, left_bottom_corner,
...
@checked function cusolverSpXcsrsymrcmHost(handle, n, nnzA, descrA, csrRowPtrA, csrColIndA,
    ...
    ccall((:cusolverSpXcsrsymrcmHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cint}, Ptr{Cint},
           Ptr{Cint}), handle, n, nnzA, descrA, csrRowPtrA, csrColIndA, p)
end
...
@checked function cusolverSpXcsrmetisndHost(handle, n, nnzA, descrA, csrRowPtrA, csrColIndA,
    ...
    ccall((:cusolverSpXcsrmetisndHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cint}, Ptr{Cint},
           Ptr{Int64}, Ptr{Cint}), handle, n, nnzA, descrA, csrRowPtrA, csrColIndA, options,
          p)
end
...
@checked function cusolverSpScsrzfdHost(handle, n, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpScsrzfdHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), handle, n, nnz, descrA, csrValA, csrRowPtrA,
          csrColIndA, P, numnz)
end
...
@checked function cusolverSpZcsrzfdHost(handle, n, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpZcsrzfdHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), handle, n, nnz, descrA, csrValA,
          csrRowPtrA, csrColIndA, P, numnz)
end
...
@checked function cusolverSpXcsrperm_bufferSizeHost(handle, m, n, nnzA, descrA, csrRowPtrA,
    ...
    ccall((:cusolverSpXcsrperm_bufferSizeHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cint}, Ptr{Cint},
           Ptr{Cint}, Ptr{Cint}, Ptr{Csize_t}), handle, m, n, nnzA, descrA, csrRowPtrA,
          csrColIndA, p, q, bufferSizeInBytes)
end
...
@checked function cusolverSpXcsrpermHost(handle, m, n, nnzA, descrA, csrRowPtrA, csrColIndA,
    ...
    ccall((:cusolverSpXcsrpermHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cint}, Ptr{Cint},
           Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cvoid}), handle, m, n, nnzA, descrA,
          csrRowPtrA, csrColIndA, p, q, map, pBuffer)
end

@checked function cusolverSpCreateCsrqrInfo(info)
    initialize_context()
    ccall((:cusolverSpCreateCsrqrInfo, libcusolver), cusolverStatus_t, (Ptr{csrqrInfo_t},),
          info)
end

@checked function cusolverSpDestroyCsrqrInfo(info)
    initialize_context()
    ccall((:cusolverSpDestroyCsrqrInfo, libcusolver), cusolverStatus_t, (csrqrInfo_t,),
          info)
end
...
@checked function cusolverSpXcsrqrAnalysisBatched(handle, m, n, nnzA, descrA, csrRowPtrA,
    ...
    ccall((:cusolverSpXcsrqrAnalysisBatched, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, CuPtr{Cint},
           CuPtr{Cint}, csrqrInfo_t), handle, m, n, nnzA, descrA, csrRowPtrA, csrColIndA,
          info)
end
...
@checked function cusolverSpScsrqrBufferInfoBatched(handle, m, n, nnz, descrA, csrVal,
    ...
    ccall((:cusolverSpScsrqrBufferInfoBatched, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, CuPtr{Cfloat},
           CuPtr{Cint}, CuPtr{Cint}, Cint, csrqrInfo_t, Ptr{Csize_t}, Ptr{Csize_t}), handle,
          m, n, nnz, descrA, csrVal, csrRowPtr, csrColInd, batchSize, info,
          internalDataInBytes, workspaceInBytes)
end
...
@checked function cusolverSpDcsrqrBufferInfoBatched(handle, m, n, nnz, descrA, csrVal,
    ...
    ccall((:cusolverSpDcsrqrBufferInfoBatched, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, CuPtr{Cdouble},
           CuPtr{Cint}, CuPtr{Cint}, Cint, csrqrInfo_t, Ptr{Csize_t}, Ptr{Csize_t}), handle,
          m, n, nnz, descrA, csrVal, csrRowPtr, csrColInd, batchSize, info,
          internalDataInBytes, workspaceInBytes)
end
...
@checked function cusolverSpCcsrqrBufferInfoBatched(handle, m, n, nnz, descrA, csrVal,
    ...
    ccall((:cusolverSpCcsrqrBufferInfoBatched, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, CuPtr{cuComplex},
           CuPtr{Cint}, CuPtr{Cint}, Cint, csrqrInfo_t, Ptr{Csize_t}, Ptr{Csize_t}), handle,
          m, n, nnz, descrA, csrVal, csrRowPtr, csrColInd, batchSize, info,
          internalDataInBytes, workspaceInBytes)
end
...
@checked function cusolverSpZcsrqrBufferInfoBatched(handle, m, n, nnz, descrA, csrVal,
    ...
    ccall((:cusolverSpZcsrqrBufferInfoBatched, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, CuPtr{cuDoubleComplex},
           CuPtr{Cint}, CuPtr{Cint}, Cint, csrqrInfo_t, Ptr{Csize_t}, Ptr{Csize_t}), handle,
          m, n, nnz, descrA, csrVal, csrRowPtr, csrColInd, batchSize, info,
          internalDataInBytes, workspaceInBytes)
end
...
@checked function cusolverSpScsrqrsvBatched(handle, m, n, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpScsrqrsvBatched, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, CuPtr{Cfloat},
           CuPtr{Cint}, CuPtr{Cint}, CuPtr{Cfloat}, CuPtr{Cfloat}, Cint, csrqrInfo_t,
           CuPtr{Cvoid}), handle, m, n, nnz, descrA, csrValA, csrRowPtrA, csrColIndA, b, x,
...
@checked function cusolverSpDcsrqrsvBatched(handle, m, n, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpDcsrqrsvBatched, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, CuPtr{Cdouble},
           CuPtr{Cint}, CuPtr{Cint}, CuPtr{Cdouble}, CuPtr{Cdouble}, Cint, csrqrInfo_t,
           CuPtr{Cvoid}), handle, m, n, nnz, descrA, csrValA, csrRowPtrA, csrColIndA, b, x,
          batchSize, info, pBuffer)
end
...
@checked function cusolverSpCcsrqrsvBatched(handle, m, n, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpCcsrqrsvBatched, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, CuPtr{cuComplex},
           CuPtr{Cint}, CuPtr{Cint}, CuPtr{cuComplex}, CuPtr{cuComplex}, Cint, csrqrInfo_t,
           CuPtr{Cvoid}), handle, m, n, nnz, descrA, csrValA, csrRowPtrA, csrColIndA, b, x,
          batchSize, info, pBuffer)
end
...
@checked function cusolverSpZcsrqrsvBatched(handle, m, n, nnz, descrA, csrValA, csrRowPtrA,
    ...
    ccall((:cusolverSpZcsrqrsvBatched, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, CuPtr{cuDoubleComplex},
           CuPtr{Cint}, CuPtr{Cint}, CuPtr{cuDoubleComplex}, CuPtr{cuDoubleComplex}, Cint,
           csrqrInfo_t, CuPtr{Cvoid}), handle, m, n, nnz, descrA, csrValA, csrRowPtrA,
          csrColIndA, b, x, batchSize, info, pBuffer)
end
...
@checked function cusolverSpCreateCsrluInfoHost(info)
    initialize_context()
    ccall((:cusolverSpCreateCsrluInfoHost, libcusolver), cusolverStatus_t,
          (Ptr{csrluInfoHost_t},), info)
end

@checked function cusolverSpDestroyCsrluInfoHost(info)
    initialize_context()
    ccall((:cusolverSpDestroyCsrluInfoHost, libcusolver), cusolverStatus_t,
...
@checked function cusolverSpXcsrluAnalysisHost(handle, n, nnzA, descrA, csrRowPtrA,
                                               csrColIndA, info)
    initialize_context()
    ccall((:cusolverSpXcsrluAnalysisHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cint}, Ptr{Cint},
           csrluInfoHost_t), handle, n, nnzA, descrA, csrRowPtrA, csrColIndA, info)
end
...
@checked function cusolverSpScsrluBufferInfoHost(handle, n, nnzA, descrA, csrValA,
                                                 ...
                                                 internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpScsrluBufferInfoHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, csrluInfoHost_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes, workspaceInBytes)
end
...
@checked function cusolverSpDcsrluBufferInfoHost(handle, n, nnzA, descrA, csrValA,
                                                 ...
                                                 internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpDcsrluBufferInfoHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble}, Ptr{Cint},
           Ptr{Cint}, csrluInfoHost_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes, workspaceInBytes)
end
...
@checked function cusolverSpCcsrluBufferInfoHost(handle, n, nnzA, descrA, csrValA,
                                                 ...
                                                 internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpCcsrluBufferInfoHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex}, Ptr{Cint},
           Ptr{Cint}, csrluInfoHost_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes, workspaceInBytes)
end
...
@checked function cusolverSpZcsrluBufferInfoHost(handle, n, nnzA, descrA, csrValA,
                                                 ...
                                                 internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpZcsrluBufferInfoHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, csrluInfoHost_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, n,
          nnzA, descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
end
...
@checked function cusolverSpScsrluFactorHost(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
    ...
    initialize_context()
    ccall((:cusolverSpScsrluFactorHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, csrluInfoHost_t, Cfloat, Ptr{Cvoid}), handle, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, info, pivot_threshold, pBuffer)
end

@checked function cusolverSpDcsrluFactorHost(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                             csrColIndA, info, pivot_threshold, pBuffer)
    initialize_context()
    ccall((:cusolverSpDcsrluFactorHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble}, Ptr{Cint},
           Ptr{Cint}, csrluInfoHost_t, Cdouble, Ptr{Cvoid}), handle, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, info, pivot_threshold, pBuffer)
end
...
@checked function cusolverSpCcsrluFactorHost(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                             csrColIndA, info, pivot_threshold, pBuffer)
    initialize_context()
    ccall((:cusolverSpCcsrluFactorHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex}, Ptr{Cint},
           Ptr{Cint}, csrluInfoHost_t, Cfloat, Ptr{Cvoid}), handle, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, info, pivot_threshold, pBuffer)
end
...
@checked function cusolverSpZcsrluFactorHost(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                             csrColIndA, info, pivot_threshold, pBuffer)
    initialize_context()
    ccall((:cusolverSpZcsrluFactorHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, csrluInfoHost_t, Cdouble, Ptr{Cvoid}), handle, n, nnzA,
          descrA, csrValA, csrRowPtrA, csrColIndA, info, pivot_threshold, pBuffer)
end

@checked function cusolverSpScsrluZeroPivotHost(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpScsrluZeroPivotHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrluInfoHost_t, Cfloat, Ptr{Cint}), handle, info, tol,
          position)
end

@checked function cusolverSpDcsrluZeroPivotHost(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpDcsrluZeroPivotHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrluInfoHost_t, Cdouble, Ptr{Cint}), handle, info, tol,
          position)
end

@checked function cusolverSpCcsrluZeroPivotHost(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpCcsrluZeroPivotHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrluInfoHost_t, Cfloat, Ptr{Cint}), handle, info, tol,
          position)
end
...
@checked function cusolverSpZcsrluZeroPivotHost(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpZcsrluZeroPivotHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrluInfoHost_t, Cdouble, Ptr{Cint}), handle, info, tol,
          position)
end
...
@checked function cusolverSpScsrluSolveHost(handle, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpScsrluSolveHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Ptr{Cfloat}, Ptr{Cfloat}, csrluInfoHost_t, Ptr{Cvoid}),
          handle, n, b, x, info, pBuffer)
end

@checked function cusolverSpDcsrluSolveHost(handle, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpDcsrluSolveHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Ptr{Cdouble}, Ptr{Cdouble}, csrluInfoHost_t,
           Ptr{Cvoid}), handle, n, b, x, info, pBuffer)
end

@checked function cusolverSpCcsrluSolveHost(handle, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpCcsrluSolveHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Ptr{cuComplex}, Ptr{cuComplex}, csrluInfoHost_t,
           Ptr{Cvoid}), handle, n, b, x, info, pBuffer)
end

@checked function cusolverSpZcsrluSolveHost(handle, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpZcsrluSolveHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Ptr{cuDoubleComplex}, Ptr{cuDoubleComplex},
           csrluInfoHost_t, Ptr{Cvoid}), handle, n, b, x, info, pBuffer)
end

@checked function cusolverSpXcsrluNnzHost(handle, nnzLRef, nnzURef, info)
    initialize_context()
    ccall((:cusolverSpXcsrluNnzHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Ptr{Cint}, Ptr{Cint}, csrluInfoHost_t), handle, nnzLRef,
          nnzURef, info)
end
...
@checked function cusolverSpScsrluExtractHost(handle, P, Q, descrL, csrValL, csrRowPtrL,
    ...
    initialize_context()
    ccall((:cusolverSpScsrluExtractHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Ptr{Cint}, Ptr{Cint}, cusparseMatDescr_t, Ptr{Cfloat},
           Ptr{Cint}, Ptr{Cint}, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint}, Ptr{Cint},
           csrluInfoHost_t, Ptr{Cvoid}), handle, P, Q, descrL, csrValL, csrRowPtrL,
          csrColIndL, descrU, csrValU, csrRowPtrU, csrColIndU, info, pBuffer)
end
...
@checked function cusolverSpDcsrluExtractHost(handle, P, Q, descrL, csrValL, csrRowPtrL,
                                              ...
                                              csrColIndU, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpDcsrluExtractHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Ptr{Cint}, Ptr{Cint}, cusparseMatDescr_t, Ptr{Cdouble},
           Ptr{Cint}, Ptr{Cint}, cusparseMatDescr_t, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cint},
           csrluInfoHost_t, Ptr{Cvoid}), handle, P, Q, descrL, csrValL, csrRowPtrL,
          csrColIndL, descrU, csrValU, csrRowPtrU, csrColIndU, info, pBuffer)
end
...
@checked function cusolverSpCcsrluExtractHost(handle, P, Q, descrL, csrValL, csrRowPtrL,
                                              ...
                                              csrColIndU, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpCcsrluExtractHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Ptr{Cint}, Ptr{Cint}, cusparseMatDescr_t, Ptr{cuComplex},
           Ptr{Cint}, Ptr{Cint}, cusparseMatDescr_t, Ptr{cuComplex}, Ptr{Cint}, Ptr{Cint},
           csrluInfoHost_t, Ptr{Cvoid}), handle, P, Q, descrL, csrValL, csrRowPtrL,
          csrColIndL, descrU, csrValU, csrRowPtrU, csrColIndU, info, pBuffer)
end
...
@checked function cusolverSpZcsrluExtractHost(handle, P, Q, descrL, csrValL, csrRowPtrL,
                                              ...
                                              csrColIndU, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpZcsrluExtractHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Ptr{Cint}, Ptr{Cint}, cusparseMatDescr_t,
           Ptr{cuDoubleComplex}, Ptr{Cint}, Ptr{Cint}, cusparseMatDescr_t,
           Ptr{cuDoubleComplex}, Ptr{Cint}, Ptr{Cint}, csrluInfoHost_t, Ptr{Cvoid}), handle,
          P, Q, descrL, csrValL, csrRowPtrL, csrColIndL, descrU, csrValU, csrRowPtrU,
          csrColIndU, info, pBuffer)
end

@checked function cusolverSpCreateCsrqrInfoHost(info)
    initialize_context()
    ccall((:cusolverSpCreateCsrqrInfoHost, libcusolver), cusolverStatus_t,
          (Ptr{csrqrInfoHost_t},), info)
end

@checked function cusolverSpDestroyCsrqrInfoHost(info)
    initialize_context()
    ccall((:cusolverSpDestroyCsrqrInfoHost, libcusolver), cusolverStatus_t,
...
@checked function cusolverSpXcsrqrAnalysisHost(handle, m, n, nnzA, descrA, csrRowPtrA,
                                               csrColIndA, info)
    initialize_context()
    ccall((:cusolverSpXcsrqrAnalysisHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cint}, Ptr{Cint},
           csrqrInfoHost_t), handle, m, n, nnzA, descrA, csrRowPtrA, csrColIndA, info)
end
...
@checked function cusolverSpScsrqrBufferInfoHost(handle, m, n, nnzA, descrA, csrValA,
                                                 ...
                                                 internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpScsrqrBufferInfoHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, csrqrInfoHost_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, m, n, nnzA,
          descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
end
...
@checked function cusolverSpDcsrqrBufferInfoHost(handle, m, n, nnzA, descrA, csrValA,
                                                 ...
                                                 internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpDcsrqrBufferInfoHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble},
           Ptr{Cint}, Ptr{Cint}, csrqrInfoHost_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, m, n,
          nnzA, descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
end
...
@checked function cusolverSpCcsrqrBufferInfoHost(handle, m, n, nnzA, descrA, csrValA,
                                                 ...
                                                 internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpCcsrqrBufferInfoHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex},
           Ptr{Cint}, Ptr{Cint}, csrqrInfoHost_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, m, n,
          nnzA, descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
...
@checked function cusolverSpZcsrqrBufferInfoHost(handle, m, n, nnzA, descrA, csrValA,
                                                 ...
                                                 internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpZcsrqrBufferInfoHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, csrqrInfoHost_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, m, n,
          nnzA, descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
...
@checked function cusolverSpScsrqrSetupHost(handle, m, n, nnzA, descrA, csrValA, csrRowPtrA,
                                            csrColIndA, mu, info)
    initialize_context()
    ccall((:cusolverSpScsrqrSetupHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, Cfloat, csrqrInfoHost_t), handle, m, n, nnzA, descrA, csrValA,
          csrRowPtrA, csrColIndA, mu, info)
end

@checked function cusolverSpDcsrqrSetupHost(handle, m, n, nnzA, descrA, csrValA, csrRowPtrA,
                                            csrColIndA, mu, info)
    initialize_context()
    ccall((:cusolverSpDcsrqrSetupHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble},
           Ptr{Cint}, Ptr{Cint}, Cdouble, csrqrInfoHost_t), handle, m, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, mu, info)
end

@checked function cusolverSpCcsrqrSetupHost(handle, m, n, nnzA, descrA, csrValA, csrRowPtrA,
                                            csrColIndA, mu, info)
    initialize_context()
    ccall((:cusolverSpCcsrqrSetupHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex},
           Ptr{Cint}, Ptr{Cint}, cuComplex, csrqrInfoHost_t), handle, m, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, mu, info)
end
...
@checked function cusolverSpZcsrqrSetupHost(handle, m, n, nnzA, descrA, csrValA, csrRowPtrA,
                                            csrColIndA, mu, info)
    initialize_context()
    ccall((:cusolverSpZcsrqrSetupHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, cuDoubleComplex, csrqrInfoHost_t), handle, m, n, nnzA,
          descrA, csrValA, csrRowPtrA, csrColIndA, mu, info)
end

@checked function cusolverSpScsrqrFactorHost(handle, m, n, nnzA, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpScsrqrFactorHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, Ptr{Cfloat}, Ptr{Cfloat}, csrqrInfoHost_t,
           Ptr{Cvoid}), handle, m, n, nnzA, b, x, info, pBuffer)
end

@checked function cusolverSpDcsrqrFactorHost(handle, m, n, nnzA, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpDcsrqrFactorHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, Ptr{Cdouble}, Ptr{Cdouble},
           csrqrInfoHost_t, Ptr{Cvoid}), handle, m, n, nnzA, b, x, info, pBuffer)
end

@checked function cusolverSpCcsrqrFactorHost(handle, m, n, nnzA, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpCcsrqrFactorHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, Ptr{cuComplex}, Ptr{cuComplex},
           csrqrInfoHost_t, Ptr{Cvoid}), handle, m, n, nnzA, b, x, info, pBuffer)
end

@checked function cusolverSpZcsrqrFactorHost(handle, m, n, nnzA, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpZcsrqrFactorHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, Ptr{cuDoubleComplex}, Ptr{cuDoubleComplex},
           csrqrInfoHost_t, Ptr{Cvoid}), handle, m, n, nnzA, b, x, info, pBuffer)
end

@checked function cusolverSpScsrqrZeroPivotHost(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpScsrqrZeroPivotHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrqrInfoHost_t, Cfloat, Ptr{Cint}), handle, info, tol,
          position)
end

@checked function cusolverSpDcsrqrZeroPivotHost(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpDcsrqrZeroPivotHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrqrInfoHost_t, Cdouble, Ptr{Cint}), handle, info, tol,
          position)
end

@checked function cusolverSpCcsrqrZeroPivotHost(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpCcsrqrZeroPivotHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrqrInfoHost_t, Cfloat, Ptr{Cint}), handle, info, tol,
          position)
end
...
@checked function cusolverSpZcsrqrZeroPivotHost(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpZcsrqrZeroPivotHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrqrInfoHost_t, Cdouble, Ptr{Cint}), handle, info, tol,
          position)
end
...
@checked function cusolverSpScsrqrSolveHost(handle, m, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpScsrqrSolveHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Ptr{Cfloat}, Ptr{Cfloat}, csrqrInfoHost_t,
           Ptr{Cvoid}), handle, m, n, b, x, info, pBuffer)
end

@checked function cusolverSpDcsrqrSolveHost(handle, m, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpDcsrqrSolveHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Ptr{Cdouble}, Ptr{Cdouble}, csrqrInfoHost_t,
           Ptr{Cvoid}), handle, m, n, b, x, info, pBuffer)
end

@checked function cusolverSpCcsrqrSolveHost(handle, m, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpCcsrqrSolveHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Ptr{cuComplex}, Ptr{cuComplex}, csrqrInfoHost_t,
           Ptr{Cvoid}), handle, m, n, b, x, info, pBuffer)
end

@checked function cusolverSpZcsrqrSolveHost(handle, m, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpZcsrqrSolveHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Ptr{cuDoubleComplex}, Ptr{cuDoubleComplex},
           csrqrInfoHost_t, Ptr{Cvoid}), handle, m, n, b, x, info, pBuffer)
end

@checked function cusolverSpXcsrqrAnalysis(handle, m, n, nnzA, descrA, csrRowPtrA,
                                           csrColIndA, info)
    initialize_context()
    ccall((:cusolverSpXcsrqrAnalysis, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cint}, Ptr{Cint},
           csrqrInfo_t), handle, m, n, nnzA, descrA, csrRowPtrA, csrColIndA, info)
end
...
@checked function cusolverSpScsrqrBufferInfo(handle, m, n, nnzA, descrA, csrValA,
                                             ...
                                             internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpScsrqrBufferInfo, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, csrqrInfo_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, m, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes, workspaceInBytes)
end
...
@checked function cusolverSpDcsrqrBufferInfo(handle, m, n, nnzA, descrA, csrValA,
                                             ...
                                             internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpDcsrqrBufferInfo, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble},
           Ptr{Cint}, Ptr{Cint}, csrqrInfo_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, m, n,
          nnzA, descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
end
...
@checked function cusolverSpCcsrqrBufferInfo(handle, m, n, nnzA, descrA, csrValA,
                                             ...
                                             internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpCcsrqrBufferInfo, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex},
           Ptr{Cint}, Ptr{Cint}, csrqrInfo_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, m, n,
          nnzA, descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
...
@checked function cusolverSpZcsrqrBufferInfo(handle, m, n, nnzA, descrA, csrValA,
                                             ...
                                             internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpZcsrqrBufferInfo, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, csrqrInfo_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, m, n,
          nnzA, descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
...
@checked function cusolverSpScsrqrSetup(handle, m, n, nnzA, descrA, csrValA, csrRowPtrA,
                                        csrColIndA, mu, info)
    initialize_context()
    ccall((:cusolverSpScsrqrSetup, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, Cfloat, csrqrInfo_t), handle, m, n, nnzA, descrA, csrValA, csrRowPtrA,
          csrColIndA, mu, info)
end
...
@checked function cusolverSpDcsrqrSetup(handle, m, n, nnzA, descrA, csrValA, csrRowPtrA,
                                        csrColIndA, mu, info)
    initialize_context()
    ccall((:cusolverSpDcsrqrSetup, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble},
           Ptr{Cint}, Ptr{Cint}, Cdouble, csrqrInfo_t), handle, m, n, nnzA, descrA, csrValA,
          csrRowPtrA, csrColIndA, mu, info)
end
...
@checked function cusolverSpCcsrqrSetup(handle, m, n, nnzA, descrA, csrValA, csrRowPtrA,
                                        csrColIndA, mu, info)
    initialize_context()
    ccall((:cusolverSpCcsrqrSetup, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex},
           Ptr{Cint}, Ptr{Cint}, cuComplex, csrqrInfo_t), handle, m, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, mu, info)
end
...
@checked function cusolverSpZcsrqrSetup(handle, m, n, nnzA, descrA, csrValA, csrRowPtrA,
                                        csrColIndA, mu, info)
    initialize_context()
    ccall((:cusolverSpZcsrqrSetup, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, cuDoubleComplex, csrqrInfo_t), handle, m, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, mu, info)
end

@checked function cusolverSpScsrqrFactor(handle, m, n, nnzA, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpScsrqrFactor, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, Ptr{Cfloat}, Ptr{Cfloat}, csrqrInfo_t,
           Ptr{Cvoid}), handle, m, n, nnzA, b, x, info, pBuffer)
end

@checked function cusolverSpDcsrqrFactor(handle, m, n, nnzA, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpDcsrqrFactor, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, Ptr{Cdouble}, Ptr{Cdouble}, csrqrInfo_t,
           Ptr{Cvoid}), handle, m, n, nnzA, b, x, info, pBuffer)
end

@checked function cusolverSpCcsrqrFactor(handle, m, n, nnzA, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpCcsrqrFactor, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, Ptr{cuComplex}, Ptr{cuComplex},
           csrqrInfo_t, Ptr{Cvoid}), handle, m, n, nnzA, b, x, info, pBuffer)
end

@checked function cusolverSpZcsrqrFactor(handle, m, n, nnzA, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpZcsrqrFactor, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Cint, Ptr{cuDoubleComplex}, Ptr{cuDoubleComplex},
           csrqrInfo_t, Ptr{Cvoid}), handle, m, n, nnzA, b, x, info, pBuffer)
end
...
@checked function cusolverSpScsrqrZeroPivot(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpScsrqrZeroPivot, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrqrInfo_t, Cfloat, Ptr{Cint}), handle, info, tol, position)
end

@checked function cusolverSpDcsrqrZeroPivot(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpDcsrqrZeroPivot, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrqrInfo_t, Cdouble, Ptr{Cint}), handle, info, tol,
          position)
end

@checked function cusolverSpCcsrqrZeroPivot(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpCcsrqrZeroPivot, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrqrInfo_t, Cfloat, Ptr{Cint}), handle, info, tol, position)
end

@checked function cusolverSpZcsrqrZeroPivot(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpZcsrqrZeroPivot, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrqrInfo_t, Cdouble, Ptr{Cint}), handle, info, tol,
          position)
end
...
@checked function cusolverSpScsrqrSolve(handle, m, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpScsrqrSolve, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Ptr{Cfloat}, Ptr{Cfloat}, csrqrInfo_t,
           Ptr{Cvoid}), handle, m, n, b, x, info, pBuffer)
end

@checked function cusolverSpDcsrqrSolve(handle, m, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpDcsrqrSolve, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Ptr{Cdouble}, Ptr{Cdouble}, csrqrInfo_t,
           Ptr{Cvoid}), handle, m, n, b, x, info, pBuffer)
end

@checked function cusolverSpCcsrqrSolve(handle, m, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpCcsrqrSolve, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Ptr{cuComplex}, Ptr{cuComplex}, csrqrInfo_t,
           Ptr{Cvoid}), handle, m, n, b, x, info, pBuffer)
end

@checked function cusolverSpZcsrqrSolve(handle, m, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpZcsrqrSolve, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, Ptr{cuDoubleComplex}, Ptr{cuDoubleComplex},
           csrqrInfo_t, Ptr{Cvoid}), handle, m, n, b, x, info, pBuffer)
end

@checked function cusolverSpCreateCsrcholInfoHost(info)
    initialize_context()
    ccall((:cusolverSpCreateCsrcholInfoHost, libcusolver), cusolverStatus_t,
          (Ptr{csrcholInfoHost_t},), info)
end

@checked function cusolverSpDestroyCsrcholInfoHost(info)
    initialize_context()
    ccall((:cusolverSpDestroyCsrcholInfoHost, libcusolver), cusolverStatus_t,
...
@checked function cusolverSpXcsrcholAnalysisHost(handle, n, nnzA, descrA, csrRowPtrA,
                                                 csrColIndA, info)
    initialize_context()
    ccall((:cusolverSpXcsrcholAnalysisHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cint}, Ptr{Cint},
           csrcholInfoHost_t), handle, n, nnzA, descrA, csrRowPtrA, csrColIndA, info)
end
...
@checked function cusolverSpScsrcholBufferInfoHost(handle, n, nnzA, descrA, csrValA,
                                                   ...
                                                   internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpScsrcholBufferInfoHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, csrcholInfoHost_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, n, nnzA,
          descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
end
...
@checked function cusolverSpDcsrcholBufferInfoHost(handle, n, nnzA, descrA, csrValA,
                                                   ...
                                                   internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpDcsrcholBufferInfoHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble}, Ptr{Cint},
           Ptr{Cint}, csrcholInfoHost_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, n, nnzA,
          descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
...
@checked function cusolverSpCcsrcholBufferInfoHost(handle, n, nnzA, descrA, csrValA,
                                                   ...
                                                   internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpCcsrcholBufferInfoHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex}, Ptr{Cint},
           Ptr{Cint}, csrcholInfoHost_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, n, nnzA,
          descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
...
@checked function cusolverSpZcsrcholBufferInfoHost(handle, n, nnzA, descrA, csrValA,
                                                   ...
                                                   internalDataInBytes, workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpZcsrcholBufferInfoHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, csrcholInfoHost_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, n,
          nnzA, descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
end
...
@checked function cusolverSpScsrcholFactorHost(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
    ...
    initialize_context()
    ccall((:cusolverSpScsrcholFactorHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, csrcholInfoHost_t, Ptr{Cvoid}), handle, n, nnzA, descrA, csrValA,
...
@checked function cusolverSpDcsrcholFactorHost(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                               csrColIndA, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpDcsrcholFactorHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble}, Ptr{Cint},
           Ptr{Cint}, csrcholInfoHost_t, Ptr{Cvoid}), handle, n, nnzA, descrA, csrValA,
          csrRowPtrA, csrColIndA, info, pBuffer)
end
...
@checked function cusolverSpCcsrcholFactorHost(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                               csrColIndA, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpCcsrcholFactorHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex}, Ptr{Cint},
           Ptr{Cint}, csrcholInfoHost_t, Ptr{Cvoid}), handle, n, nnzA, descrA, csrValA,
          csrRowPtrA, csrColIndA, info, pBuffer)
end
...
@checked function cusolverSpZcsrcholFactorHost(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                               csrColIndA, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpZcsrcholFactorHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, csrcholInfoHost_t, Ptr{Cvoid}), handle, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, info, pBuffer)
end

@checked function cusolverSpScsrcholZeroPivotHost(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpScsrcholZeroPivotHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrcholInfoHost_t, Cfloat, Ptr{Cint}), handle, info, tol,
          position)
end

@checked function cusolverSpDcsrcholZeroPivotHost(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpDcsrcholZeroPivotHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrcholInfoHost_t, Cdouble, Ptr{Cint}), handle, info, tol,
          position)
end

@checked function cusolverSpCcsrcholZeroPivotHost(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpCcsrcholZeroPivotHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrcholInfoHost_t, Cfloat, Ptr{Cint}), handle, info, tol,
          position)
end
...
@checked function cusolverSpZcsrcholZeroPivotHost(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpZcsrcholZeroPivotHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrcholInfoHost_t, Cdouble, Ptr{Cint}), handle, info, tol,
          position)
end
...
@checked function cusolverSpScsrcholSolveHost(handle, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpScsrcholSolveHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Ptr{Cfloat}, Ptr{Cfloat}, csrcholInfoHost_t,
           Ptr{Cvoid}), handle, n, b, x, info, pBuffer)
end

@checked function cusolverSpDcsrcholSolveHost(handle, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpDcsrcholSolveHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Ptr{Cdouble}, Ptr{Cdouble}, csrcholInfoHost_t,
           Ptr{Cvoid}), handle, n, b, x, info, pBuffer)
end

@checked function cusolverSpCcsrcholSolveHost(handle, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpCcsrcholSolveHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Ptr{cuComplex}, Ptr{cuComplex}, csrcholInfoHost_t,
           Ptr{Cvoid}), handle, n, b, x, info, pBuffer)
end

@checked function cusolverSpZcsrcholSolveHost(handle, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpZcsrcholSolveHost, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Ptr{cuDoubleComplex}, Ptr{cuDoubleComplex},
           csrcholInfoHost_t, Ptr{Cvoid}), handle, n, b, x, info, pBuffer)
end

@checked function cusolverSpCreateCsrcholInfo(info)
    initialize_context()
    ccall((:cusolverSpCreateCsrcholInfo, libcusolver), cusolverStatus_t,
          (Ptr{csrcholInfo_t},), info)
end

@checked function cusolverSpDestroyCsrcholInfo(info)
    initialize_context()
    ccall((:cusolverSpDestroyCsrcholInfo, libcusolver), cusolverStatus_t, (csrcholInfo_t,),
          info)
end
...
@checked function cusolverSpXcsrcholAnalysis(handle, n, nnzA, descrA, csrRowPtrA,
                                             csrColIndA, info)
    initialize_context()
    ccall((:cusolverSpXcsrcholAnalysis, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cint}, Ptr{Cint},
           csrcholInfo_t), handle, n, nnzA, descrA, csrRowPtrA, csrColIndA, info)
end
...
@checked function cusolverSpScsrcholBufferInfo(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                               ...
                                               workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpScsrcholBufferInfo, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, csrcholInfo_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes, workspaceInBytes)
end
...
@checked function cusolverSpDcsrcholBufferInfo(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                               ...
                                               workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpDcsrcholBufferInfo, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble}, Ptr{Cint},
           Ptr{Cint}, csrcholInfo_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes, workspaceInBytes)
end
...
@checked function cusolverSpCcsrcholBufferInfo(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                               ...
                                               workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpCcsrcholBufferInfo, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex}, Ptr{Cint},
           Ptr{Cint}, csrcholInfo_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes, workspaceInBytes)
end
...
@checked function cusolverSpZcsrcholBufferInfo(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                               ...
                                               workspaceInBytes)
    initialize_context()
    ccall((:cusolverSpZcsrcholBufferInfo, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, csrcholInfo_t, Ptr{Csize_t}, Ptr{Csize_t}), handle, n,
          nnzA, descrA, csrValA, csrRowPtrA, csrColIndA, info, internalDataInBytes,
          workspaceInBytes)
end
...
@checked function cusolverSpScsrcholFactor(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                           csrColIndA, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpScsrcholFactor, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cfloat}, Ptr{Cint},
           Ptr{Cint}, csrcholInfo_t, Ptr{Cvoid}), handle, n, nnzA, descrA, csrValA,
          csrRowPtrA, csrColIndA, info, pBuffer)
end
...
@checked function cusolverSpDcsrcholFactor(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                           csrColIndA, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpDcsrcholFactor, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{Cdouble}, Ptr{Cint},
           Ptr{Cint}, csrcholInfo_t, Ptr{Cvoid}), handle, n, nnzA, descrA, csrValA,
          csrRowPtrA, csrColIndA, info, pBuffer)
end
...
@checked function cusolverSpCcsrcholFactor(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                           csrColIndA, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpCcsrcholFactor, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuComplex}, Ptr{Cint},
           Ptr{Cint}, csrcholInfo_t, Ptr{Cvoid}), handle, n, nnzA, descrA, csrValA,
          csrRowPtrA, csrColIndA, info, pBuffer)
end
...
@checked function cusolverSpZcsrcholFactor(handle, n, nnzA, descrA, csrValA, csrRowPtrA,
                                           csrColIndA, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpZcsrcholFactor, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Cint, cusparseMatDescr_t, Ptr{cuDoubleComplex},
           Ptr{Cint}, Ptr{Cint}, csrcholInfo_t, Ptr{Cvoid}), handle, n, nnzA, descrA,
          csrValA, csrRowPtrA, csrColIndA, info, pBuffer)
end

@checked function cusolverSpScsrcholZeroPivot(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpScsrcholZeroPivot, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrcholInfo_t, Cfloat, Ptr{Cint}), handle, info, tol,
          position)
end

@checked function cusolverSpDcsrcholZeroPivot(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpDcsrcholZeroPivot, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrcholInfo_t, Cdouble, Ptr{Cint}), handle, info, tol,
          position)
end

@checked function cusolverSpCcsrcholZeroPivot(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpCcsrcholZeroPivot, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrcholInfo_t, Cfloat, Ptr{Cint}), handle, info, tol,
          position)
end
...
@checked function cusolverSpZcsrcholZeroPivot(handle, info, tol, position)
    initialize_context()
    ccall((:cusolverSpZcsrcholZeroPivot, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrcholInfo_t, Cdouble, Ptr{Cint}), handle, info, tol,
          position)
end
...
@checked function cusolverSpScsrcholSolve(handle, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpScsrcholSolve, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Ptr{Cfloat}, Ptr{Cfloat}, csrcholInfo_t, Ptr{Cvoid}),
          handle, n, b, x, info, pBuffer)
end

@checked function cusolverSpDcsrcholSolve(handle, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpDcsrcholSolve, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Ptr{Cdouble}, Ptr{Cdouble}, csrcholInfo_t, Ptr{Cvoid}),
          handle, n, b, x, info, pBuffer)
end

@checked function cusolverSpCcsrcholSolve(handle, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpCcsrcholSolve, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Ptr{cuComplex}, Ptr{cuComplex}, csrcholInfo_t,
           Ptr{Cvoid}), handle, n, b, x, info, pBuffer)
end

@checked function cusolverSpZcsrcholSolve(handle, n, b, x, info, pBuffer)
    initialize_context()
    ccall((:cusolverSpZcsrcholSolve, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, Cint, Ptr{cuDoubleComplex}, Ptr{cuDoubleComplex},
           csrcholInfo_t, Ptr{Cvoid}), handle, n, b, x, info, pBuffer)
end

@checked function cusolverSpScsrcholDiag(handle, info, diag)
    initialize_context()
    ccall((:cusolverSpScsrcholDiag, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrcholInfo_t, Ptr{Cfloat}), handle, info, diag)
end

@checked function cusolverSpDcsrcholDiag(handle, info, diag)
    initialize_context()
    ccall((:cusolverSpDcsrcholDiag, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrcholInfo_t, Ptr{Cdouble}), handle, info, diag)
end

@checked function cusolverSpCcsrcholDiag(handle, info, diag)
    initialize_context()
    ccall((:cusolverSpCcsrcholDiag, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrcholInfo_t, Ptr{Cfloat}), handle, info, diag)
end

@checked function cusolverSpZcsrcholDiag(handle, info, diag)
    initialize_context()
    ccall((:cusolverSpZcsrcholDiag, libcusolver), cusolverStatus_t,
          (cusolverSpHandle_t, csrcholInfo_t, Ptr{Cdouble}), handle, info, diag)
end
