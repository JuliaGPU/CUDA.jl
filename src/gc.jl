...
"""
Block finalization of all objects in `targets`, and register `owner` as the owning object.
...
"""
Unblock finalization of all objects in `targets`, checking whether they were owned by `owner`.
...
This function is meant to be called in the finalized of the parent object, as during process
