...
const cuda_artifacts = Dict(
    (release=v"11.1", version=v"11.1.0",   preferred=false) => ()->artifact"CUDA111",
    (release=v"11.0", version=v"11.0.3",   preferred=true)  => ()->artifact"CUDA110",
    (release=v"10.2", version=v"10.2.89",  preferred=true)  => ()->artifact"CUDA102",
    (release=v"10.1", version=v"10.1.243", preferred=true)  => ()->artifact"CUDA101",
)
