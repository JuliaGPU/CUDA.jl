...
Broadcast.BroadcastStyle(::CUDACore.CuArrayStyle{N1, B1},
               ::CUDACore.CuArrayStyle{N2, B2}) where {N1,N2,B1,B2} =
    CuArrayStyle{max(N1,N2), UnifiedMemory}()

# resolve ambiguity: different N, same memory type
Broadcast.BroadcastStyle(::CUDACore.CuArrayStyle{N1, B},
               ::CUDACore.CuArrayStyle{N2, B}) where {N1,N2,B} =
