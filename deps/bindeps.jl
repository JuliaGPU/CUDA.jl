...
const cuda_artifacts = Dict(
    (release=v"11.1", version=v"11.1.0",   preferred=false) => ()->@artifact_str("CUDA$v_111"),
    (release=v"11.0", version=v"11.0.3",   preferred=true)  => ()->@artifact_str("CUDA$v_110"),
    (release=v"10.2", version=v"10.2.89",  preferred=true)  => ()->@artifact_str("CUDA$v_102"),
    (release=v"10.1", version=v"10.1.243", preferred=true)  => ()->@artifact_str("CUDA$v_101"),
)
...
const cudnn_artifacts = Dict(
    v"11.0" => ()->(@artifact_str("CUDNN_CUDA$v_110"), v"8"),
    v"10.2" => ()->(@artifact_str("CUDNN_CUDA$v_102"), v"8"),
    v"10.1" => ()->(@artifact_str("CUDNN_CUDA$v_101"), v"8"),
)
...
const cutensor_artifacts = Dict(
    v"11.0" => ()->@artifact_str("CUTENSOR_CUDA$v_110"),
    v"10.2" => ()->@artifact_str("CUTENSOR_CUDA$v_102"),
    v"10.1" => ()->@artifact_str("CUTENSOR_CUDA$v_101"),
)
