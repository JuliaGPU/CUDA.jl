...
function CuContext(pctx::CuPrimaryContext)
    ...
    @apicall(:cuDevicePrimaryCtxRetain, (Ptr{CUcontext}, CUdevice,), handle, pctx.dev)
    ...
    finalizer((ctx)->begin
        ...
        @apicall(:cuDevicePrimaryCtxRelease, (CUdevice,), pctx.dev)
        invalidate!(ctx)
...
function state(pctx::CuPrimaryContext)
    flags = Ref{Cuint}()
    active = Ref{Cint}()
    @apicall(:cuDevicePrimaryCtxGetState, (CUdevice, Ptr{Cuint}, Ptr{Cint}),
...
function unsafe_reset!(pctx::CuPrimaryContext, checked::Bool=true)
    ...
    #@apicall(:cuDevicePrimaryCtxReset, (CUdevice,), pctx.dev)
...
setflags!(pctx::CuPrimaryContext, flags::CUctx_flags) =
    @apicall(:cuDevicePrimaryCtxSetFlags, (CUdevice, Cuint), pctx.dev, flags)
