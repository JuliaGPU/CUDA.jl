...
@test flags(pctx) == CUDAdrv.CU_CTX_SCHED_AUTO
setflags!(pctx, CUDAdrv.CU_CTX_SCHED_BLOCKING_SYNC)
@test flags(pctx) == CUDAdrv.CU_CTX_SCHED_BLOCKING_SYNC
...
cache_config!(CUDAdrv.CU_FUNC_CACHE_PREFER_L1)
@test cache_config() == CUDAdrv.CU_FUNC_CACHE_PREFER_L1
...
shmem_config!(CUDAdrv.CU_SHARED_MEM_CONFIG_FOUR_BYTE_BANK_SIZE)
@test shmem_config() == CUDAdrv.CU_SHARED_MEM_CONFIG_FOUR_BYTE_BANK_SIZE
