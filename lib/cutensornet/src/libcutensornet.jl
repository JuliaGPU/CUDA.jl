...
@checked function cutensornetContractionAutotune(handle, plan, rawDataIn, rawDataOut, workDesc, pref, stream)
        initialize_context()
        ccall((:cutensornetContractionAutotune, libcutensornet), cutensornetStatus_t, (cutensornetHandle_t, cutensornetContractionPlan_t, Ptr{CuPtr{Cvoid}}, CuPtr{Cvoid}, cutensornetWorkspaceDescriptor_t, cutensornetContractionAutotunePreference_t, cudaStream_t), handle, plan, rawDataIn, rawDataOut, workDesc, pref, stream)
    end
...
@checked function cutensornetContraction(handle, plan, rawDataIn, rawDataOut, workDesc, sliceId, stream)
        initialize_context()
        ccall((:cutensornetContraction, libcutensornet), cutensornetStatus_t, (cutensornetHandle_t, cutensornetContractionPlan_t, Ptr{CuPtr{Cvoid}}, CuPtr{Cvoid}, cutensornetWorkspaceDescriptor_t, Int64, cudaStream_t), handle, plan, rawDataIn, rawDataOut, workDesc, sliceId, stream)
    end
...
@checked function cutensornetContractSlices(handle, plan, rawDataIn, rawDataOut, accumulateOutput, workDesc, sliceGroup, stream)
        initialize_context()
        ccall((:cutensornetContractSlices, libcutensornet), cutensornetStatus_t, (cutensornetHandle_t, cutensornetContractionPlan_t, Ptr{Ptr{Cvoid}}, Ptr{Cvoid}, Int32, cutensornetWorkspaceDescriptor_t, cutensornetSliceGroup_t, cudaStream_t), handle, plan, rawDataIn, rawDataOut, accumulateOutput, workDesc, sliceGroup, stream)
    end
...
@checked function cutensornetLoggerSetFile(file)
        ccall((:cutensornetLoggerSetFile, libcutensornet), cutensornetStatus_t, (Ptr{Libc.FILE},), file)
    end
