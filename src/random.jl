# random number generation stubs and GPUArrays RNG integration
#
# CUDA.rand/randn/seed! are defined as stub functions here; cuRAND adds
# the actual methods. GPUArrays.default_rng is implemented here using
